...
translate german strings:
    ...
    new "{image=submission}{color=#000000} Unterwerfung........[momsubmission]{/color}"

    # game/Phone_stats_screen.rpy:89
    old "{image=anger}{color=#000000} Anger...................[momanger]{/color}"
    new "{image=anger}{color=#000000} Wut...................[momanger]{/color}"

    # game/Phone_stats_screen.rpy:91
    old "{image=frustrated}{color=#000000} Sex Frustration..[mom_sexual_frustration]{/color}"
    new "{image=frustrated}{color=#000000} Sexuelle Frustration...[mom_sexual_frustration]{/color}"

    # game/Phone_stats_screen.rpy:93
    old "{image=iconL} {color=#f442d9}Lauren's:{/color}"
    new "{image=iconL} {color=#f442d9}Laurens:{/color}"

    # game/Phone_stats_screen.rpy:95
    old "{image=respect}{color=#000000} Respect..............[laurenrespect]{/color}"
    new "{image=respect}{color=#000000} Respekt..............[laurenrespect]{/color}"

    # game/Phone_stats_screen.rpy:96
    old "{image=affection}{color=#000000} Affection............[laurenaffection]{/color}"
    new "{image=affection}{color=#000000} Anziehung............[laurenaffection]{/color}"
    ...
    # game/Phone_stats_screen.rpy:125
    old "{image=submission}{color=#000000} Submission........[auntsubmission]{/color}"
    new "{image=submission}{color=#000000} Unterwerfung........[auntsubmission]{/color}"

    # game/Phone_stats_screen.rpy:126
    old "{image=anger}{color=#000000} Anger...................[auntanger]{/color}"
    new "{image=anger}{color=#000000} Wut...................[auntanger]{/color}"

    # game/Phone_stats_screen.rpy:185
    old "  Loads counter {image=load_counter}"
    new "  Lädt Zähler {image = load_counter}"

    # game/Phone_stats_screen.rpy:198
    old "{image=iconR} {color=#0000CC} By [ryan]:{/color}"
    new "{image=iconR} {color=#0000CC} Durch [ryan]: {/color}"
    ...
    new "{image=iconMT} {color=#993300} Von Matt:{/color}"
    ...
    new "{image=iconJ} {color=#993300} Von Joey:{/color}"
