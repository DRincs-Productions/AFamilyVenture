...
translate german test_feb4bc5b:

    # "[betPickVar]"
    "[betPickVar]"

# game/images/interface_images/Roulette/RouletteGame.rpy:617
translate german gameTypeErrorCheck_be76e8b9:

    # RLT_dealer "Error: You haven't bet any amount of money.{w=3.0}{nw}" with Dissolve(2.0)
    RLT_dealer "Fehler: Sie haben keinen Geldbetrag gesetzt.{w=3.0}{nw}" with Dissolve(2.0)

# game/images/interface_images/Roulette/RouletteGame.rpy:624
translate german gameTypeErrorCheck_76d464ef:
    ...
    RLT_dealer "Fehler: Mit dem Straight-Tippspiel können Sie eine beliebige Roulettezahl wählen. Bitte geben Sie eine Liste mit einer Zahl an.{w=3.0}{nw}" with Dissolve(2.0)

# game/images/interface_images/Roulette/RouletteGame.rpy:633
translate german gameTypeErrorCheck_fbac9fac:
...
translate german gameTypeErrorCheck_a87619d6:
    ...
    RLT_dealer "Fehler: Mit dem Straight-Tippspiel können Sie eine beliebige Roulettezahl wählen. Bitte geben Sie eine Liste mit einer Zahl an.{w=3.0}{nw} [withDissolve30]"

# game/images/interface_images/Roulette/RouletteGame.rpy:651
translate german gameTypeErrorCheck_896b51f0:
    ...
    RLT_dealer "Fehler: Mit dem Straight-Tippspiel können Sie eine beliebige Roulettezahl wählen. Bitte geben Sie eine Liste mit einer Zahl an.{w=4.0}{nw} [withDissolve30]"

# game/images/interface_images/Roulette/RouletteGame.rpy:660
translate german gameTypeErrorCheck_7f667963:
    ...
    RLT_dealer "Fehler: Mit dem Straight-Tippspiel können Sie eine beliebige Roulettezahl wählen. Bitte geben Sie eine Liste mit einer Zahl an.{w=5.0}{nw} [withDissolve30]"

# game/images/interface_images/Roulette/RouletteGame.rpy:669
translate german gameTypeErrorCheck_30b475c4:
    ...
    RLT_dealer "Fehler: Mit dem Straight-Tippspiel können Sie eine beliebige Roulettezahl wählen. Bitte geben Sie eine Liste mit einer Zahl an.{w=3.0}{nw} [withDissolve60]"

# game/images/interface_images/Roulette/RouletteGame.rpy:678
translate german gameTypeErrorCheck_e69becfe:
    ...
    RLT_dealer "Fehler: Mit dem Straight-Tippspiel können Sie eine beliebige Roulettezahl wählen. Bitte geben Sie eine Liste mit einer Zahl an.{w=12.0}{nw} [withDissolve30]"

# game/images/interface_images/Roulette/RouletteGame.rpy:688
translate german gameTypeErrorCheck_3fde7c69:
    ...
    RLT_dealer "Fehler: Sie haben eine falsche Farbe gewählt. Akzeptable Farben sind {outlinecolor=#ffffff}{color=#FF0000}Red{/color}{/outlinecolor} und {outlinecolor=#ffffff}{color=#000000}Black{/color}{/outlinecolor}.{w=3.0}{nw}" with Dissolve(2.0)

# game/images/interface_images/Roulette/RouletteGame.rpy:696
translate german gameTypeErrorCheck_3fde7c69_1:

    # RLT_dealer "Error: You have picked an incorrect color. Acceptable colors are {outlinecolor=#ffffff}{color=#FF0000}Red{/color}{/outlinecolor} and {outlinecolor=#ffffff}{color=#000000}Black{/color}{/outlinecolor}.{w=3.0}{nw}" with Dissolve(2.0)
    RLT_dealer "Fehler: Sie haben eine falsche Farbe gewählt. Akzeptable Farben sind {outlinecolor=#ffffff}{color=#FF0000}Red{/color}{/outlinecolor} und {outlinecolor=#ffffff}{color=#000000}Black{/color}{/outlinecolor}.{w=3.0}{nw}" with Dissolve(2.0)

# game/images/interface_images/Roulette/RouletteGame.rpy:704
translate german gameTypeErrorCheck_e10368bb:
    ...
    RLT_dealer "Fehler: Sie haben eine falsche Wette gewählt. Akzeptable Wetten sind {outlinecolor=#ffffff}{color=#00008B}Odd{/color}{/outlinecolor} oder {outlinecolor=#ffffff}{color=#00008B}Even{/color}{/outlinecolor}.{w=3.0}{nw}" with Dissolve(2.0)

# game/images/interface_images/Roulette/RouletteGame.rpy:712
translate german gameTypeErrorCheck_e10368bb_1:

    # RLT_dealer "Error: You have picked an incorrect bet. Acceptable bets are {outlinecolor=#ffffff}{color=#00008B}Odd{/color}{/outlinecolor} or {outlinecolor=#ffffff}{color=#00008B}Even{/color}{/outlinecolor}.{w=3.0}{nw}" with Dissolve(2.0)
    RLT_dealer "Fehler: Sie haben eine falsche Wette gewählt. Akzeptable Wetten sind {outlinecolor=#ffffff}{color=#00008B}Odd{/color}{/outlinecolor} oder {outlinecolor=#ffffff}{color=#00008B}Even{/color}{/outlinecolor}.{w=3.0}{nw}" with Dissolve(2.0)

# game/images/interface_images/Roulette/RouletteGame.rpy:720
translate german call_rotate_1bc2ab16:

    # RLT_dealer "Let's roll the ball!{w=2.0}{nw}" with Dissolve(2.0)
    RLT_dealer "Lassen wir den Ball rollen!{w=2.0}{nw}" with Dissolve(2.0)

# game/images/interface_images/Roulette/RouletteGame.rpy:741
translate german lblCheckRoll_4da8e105:

    # RLT_dealer "You bet the ball would land on [playerPiked]{w=3.0}{nw}" with Dissolve(2.0)
    RLT_dealer "Du wettest, dass der Ball auf [playerPiked]{w=3.0}{nw} [withDissolve20] landen würde"

# game/images/interface_images/Roulette/RouletteGame.rpy:748
translate german lblCheckRoll_38a91ca2:
    ...
    RLT_dealer "Du hast gewonnen! Die gewürfelte Zahl ist [theRoll] und sie ist [theRollOddOrEven_text], die Farbe ist [theRollColor_text]!{w=3.0}{nw}" with Dissolve(2.0)

# game/images/interface_images/Roulette/RouletteGame.rpy:749
translate german lblCheckRoll_fb67b1be:

    # RLT_dealer "The payout is 35 to 1, so you won $[payout]!{w=3.0}{nw}" with Dissolve(2.0)
    RLT_dealer "Die Auszahlung beträgt 35 zu 1, Sie haben also $[payout]!{w=3.0}{nw}" with Dissolve(2.0)

# game/images/interface_images/Roulette/RouletteGame.rpy:753
translate german lblCheckRoll_bf9f0393:
