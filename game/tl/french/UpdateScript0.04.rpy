...
translate french get_sidney_modeling_479db5a9:

    # RT "{i}{b}(HINT){/b} I need to bring $200 to Sidney so she can start making her cosplay outfit.{/i}"
    RT "{i}{b}(Indice){/b} Je dois apporter 200$ à Sidney pour qu'elle puisse commencer à faire sa tenue de cosplay. {/i}"

# game/UpdateScript0.04.rpy:501
translate french get_sidney_modeling_834d13b4:
    ...
    RT "{i}{b}(Indice){/b} Sidney est bizarre quand il s'agit de s'amuser la nuit. Peut-être que je peux réparer la gêne entre nous pendant nos séances de photos.{/i}"
...
translate french get_sidney_modeling_479db5a9_1:

    # RT "{i}{b}(HINT){/b} I need to bring $200 to Sidney so she can start making her cosplay outfit.{/i}"
    RT "{i}{b}(Indice){/b} Je dois apporter 200$ à Sidney pour qu'elle puisse commencer à faire sa tenue de cosplay. {/i}"

# game/UpdateScript0.04.rpy:599
translate french get_sidney_modeling_834d13b4_1:
...
translate french posting_the_wr_pics_af40ba16:
    ...
    RT "{i}{b}(Indice){/b} je dois continuer à prendre ces photos de « Womb Raider » avec Sidney jusqu’à ce que nous ayons toutes les sortes de photos dont nous avons besoin. {/i}"
...
translate french bobbytext_558092c9:
    ...
    RT "{i}Eh bien, c'est difficile de résister après un message crypté comme celui-là.... {/i}"
...
translate french nightly_sixtynine_413f1352:

    # RT "{i}{b}(HINT){/b} Recent events have caused me to have weird dreams. I wonder if I'll have another weird dream soon.{/i}"
    RT "{i}{b}(Indice){/b} Des événements récents m'ont fait faire des rêves bizarres. Je me demande si je ferai bientôt un autre rêve étrange.{/i}"
...
translate french camille_tells_2aff5612:
    ...
    RT "{i}{b}(Indice){/b} Bon sang, tante Cami peut être une vraie salope... Je ne sais pas ce que l'oncle Bobby voit en elle. Je quitterais son cul en une seconde.{/i}"
...
translate french hire_a_maid_f9ed613e:
    ...
    R "Donc, si tante Cami.... Camille ne me dérangerait pas de faire toutes nos tâches autour de la maison, afin que nous puissions nous concentrer sur le succès de l'entreprise, je pense que nous aurions un commerce équitable..."
...
translate french hire_a_maid_9ae52970:
    ...
    RT "{i}{b}(Indice){/b} Sidney met généralement 3 jours pour confectionner une nouvelle tenue. Elle les ajuste généralement dans la cuisine, mais je serais bien avisé de vérifier le salon le matin aussi.{/i}"

# game/UpdateScript0.04.rpy:1538
translate french hire_a_maid_71898f8f:
    ...
    RT "{i}{b}(Indice){/b} Dieu merci, oncle Bobby a laissé à tante Cami de l'argent pour payer leur hypothèque, sinon ils auraient probablement dû emménager avec nous.{/i}"
...
translate french maid_outfit_fitting_9ab71613:
    ...
    C "{i}(marmonnement){/i} trou du cul sarcastique."

# game/UpdateScript0.04.rpy:1632
translate french maid_outfit_fitting_293913ea:

    # RT "{i}{b}(HINT){/b} I should keep going to the kitchen in the late morning until I can assign Aunt Cami a chore to work on.{/i}"
    RT "{i}{b}(Indice){/b} je devrais continuer à aller à la cuisine en fin de matinée jusqu’à ce que je puisse assigner à tante Camille une corvée pour la faire travailler. {/i}"

# game/UpdateScript0.04.rpy:1639
translate french maid_outfit_fitting_293913ea_1:

    # RT "{i}{b}(HINT){/b} I should keep going to the kitchen in the late morning until I can assign Aunt Cami a chore to work on.{/i}"
    RT "{i}{b}(Indice){/b} je devrais continuer à aller à la cuisine en fin de matinée jusqu’à ce que je puisse assigner à tante Camille une corvée pour la faire travailler. {/i}"

# game/UpdateScript0.04.rpy:1646
translate french maid_outfit_fitting_293913ea_2:
...
translate french aunt_clean_lounge_a8600dad:
    ...
    RT "{i}Oh mon Dieu!.... Regarde ces nichons !{/i}"
...
translate french aunt_clean_lounge_3945461a:

    # R "And we don't even need to talk about what happened in the Lounge the other evening."
    R "Et nous n'avons même pas besoin de parler de ce qui s'est passé dans le Salon l'autre soir."

# game/UpdateScript0.04.rpy:1766
translate french aunt_clean_lounge_4f768eb2:

    # C "Yes... Can we please not talk about that."
    C "Oui... Pouvons-nous s'il vous plaît ne pas parler de ça."
...
translate french aunt_clean_lounge_e1c969cd:

    # CT "{i}At least it's not as bad as when I sucked his dick.{/i}"
    CT "{i}Au moins, ce n'est pas aussi mauvais que quand je l'ai sucé.{/i}"

# game/UpdateScript0.04.rpy:2012
translate french aunt_clean_lounge_26242890:

    # CT "{i}At least it's not as bad as letting him fuck my tits.{/i}"
    CT "{i}Au moins ce n'est pas aussi mal que de le laisser baiser mes seins.{/i}"

# game/UpdateScript0.04.rpy:2014
translate french aunt_clean_lounge_945817e2:

    # CT "{I}At least it's not as bad as when I jerked him off.{/i}"
    CT "{I}Au moins, ce n'est pas aussi grave que quand je l'ai branlé.{/i}"
...
translate french aunt_clean_lounge_e1c969cd_1:

    # CT "{i}At least it's not as bad as when I sucked his dick.{/i}"
    CT "{i}Au moins, ce n'est pas aussi mauvais que quand je l'ai sucé.{/i}"

# game/UpdateScript0.04.rpy:2095
translate french aunt_clean_lounge_26242890_1:

    # CT "{i}At least it's not as bad as letting him fuck my tits.{/i}"
    CT "{i}Au moins ce n'est pas aussi mal que de le laisser baiser mes seins.{/i}"

# game/UpdateScript0.04.rpy:2097
translate french aunt_clean_lounge_945817e2_1:
...
translate french aunt_clean_bath_d1870bdc:

    # CT "{i}I can't believe I fit that thing in my mouth!{/i}"
    CT "{i}Je n'arrive pas à croire que j'ai pu mettre ce truc dans ma bouche!{/i}"

# game/UpdateScript0.04.rpy:2204
translate french aunt_clean_bath_e6b1cbf5:

    # CT "{i}Why am I so compelled to watch?{/i}"
    CT "{i}Pourquoi suis-je si pressé de regarder ?{/i}"
...
translate french aunt_clean_bath_319ebf2f:

    # CT "{i}I've probably got bruises between my tits from that thing slamming up and down my chest.{/i}"
    CT "{i}J'ai probablement des bleus entre les seins à cause de cette chose qui a frappé ma poitrine de haut en bas.{/i}"

# game/UpdateScript0.04.rpy:2209
translate french aunt_clean_bath_e6b1cbf5_1:

    # CT "{i}Why am I so compelled to watch?{/i}"
    CT "{i}Pourquoi suis-je si pressé de regarder ?{/i}"

# game/UpdateScript0.04.rpy:2210
translate french aunt_clean_bath_6e4f47d4_1:

    # "{i}{b}\"Aunt Camille's libido +2\"{/b}{/i}"
    "{i}{b}«Libido de tante Camille +2»{/b}{/i}"

# game/UpdateScript0.04.rpy:2213
translate french aunt_clean_bath_f5034a78:

    # CT "{i}I can't believe that thing's been in my hand.{/i}"
    CT "{i}Je ne peux pas croire que cette chose a été dans ma main.{/i}"

# game/UpdateScript0.04.rpy:2214
translate french aunt_clean_bath_83c777f9:

    # CT "{i}Why am I so compelled to watch this?{/i}"
    CT "{i}Pourquoi suis-je si pressé de regarder ça ?{/i}"

# game/UpdateScript0.04.rpy:2215
translate french aunt_clean_bath_6e4f47d4_2:
...
translate french aunt_clean_bath_6e4f47d4_3:
...
translate french aunt_clean_bath_50bc6cfa:

    # RT "{i}I loved having those tits wrapped around my dick!... it felt almost as good as her mouth.{/i}"
    RT "{i}J'ai adoré avoir ces nichons autour de ma queue !... c'était presque aussi bon que sa bouche. {/i}"

# game/UpdateScript0.04.rpy:2424
translate french aunt_clean_bath_24ba55be:

    # RT "{i}I can't believe I've had those amazing tits wrapped around my dick!{/i}"
    RT "{i}Je n'arrive pas à croire que j'ai eu ces superbes seins autour de ma bite!{/i}"

# game/UpdateScript0.04.rpy:2426
translate french aunt_clean_bath_3bed8e65:

    # RT "{i}I'll bet those tits feel even better than her hand did.{/i}"
    RT "{i}Je parie que ces seins sont encore mieux que sa main ne l'était.{/i}"
...
translate french aunt_clean_bath_afdebb84:

    # CT "{i}I mean... It's not as bad as when I sucked his dick, but still...{/i}"
    CT "{i}Je veux dire... Ce n'est pas aussi grave que quand je l'ai sucé, mais quand même...{/i}"

# game/UpdateScript0.04.rpy:2449
translate french aunt_clean_bath_e6f4fe03:

    # CT "{i}I mean... It's not as bad as when I let him fuck my tits, but still...{/i}"
    CT "{i}Je veux dire... Ce n'est pas aussi mauvais que lorsque je le laisse baiser mes seins, mais quand même...{/i}"

# game/UpdateScript0.04.rpy:2451
translate french aunt_clean_bath_239c6b24:

    # CT "{i}I mean... It's not as bad as when I jerked him off, but still...{/i}"
    CT "{i}Je veux dire... Ce n'est pas aussi grave que quand je l'ai branlé, mais quand même...{/i}"
...
translate french aunt_clean_bath_4c810688:

    # C "I mean, sure, there's the time I sucked your dick, but that was a mistake!"
    C "Je veux dire, bien sûr, il y a la fois où je t'ai sucé la bite, mais c'était une erreur !"

# game/UpdateScript0.04.rpy:2500
translate french aunt_clean_bath_61970a6f:

    # C "I mean, sure, there's the time I let you fuck my tits, but that was a mistake!"
    C "Je veux dire, bien sûr, il y a la fois où je t'ai laissé baiser mes seins, mais c'était une erreur !"

# game/UpdateScript0.04.rpy:2502
translate french aunt_clean_bath_a8564372:

    # C "I mean, sure, there's that time I jerked you off, but that was a mistake!"
    C "Je veux dire, bien sûr, il y a la fois où je t'ai branlé, mais c'était une erreur !"
...
translate french assign_chores_4b53f3ea:

    # C "It's none of your business... don't worry about it! It's not costing you anything."
    C "Ce ne sont pas tes affaires... ne t'en fais pas ! Ça ne te coûte rien."
...
translate french aunt_clean_kitchen_86ffcd08:

    # RT "{i}They felt so good around my cock... almost as good as her mouth!{/i}"
    RT "{i}Ils étaient si bons autour de ma queue... presque aussi bons que sa bouche!{/i}"

# game/UpdateScript0.04.rpy:3329
translate french aunt_clean_kitchen_c67413c2:

    # RT "{i}They felt so soft wrapped around my cock!{/i}"
    RT "{i}Elles étaient si douces enveloppées autour de ma bite!{/i}"

# game/UpdateScript0.04.rpy:3331
translate french aunt_clean_kitchen_c95f555b:

    # RT "{i}I'll bet they feel even better than her hand did.{/i}"
    RT "{i}Je parie qu'ils sont encore mieux que sa main ne l'était.{/i}"
...
translate french aunt_clean_kitchen_86ffcd08_1:

    # RT "{i}They felt so good around my cock... almost as good as her mouth!{/i}"
    RT "{i}Ils étaient si bons autour de ma queue... presque aussi bons que sa bouche!{/i}"

# game/UpdateScript0.04.rpy:3596
translate french aunt_clean_kitchen_c67413c2_1:

    # RT "{i}They felt so soft wrapped around my cock!{/i}"
    RT "{i}Elles étaient si douces enveloppées autour de ma bite!{/i}"

# game/UpdateScript0.04.rpy:3598
translate french aunt_clean_kitchen_c95f555b_1:
...
translate french aunt_clean_kitchen_38ef02cf:
    ...
    C "Je veux dire, bien sûr... J'ai peut-être sucé ta bite, mais c'était une erreur !"

# game/UpdateScript0.04.rpy:3672
translate french aunt_clean_kitchen_c1cd4d51:

    # C "I mean, sure... I may have let you fuck my tits, but that was a mistake!"
    C "Je veux dire, bien sûr... Je t'ai peut-être laissé baiser mes seins, mais c'était une erreur !"

# game/UpdateScript0.04.rpy:3674
translate french aunt_clean_kitchen_fbe92a87:

    # C "I mean, sure... I may have jacked you off, but that was a mistake!"
    C "Je veux dire, bien sûr... Je t'ai peut-être branché, mais c'était une erreur !"
...
translate french yoga_with_aunt_9e3084a6:

    # RT "{i}Mom and Aunt Cami already said they weren't going to let me in.{/i}"
    RT "{i}Maman et tante Cami ont déjà dit qu'elles ne me laisseraient pas entrer.{/i}"

# game/UpdateScript0.04.rpy:3706
translate french yoga_with_aunt_f155567a:

    # RT "{i}I can always watch them on the spy-cam, though.{/i}"
    RT "{i}Je peux toujours les regarder sur la caméra d'espionnage, cependant.{/i}"
...
translate french yoga_with_aunt_3e68be24:
...
translate french yoga_with_aunt_e19e1499:

    # RT "{i}Mom's workouts have only gotten sexier now that Aunt Cami works out with her.{/i}"
    RT "{i}Les séances d'entraînement de maman sont devenues plus sexy maintenant que tante Cami s'entraîne avec elle.{/i}"

# game/UpdateScript0.04.rpy:3773
translate french yoga_with_aunt_2e367468:

    # RT "{i}Maybe I should drop in and say \"good morning\"?{/i}"
    RT "{i}Peut-être que je devrais passer et dire 'bonjour' ?{/i}"

# game/UpdateScript0.04.rpy:3777
translate french yoga_with_aunt_7ccb0083:

    # M "{i}(Yelling through the door){/i} Who is it?"
    M "{i}(Hurlant à travers la porte) {/i} Qui est-ce ?"

# game/UpdateScript0.04.rpy:3778
translate french yoga_with_aunt_d428c608:

    # C "{i}(Muffled voice){/i} You know exactly who it is."
    C "{i}(Voix étouffée){/i} Vous savez exactement qui c'est."

# game/UpdateScript0.04.rpy:3779
translate french yoga_with_aunt_56cec944:

    # R "It's me... Can I come in?"
    R "C'est moi... Je peux entrer ?"

# game/UpdateScript0.04.rpy:3780
translate french yoga_with_aunt_c61fc23d:

    # M "Honey, we're both holding a yoga pose!"
    M "Chérie, on fait tous les deux une pose de yoga !"

# game/UpdateScript0.04.rpy:3781
translate french yoga_with_aunt_063b6872:

    # M "If the door's unlocked, you can let yourself in."
    M "Si la porte est déverrouillée, vous pouvez entrer."

# game/UpdateScript0.04.rpy:3786
translate french yoga_with_aunt_981875ba:

    # RT "{i}Here goes.{/i}"
    RT "{i}C'est parti.{/i}"

# game/UpdateScript0.04.rpy:3787
translate french yoga_with_aunt_12862598:

    # RT "{i}Dammit!{/i}"
    RT "{i}Bon sang!{/i}"

# game/UpdateScript0.04.rpy:3788
translate french yoga_with_aunt_6d0d6847:

    # R "Mom, it's locked!"
    R "Maman, c'est fermé !"

# game/UpdateScript0.04.rpy:3789
translate french yoga_with_aunt_0c189e31:

    # R "Can't you just take a second to let me in?"
    R "Tu ne peux pas juste prendre une seconde pour me laisser entrer ?"

# game/UpdateScript0.04.rpy:3790
translate french yoga_with_aunt_b56df5e0:

    # C "{i}(Yelling through the door){/i} You know we can't, Dipshit!"
    C "{i}(Hurlant à travers la porte){/i} Tu sais que nous ne pouvons pas, Dipshit !"

# game/UpdateScript0.04.rpy:3791
translate french yoga_with_aunt_8953fd3a:

    # M "{i}(Muffled voice){/i} Don't call my son a dipshit!"
    M "{i}(Voix étouffée){/i} Ne traitez pas mon fils de merde !"

# game/UpdateScript0.04.rpy:3792
translate french yoga_with_aunt_f5bd3f7c:

    # C "Uhhh... Well, you know he's being one."
    C "Uhhh... Eh bien, tu sais qu'il en est un."

# game/UpdateScript0.04.rpy:3793
translate french yoga_with_aunt_9980ecf9:

    # M "I know... But you still don't say that to an impressionable boy."
    M "Je sais... Mais on ne dit quand même pas ça à un garçon impressionnable."

# game/UpdateScript0.04.rpy:3794
translate french yoga_with_aunt_7a5c7be1:

    # C "Whatever."
    C "Peu importe."

# game/UpdateScript0.04.rpy:3795
translate french yoga_with_aunt_c5eb680b:
    ...
    M "{i}(criant à travers la porte) Chéri, ta tante a raison... On ne peut pas juste arrêter notre entraînement. Tu dois tenir les mouvements de yoga pendant un certain temps pour que ça fasse effet."

# game/UpdateScript0.04.rpy:3796
translate french yoga_with_aunt_d5db51dd:

    # M "I don't have time to talk this morning, anyways... I'm barely going to have enough time to get ready."
    M "Je n'ai pas le temps de parler ce matin, de toute façon... Je vais à peine avoir le temps de me préparer."

# game/UpdateScript0.04.rpy:3797
translate french yoga_with_aunt_41ba1dc4:

    # M "You'll have to come find me some other time."
    M "Tu devras venir me trouver une autre fois."

# game/UpdateScript0.04.rpy:3798
translate french yoga_with_aunt_97b1b10a:

    # R "Alright, we'll catch up later."
    R "D'accord, on se retrouve plus tard."

# game/UpdateScript0.04.rpy:3799
translate french yoga_with_aunt_72b645de:

    # RT "{i}They're too busy to unlock the door, but now, I can watch them on my spy-cam.{/i}"
    RT "{i}Ils sont trop occupés pour déverrouiller la porte, mais maintenant, je peux les voir avec ma caméra espionne.{/i}"

# game/UpdateScript0.04.rpy:3802
translate french yoga_with_aunt_a151e05c_1:

    # RT "{i}I better go to my room to watch, just in case one of them comes out.{/i}"
    RT "{i}Je ferais mieux d'aller dans ma chambre pour regarder, juste au cas où l'une d'eux sortirait.{/i}"

# game/UpdateScript0.04.rpy:3808
translate french yoga_with_aunt_695589a2_1:

    # RT "{i}Wow!.... Mom is fucking flexible.{/i}"
    RT "{i}Wow!.... Maman est flexible.{/i}"

# game/UpdateScript0.04.rpy:3813
translate french yoga_with_aunt_0faf69f3_3:

    # RT "{i}Limber up those bodies, ladies.{/i}"
    RT "{i}Assouplissez ces corps, mesdames.{/i}"

# game/UpdateScript0.04.rpy:3816
translate french yoga_with_aunt_3e68be24_1:

    # RT "{i}Yeah, Aunt Cami. Get a good look at Mom's fun bags.{/i}"
    RT "{i}Ouais Tante Cami. Regardes bien les ballons de maman.{/i}"

# game/UpdateScript0.04.rpy:3817
translate french yoga_with_aunt_f094216e_1:

    # RT "{i}And Mom?.... Why don't you get a good look at Aunt Cami's ass while you're at it.{/i}"
    RT "{i}Et Maman?.... Regardes bien le cul de tante Camille pendant que tu y es.{/i}"

# game/UpdateScript0.04.rpy:3819
translate french yoga_with_aunt_0faf69f3_4:

    # RT "{i}Limber up those bodies, ladies.{/i}"
    RT "{i}Assouplissez ces corps, mesdames.{/i}"

# game/UpdateScript0.04.rpy:3822
translate french yoga_with_aunt_dcfc0d1a_1:

    # RT "{i}Ohhh.... we've got pussy contact!.... {/i}"
    RT "{i}Ohhh.... on a une vue sur sa chatte!.... {/i}"

# game/UpdateScript0.04.rpy:3823
translate french yoga_with_aunt_d165a869_1:

    # RT "{i}Grind those pussies together!{/i}"
    RT "{i}Malaxer ces chattes ensemble!{/i}"

# game/UpdateScript0.04.rpy:3825
translate french yoga_with_aunt_0faf69f3_5:

    # RT "{i}Limber up those bodies, ladies.{/i}"
    RT "{i}Assouplissez ces corps, mesdames.{/i}"

# game/UpdateScript0.04.rpy:3828
translate french yoga_with_aunt_fda02015_1:

    # RT "{i}If only Mom was wearing Lauren's strap-on.{/i}"
    RT "{i}Si seulement Maman portait le gode ceinture de Lauren.{/i}"

# game/UpdateScript0.04.rpy:3829
translate french yoga_with_aunt_0eb83cf9_1:

    # RT "{i}Or I guess I should say Mr. Snuggles strap-on.{/i}"
    RT "{i}Ou je suppose que je devrais dire monsieur Snuggles gode ceinture.{/i}"

# game/UpdateScript0.04.rpy:3832
translate french yoga_with_aunt_abe6e17a_1:

    # RT "{i}Oh.... it looks like Aunt Cami left.{/i}"
    RT "{i}Oh.... on dirait que tante Camille est partie.{/i}"

# game/UpdateScript0.04.rpy:3833
translate french yoga_with_aunt_5293625b_1:

    # RT "{i}Good thing I didn't hang around by the door.{/i}"
    RT "{i}Heureusement que je n'ai pas traîné près de la porte.{/i}"

# game/UpdateScript0.04.rpy:3836
translate french yoga_with_aunt_035883ea_1:

    # RT "{i}Ahhh.... if only Aunt Cami was changing clothes with her.{/i}"
    RT "{i}Ahhh.... si seulement tante Camille changeait de vêtements avec elle.{/i}"

# game/UpdateScript0.04.rpy:3839
translate french yoga_with_aunt_590f6f50_1:

    # RT "{i}Just.... wow.... what a body!{/i}"
    RT "{i}Juste.... wow.... quel corps!{/i}"

# game/UpdateScript0.04.rpy:3842
translate french yoga_with_aunt_a26be530_1:

    # "{i}\"A little while later.\"{/i}"
    "{i}'Un peu plus tard.'{/i}"

# game/UpdateScript0.04.rpy:3852
translate french yoga_with_aunt_4af2d87c_1:

    # RT "{i}Looks like she's about done.{/i}"
    RT "{i}On dirait qu'elle a fini.{/i}"

# game/UpdateScript0.04.rpy:3863
translate french yoga_with_aunt_a151e05c_2:

    # RT "{i}I better go to my room to watch, just in case one of them comes out.{/i}"
    RT "{i}Je ferais mieux d'aller dans ma chambre pour regarder, juste au cas où l'une d'eux sortirait.{/i}"

# game/UpdateScript0.04.rpy:3869
translate french yoga_with_aunt_695589a2_2:

    # RT "{i}Wow!.... Mom is fucking flexible.{/i}"
    RT "{i}Wow!.... Maman est flexible.{/i}"

# game/UpdateScript0.04.rpy:3874
translate french yoga_with_aunt_0faf69f3_6:

    # RT "{i}Limber up those bodies, ladies.{/i}"
    RT "{i}Assouplissez ces corps, mesdames.{/i}"

# game/UpdateScript0.04.rpy:3877
translate french yoga_with_aunt_3e68be24_2:

    # RT "{i}Yeah, Aunt Cami. Get a good look at Mom's fun bags.{/i}"
    RT "{i}Ouais Tante Cami. Regardes bien les ballons de maman.{/i}"

# game/UpdateScript0.04.rpy:3878
translate french yoga_with_aunt_f094216e_2:

    # RT "{i}And Mom?.... Why don't you get a good look at Aunt Cami's ass while you're at it.{/i}"
    RT "{i}Et Maman?.... Regardes bien le cul de tante Camille pendant que tu y es.{/i}"

# game/UpdateScript0.04.rpy:3880
translate french yoga_with_aunt_0faf69f3_7:

    # RT "{i}Limber up those bodies, ladies.{/i}"
    RT "{i}Assouplissez ces corps, mesdames.{/i}"

# game/UpdateScript0.04.rpy:3883
translate french yoga_with_aunt_dcfc0d1a_2:

    # RT "{i}Ohhh.... we've got pussy contact!.... {/i}"
    RT "{i}Ohhh.... on a une vue sur sa chatte!.... {/i}"

# game/UpdateScript0.04.rpy:3884
translate french yoga_with_aunt_d165a869_2:

    # RT "{i}Grind those pussies together!{/i}"
    RT "{i}Malaxer ces chattes ensemble!{/i}"

# game/UpdateScript0.04.rpy:3886
translate french yoga_with_aunt_0faf69f3_8:

    # RT "{i}Limber up those bodies, ladies.{/i}"
    RT "{i}Assouplissez ces corps, mesdames.{/i}"

# game/UpdateScript0.04.rpy:3889
translate french yoga_with_aunt_fda02015_2:

    # RT "{i}If only Mom was wearing Lauren's strap-on.{/i}"
    RT "{i}Si seulement Maman portait le gode ceinture de Lauren.{/i}"

# game/UpdateScript0.04.rpy:3890
translate french yoga_with_aunt_0eb83cf9_2:

    # RT "{i}Or I guess I should say Mr. Snuggles strap-on.{/i}"
    RT "{i}Ou je suppose que je devrais dire monsieur Snuggles gode ceinture.{/i}"

# game/UpdateScript0.04.rpy:3893
translate french yoga_with_aunt_abe6e17a_2:

    # RT "{i}Oh.... it looks like Aunt Cami left.{/i}"
    RT "{i}Oh.... on dirait que tante Camille est partie.{/i}"

# game/UpdateScript0.04.rpy:3894
translate french yoga_with_aunt_5293625b_2:

    # RT "{i}Good thing I didn't hang around by the door.{/i}"
    RT "{i}Heureusement que je n'ai pas traîné près de la porte.{/i}"

# game/UpdateScript0.04.rpy:3897
translate french yoga_with_aunt_035883ea_2:

    # RT "{i}Ahhh.... if only Aunt Cami was changing clothes with her.{/i}"
    RT "{i}Ahhh.... si seulement tante Camille changeait de vêtements avec elle.{/i}"

# game/UpdateScript0.04.rpy:3900
translate french yoga_with_aunt_590f6f50_2:

    # RT "{i}Just.... wow.... what a body!{/i}"
    RT "{i}Juste.... wow.... quel corps!{/i}"

# game/UpdateScript0.04.rpy:3903
translate french yoga_with_aunt_a26be530_2:

    # "{i}\"A little while later.\"{/i}"
    "{i}'Un peu plus tard.'{/i}"

# game/UpdateScript0.04.rpy:3913
translate french yoga_with_aunt_4af2d87c_2:
...
translate french jacky_at_Laptop_48387a1c:
    ...
    MT "{i}Merde ! Oui, je peux le faire.{/i}"
...
translate french jacky_at_Laptop_e257f4d1:
    ...
    MT "{i}Sainte Mère ! [ryan] est sur le point d'éclater dans son pantalon!{/i}"
...
translate french jacky_at_Laptop_d0ec7b7c:
    ...
    RT "{i}{b}(Indice){/b} Je n'arrive pas à croire que Maman était si à l'aise en me regardant me branler... Peut-être que je n'ai pas besoin de m'inquiéter autant de mes érections en sa présence, surtout quand elle me serre dans ses bras après que j'ai payé la dette de la mafia.{/i}"

# game/UpdateScript0.04.rpy:4512
translate french jacky_at_Laptop_cc738b75:
    ...
    RT "{i}{b}(Indice){/b} Faire des bêtises dans le bureau de maman est super risqué... Sa porte n'a même pas de verrou ! Plus on fait de bêtises là-dedans, plus on a de chances de se faire prendre.{/i}"

# game/UpdateScript0.04.rpy:4523
translate french bye_bobby_35885d12:

    # RT "{i}Ok, off to the warehouse!{/i}"
    RT "{i}Ok, dehors de l'entrepôt !{/i}"
...
translate french wr_gape_e56b1766:
    ...
    RT "{i}Mais ssssiiiiiiii.... chaud!!.... !!{/i}"
...
translate french wr_gape_ec3c9932:
    ...
    RT "{i}{b}(Indice){/b} Sidney était drôle quand je lui ai parlé de maman. Je ferais mieux de garder un œil sur elle ce week-end lorsque la mafia viendra pour le paiement hebdomadaire. {/i}"
...
translate french wr_gape_6df1a12e:
    ...
    RT "{i}Je vais à nouveau jouir dans la gorge de ma sœur!{/i}"
