...
translate turkish gameTypeErrorCheck_76d464ef:
    ...
    RLT_dealer "Hata: Straight bahis oyunu ile herhangi bir rulet numarası seçebilirsiniz. Lütfen bir sayı listesi sağlayın.{w=3.0}{nw} [withDissolve()]"
...
translate turkish gameTypeErrorCheck_fbac9fac:
    ...
    RLT_dealer "Hata: Split bahis oyunu ile herhangi 2 (iki) rulet numarası seçebilirsiniz. Lütfen iki farklı sayıdan oluşan bir liste sağlayın.{w=3.0}{nw} [withDissolve()]"
...
translate turkish gameTypeErrorCheck_a87619d6:
    ...
    RLT_dealer "Hata: Street bahis oyunu ile herhangi 3 (üç) rulet numarası seçebilirsiniz. Lütfen üç farklı sayıdan oluşan bir liste sağlayın.{w=3.0}{nw} [withDissolve()]"
...
translate turkish gameTypeErrorCheck_896b51f0:
    ...
    RLT_dealer "Hata: Split bahis oyunu ile herhangi 4 (iki) rulet numarası seçebilirsiniz. Lütfen iki farklı sayıdan oluşan bir liste sağlayın.{w=3.0}{nw} [withDissolve()]"
...
translate turkish gameTypeErrorCheck_30b475c4:
    ...
    RLT_dealer "Hata: Split bahis oyunu ile herhangi 6 (iki) rulet numarası seçebilirsiniz. Lütfen iki farklı sayıdan oluşan bir liste sağlayın.{w=3.0}{nw} [withDissolve()]"
...
translate turkish gameTypeErrorCheck_3fde7c69:
    ...
    RLT_dealer "Hata: Yanlış bir renk seçtiniz. Kabul edilebilir renkler {outlinecolor=#ffffff}{color=#FF0000}Red{/color}{/outlinecolor} ve {outlinecolor=#ffffff}{color=#000000}Black{/color}{/outlinecolor}.{w=3.0}{nw} [withDissolve()]"
...
translate turkish gameTypeErrorCheck_e10368bb:
    ...
    RLT_dealer "Hata: Yanlış bir bahis seçtiniz. Kabul edilebilir bahisler {outlinecolor=#ffffff}{color=#00008B}Odd{/color}{/outlinecolor} veya {outlinecolor=#ffffff}{color=#00008B}Even{/color}{/outlinecolor}.{w=3.0}{nw} [withDissolve()]"
...
translate turkish call_rotate_1bc2ab16:
    ...
    "[Rlt_dealer] Hadi topu yuvarlayalım!{w=2.0}{nw} [withDissolve(2.0)]"
...
translate turkish lblCheckRoll_4da8e105:
    ...
    RLT_dealer "Topun [playerPiked]{w=3.0} üzerine düşeceğine bahse girersiniz.{nw} [withDissolve()]"
...
translate turkish lblCheckRoll_38a91ca2:
    ...
    RLT_dealer "Sen kazandın! Yuvarlanan sayı [theRoll] ve [theRollOddOrEven_text], renk [theRollColor_text]!{w=3.0}{nw} [withDissolve()]"
...
translate turkish lblCheckRoll_fb67b1be:
    ...
    RLT_dealer "Ödeme 35'e 1'dir, yani $[payout] kazandınız!{w=3.0}{nw} [withDissolve()]"
...
translate turkish lblCheckRoll_a5eb7354:
    ...
    RLT_dealer "Ödeme 17'e 1'dir, yani $[payout] kazandınız!{w=3.0}{nw} [withDissolve()]"
...
translate turkish lblCheckRoll_700ff3e1:
    ...
    RLT_dealer "Ödeme 11'e 1'dir, yani $[payout] kazandınız!{w=3.0}{nw} [withDissolve()]"
...
translate turkish lblCheckRoll_0f532220:
    ...
    RLT_dealer "Ödeme 8'e 1'dir, yani $[payout] kazandınız!{w=3.0}{nw} [withDissolve()]"
...
translate turkish lblCheckRoll_b19b6772:
    ...
    RLT_dealer "Ödeme 2'e 1'dir, yani $[payout] kazandınız!{w=3.0}{nw} [withDissolve()]"
...
translate turkish lblCheckRoll_93d132d6:
    ...
    RLT_dealer "Ödeme 1'e 1'dir, yani $[payout] kazandınız!{w=3.0}{nw} [withDissolve()]"
...
translate turkish strings:
    ...
    new "Rulet oyunundan ayrılmak istiyor musunuz?"
