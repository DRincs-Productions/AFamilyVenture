...
translate turkish cosplaywakeme_7969daaf:
...
translate turkish cosplaywakeme_8ca7da98:
...
translate turkish cosplaywakeme_c5ee3330:
...
translate turkish cosplaywakeme_554188de:
...
translate turkish sidneysleepswithryan_11fccb0d:
...
translate turkish sidneysleepswithryan_b96d631d:
    ...
    S "{i}(Fısıldayarak){/i} İşte bu küçük kardeşim, benim için boşal.... külotumun içine boşal.... bu iyi bir kardeş."

# game/UpdateScript0.02.rpy:298
translate turkish sidneysleepswithryan_70fd47ef:

    # ST "{i}Now to get rid of the evidence.{/i}"
    ST "{i}Şimdi kanıtlardan kurtulalım.{/i}"
...
translate turkish sidneysleepswithryan_1462f465:
    ...
    RT "{i}Oh evet, bundan zevk alıyor olmalı! Onun önünde boşaldıktan sonra bile, hala yatağımda uyumak istiyor.{/i}"

# game/UpdateScript0.02.rpy:339
translate turkish sidneysleepswithryan_9cc1d308:

    # RT "{i}Ok, she should be pretty sound asleep by now.{/i}"
    RT "{i}Tamam, şu anda mışıl mışıl uyuyor olmalı.{/i}"

# game/UpdateScript0.02.rpy:340
translate turkish sidneysleepswithryan_e0c03b64:

    # RT "{i}I'm pretty tired myself.{/i}"
    RT "{i}Ben de çok yorgunum.{/i}"

# game/UpdateScript0.02.rpy:341
translate turkish sidneysleepswithryan_a5ec21b9:

    # RT "{i}I'm not really sure what I should do to her next.{/i}"
    RT "{i}Ona ne yapmam gerektiğinden emin değilim.{/i}"

# game/UpdateScript0.02.rpy:342
translate turkish sidneysleepswithryan_24c241cc:

    # RT "{i}I guess I should just lie here and think a little bit more about how I'm going to progress this.{/i}"
    RT "{i}Sanırım burada uzanmalı ve bunu nasıl ilerleteceğimi biraz daha düşünmeliyim.{/i}"

# game/UpdateScript0.02.rpy:343
translate turkish sidneysleepswithryan_609ec708_1:

    # RT "{i}Hmmmm.... {/i}"
    ""

# game/UpdateScript0.02.rpy:350
translate turkish sidneysleepswithryan_3ee0b323:

    # RT "{i}Hmmm.... what is that feeling?.... Did I doze off?.... {/i}"
    RT "{i}Hmmm.... bu his de ne?.... Uyuya mı kaldım?.... {/i}"

# game/UpdateScript0.02.rpy:353
translate turkish sidneysleepswithryan_ffe6ccdd:

    # RT "{i}Oh my God!! I don't dare open my eyes, but I think Sidney has grabbed my dick by her own free will and choice!!{/i}"
    RT "{i}Aman Tanrım! Gözlerimi açmaya cesaret edemiyorum, ama sanırım Sidney kendi özgür iradesi ve seçimiyle sikimi kavradı!!{/i}"

# game/UpdateScript0.02.rpy:356
translate turkish sidneysleepswithryan_b2d8ded8:

    # ST "{i}Oh my God, I've made this move on my own, and not just subconsciously.{/i}"
    ST "{i}Aman Tanrım, bu hareketi kendi başıma yaptım, sadece bilinçaltımla değil.{/i}"

# game/UpdateScript0.02.rpy:357
translate turkish sidneysleepswithryan_be928525:

    # ST "{i}After what happened last night, I haven't been able to think of anything else.{/i}"
    ST "{i}Dün gece olanlardan sonra başka bir şey düşünemez oldum.{/i}"

# game/UpdateScript0.02.rpy:364
translate turkish sidneysleepswithryan_78132590:

    # ST "{i}I don't want to get covered in his cum again like I did last night though.{/i}"
    ST "{i}Dün gece yaptığım gibi yine onun spermine bulanmak istemiyorum.{/i}"

# game/UpdateScript0.02.rpy:365
translate turkish sidneysleepswithryan_f078cb2b:

    # ST "{i}Hmmmm.... If I wipe it up with his blankets or sheets, he probably will notice.{/i}"
    ST "{i}Hmmmm.... Eğer battaniye ya da çarşafla silersem muhtemelen fark edecektir.{/i}"

# game/UpdateScript0.02.rpy:366
translate turkish sidneysleepswithryan_03f48a82:

    # ST "{i}If I wipe it up with some of my clothes, he might see that too. Plus I don't know if it stains or not.{/i}"
    ST "{i}Kıyafetlerimle silersem onu da görebilir. Ayrıca leke tutup tutmadığını da bilmiyorum.{/i}"

# game/UpdateScript0.02.rpy:367
translate turkish sidneysleepswithryan_b4b3bc25:

    # ST "{i}There is one item of my clothes he doesn't ever see though.{/i}"
    ST "{i}Kıyafetlerimden hiç görmediği bir parça var.{/i}"

# game/UpdateScript0.02.rpy:370
translate turkish sidneysleepswithryan_646aa2f4:

    # ST "{i}If I wipe it up with my panties, he'll never be the wiser.{/i}"
    ST "{i}Eğer onu külotumla silersem, asla fark etmez.{/i}"

# game/UpdateScript0.02.rpy:373
translate turkish sidneysleepswithryan_40f156ae_1:
...
translate turkish sidneysleepswithryan_df33fc4c:
    ...
    RT "{i}Belki de kız kardeşim yatağımda çıplak götüyle oturup sikimle oynadığı içindir.{/i}"

# game/UpdateScript0.02.rpy:378
translate turkish sidneysleepswithryan_4f8a53e8:

    # RT "{i}Why in hell did she take her panties off?{/i}"
    RT "{i}Neden altını çıkardı ki?{/i}"

# game/UpdateScript0.02.rpy:379
translate turkish sidneysleepswithryan_c334a465:

    # RT "{i}Maybe she's planning on sitting on my cock!{/i}"
    RT "{i}Belki de sikimin üstüne oturmayı planlıyordur!{/i}"

# game/UpdateScript0.02.rpy:380
translate turkish sidneysleepswithryan_dcc7199c:

    # RT "{i}Oh, shit!!! Just the thought!! I'm losing it!!!{/i}"
    RT "{i}Oh, siktir!!! Sadece düşünmesi bile!! Kaybediyorum!!!{/i}"

# game/UpdateScript0.02.rpy:387
translate turkish sidneysleepswithryan_b96d631d_1:

    # S "{i}(Whispering){/i} That's it little brother, cum for me.... cum right into my panties.... that's a good brother."
    S "{i}(Fısıldayarak){/i} İşte bu küçük kardeşim, benim için boşal.... külotumun içine boşal.... bu iyi bir kardeş."

# game/UpdateScript0.02.rpy:388
translate turkish sidneysleepswithryan_5bd31dc0_1:

    # "{i}{b}\"Sidney's Libido +1\"{/b}{/i}"
    "{i}{b}\"Sidney'in azgınlığı +1\"{/b}{/i}"

# game/UpdateScript0.02.rpy:390
translate turkish sidneysleepswithryan_70fd47ef_1:

    # ST "{i}Now to get rid of the evidence.{/i}"
    ST "{i}Şimdi kanıtlardan kurtulalım.{/i}"

# game/UpdateScript0.02.rpy:393
translate turkish sidneysleepswithryan_0e21e23e:

    # RT "{i}Holy Hell! She made me bust on purpose! Right into her panties!{/i}"
    RT "{i}Vay anasını! Beni bilerek patlattı! Tam külotunun içine!{/i}"

# game/UpdateScript0.02.rpy:394
translate turkish sidneysleepswithryan_80448df9:

    # RT "{i}Will she go further? Do I just leave it up to her now?{/i}"
    RT "{i}Daha ileri gidecek mi? Bu işi artık ona mı bırakmalıyım?{/i}"

# game/UpdateScript0.02.rpy:395
translate turkish sidneysleepswithryan_e8aa4682:

    # RT "{i}There's always tomorrow night to see if she'll go further.{/i}"
    RT "{i}Daha ileri gidip gitmeyeceğini göreceğiz. Her gecenin bir sabahı var.{/i}"

# game/UpdateScript0.02.rpy:406
translate turkish sidneysleepswithryan_fa8c89ee:

    # RT "{i}Sweet! She came back!{/i}"
    RT "{i}Güzel! Geri döndü!{/i}"

# game/UpdateScript0.02.rpy:414
translate turkish sidneysleepswithryan_9cc1d308_1:

    # RT "{i}Ok, she should be pretty sound asleep by now.{/i}"
    RT "{i}Tamam, şu anda mışıl mışıl uyuyor olmalı.{/i}"

# game/UpdateScript0.02.rpy:415
translate turkish sidneysleepswithryan_2df756e9:

    # RT "{i}Time to have some more fun.{/i}"
    RT "{i}Biraz daha eğlenme zamanı.{/i}"

# game/UpdateScript0.02.rpy:425
translate turkish sidneysleepswithryan_286ce1b6:

    # RT "{i}Ok, I'm all ready. Let's see if I can get her into position again without waking her up.{/i}"
    RT "{i}Tamam, ben hazırım. Bakalım onu uyandırmadan tekrar pozisyonunu alabilecek miyim?{/i}"

# game/UpdateScript0.02.rpy:428
translate turkish sidneysleepswithryan_d94dd63d:

    # RT "{i}Ok, and now to just move her hand into place.{/i}"
    RT "{i}Tamam, şimdi elini ayarlayayım.{/i}"

# game/UpdateScript0.02.rpy:431
translate turkish sidneysleepswithryan_e39ee42d:

    # RT "{i}Ohh.... ho.... hngggg.... wow!{/i}"
    RT "{i}Ohh.... ho.... hngggg.... vayy!{/i}"

# game/UpdateScript0.02.rpy:432
translate turkish sidneysleepswithryan_154150a7:

    # RT "{i}She just started gripping like before! Like she was expecting it.{/i}"
    RT "{i}Eskisi gibi sıkmaya başladı! Sanki bunu bekliyormuş gibi.{/i}"

# game/UpdateScript0.02.rpy:433
translate turkish sidneysleepswithryan_a1797ef5:

    # RT "{i}Oh my God!! I've got my own sister gripping my naked cock again!{/i}"
    RT "{i}Aman Tanrım! Kendi kız kardeşim yine çıplak sikimi kavrıyor!{/i}"

# game/UpdateScript0.02.rpy:434
translate turkish sidneysleepswithryan_a6116004:

    # RT "{i}My own sister has my cock in her soft lovely hands! I love having her sleep in my room!{/i}"
    RT "{i}Öz kız kardeşim sikimi yumuşak ve güzel ellerine aldı! Odamda uyumasına bayılıyorum!{/i}"

# game/UpdateScript0.02.rpy:435
translate turkish sidneysleepswithryan_b910df4d:

    # RT "{i}I've got to really try hard not to just lose my load right now!{/i}"
    RT "{i}Şu anda kendimi kaybetmemek için gerçekten çok çabalamalıyım!{/i}"

# game/UpdateScript0.02.rpy:436
translate turkish sidneysleepswithryan_b18ab89b:

    # RT "{i}Ok, [ryan] concentrate! I don't want to ruin it already!{/i}"
    RT "{i}Tamam, [ryan] konsantre ol! Şimdiden mahvetmek istemiyorum!{/i}"

# game/UpdateScript0.02.rpy:439
translate turkish sidneysleepswithryan_95b021cc:

    # RT "{i}Now, I just have to give her a little pinch again, and act like I'm still asleep.{/i}"
    RT "{i}Şimdi ona tekrar küçük bir çimdik atmam ve hala uyuyormuşum gibi davranmam gerekiyor.{/i}"

# game/UpdateScript0.02.rpy:442
translate turkish sidneysleepswithryan_25274c25:

    # ST "{i}Huh.... did.... what?.... {/i}"
    ST "{i}Huh.... ne.... yapıyorum?.... {/i}"

# game/UpdateScript0.02.rpy:443
translate turkish sidneysleepswithryan_a46a53f9:

    # ST "{i}Is that [ryan]'s cock in my hands again?.... {/i}"
    ST "{i}Elimdeki yine onun siki mi?.... {/i}"

# game/UpdateScript0.02.rpy:446
translate turkish sidneysleepswithryan_baa8c04d:

    # ST "{i}It looks like he is still asleep.{/i}"
    ST "{i}Görünüşe göre uyuyor gibi görünüyor.{/i}"

# game/UpdateScript0.02.rpy:447
translate turkish sidneysleepswithryan_c51a6315:

    # S "{i}(whispering){/i} pssst.... [ryan].... are you asleep?"
    S "{i}(fısıldayarak){/i} şşşt.... [ryan].... uyuyor musun?"

# game/UpdateScript0.02.rpy:448
translate turkish sidneysleepswithryan_429c068c:

    # ST "{i}Good, he's sound asleep.{/i}"
    ST "{i}Güzel, mışıl mışıl uyuyor.{/i}"

# game/UpdateScript0.02.rpy:451
translate turkish sidneysleepswithryan_d7eaee6f:

    # ST "{i}I just can't control myself.{/i}"
    ST "{i}Kendimi kontrol edemiyorum.{/i}"

# game/UpdateScript0.02.rpy:452
translate turkish sidneysleepswithryan_f9815e72:

    # ST "{i}Why do I want to do this so bad?{/i}"
    ST "{i}Bunu yapmayı neden bu kadar çok istiyorum?{/i}"

# game/UpdateScript0.02.rpy:459
translate turkish sidneysleepswithryan_7258e90e:

    # ST "{i}I need to get a closer look.{/i}"
    ST "{i}Daha yakından bakmalıyım.{/i}"

# game/UpdateScript0.02.rpy:462
translate turkish sidneysleepswithryan_d9a4368a:

    # ST "{i}My old boyfriend said the top of the penis is the most sensitive.{/i}"
    ST "{i}Eski erkek arkadaşım sikinin üst kısmının en hassas yer olduğunu söylemişti.{/i}"

# game/UpdateScript0.02.rpy:463
translate turkish sidneysleepswithryan_96bc2f97:

    # ST "{i}It's so soft and smooth.{/i}"
    ST "{i}Çok yumuşak ve pürüzsüz.{/i}"

# game/UpdateScript0.02.rpy:464
translate turkish sidneysleepswithryan_fd971abf:

    # RT "{i}Shit! She's playing with my head!!!!{/i}"
    RT "{i}Siktir! Başıyla oynuyor!!!!{/i}"

# game/UpdateScript0.02.rpy:465
translate turkish sidneysleepswithryan_33abe7a8:

    # RT "{i}That feels so good!!!!{/i}"
    RT "{i}Bu çok iyi hissettiriyor!!!!{/i}"

# game/UpdateScript0.02.rpy:466
translate turkish sidneysleepswithryan_5f608862:

    # RT "{i}I'm not going to be able to hold back much longer.{/i}"
    RT "{i}Kendimi daha fazla tutamayacağım.{/i}"

# game/UpdateScript0.02.rpy:469
translate turkish sidneysleepswithryan_4bebc51f:

    # ST "{i}Holy shit! His veins are just bulging!{/i}"
    ST "{i}Vay anasını! Damarları şişiyor!{/i}"

# game/UpdateScript0.02.rpy:470
translate turkish sidneysleepswithryan_ef9d9279:

    # ST "{i}And the way it's just throbbing and twitching in my hand.... {/i}"
    ST "{i}Ve elimdeki zonklama ve seğirme şekli.... {/i}"

# game/UpdateScript0.02.rpy:471
translate turkish sidneysleepswithryan_d4596586:

    # ST "{i}It's almost like he's about to.... oh.... no.... {/i}"
    ST "{i}Neredeyse.... oh.... hayır.... yapmak üzere gibi.{/i}"

# game/UpdateScript0.02.rpy:478
translate turkish sidneysleepswithryan_a0dd8877:

    # ST "{i}Holy shit!!{/i}"
    ST "{i}Lanet olsun!!{/i}"

# game/UpdateScript0.02.rpy:479
translate turkish sidneysleepswithryan_59adf085:

    # ST "{i}All over my face!!{/i}"
    ST "{i}Yüzümün her yerinde!!{/i}"

# game/UpdateScript0.02.rpy:486
translate turkish sidneysleepswithryan_18a3967a:

    # ST "{i}Fuck, he's still going!{/i}"
    ST "{i}Kahretsin, hala devam ediyor!{/i}"

# game/UpdateScript0.02.rpy:493
translate turkish sidneysleepswithryan_db47d66c:

    # ST "{i}Why won't it stop?!!{/i}"
    ST "{i}Durmak bilmiyor amk?!!{/i}"

# game/UpdateScript0.02.rpy:496
translate turkish sidneysleepswithryan_7c55be36:

    # ST "{i}What in the actual fuck was that?{/i}"
    ST "{i}Bu da neydi amk?{/i}"

# game/UpdateScript0.02.rpy:497
translate turkish sidneysleepswithryan_7b04a67b:

    # ST "{i}I didn't know guys could cum that much.{/i}"
    ST "{i}Erkeklerin bu kadar boşalabildiğini bilmiyordum.{/i}"

# game/UpdateScript0.02.rpy:498
translate turkish sidneysleepswithryan_a04030fc:

    # ST "{i}He must have been very backed up.{/i}"
    ST "{i}Çok sıkışmış olmalı.{/i}"

# game/UpdateScript0.02.rpy:499
translate turkish sidneysleepswithryan_60d1e3df:

    # ST "{i}Maybe he's not jacking off every free moment like I thought he was.{/i}"
    ST "{i}Belki de düşündüğüm gibi her boş anında 31 çekmiyordur.{/i}"

# game/UpdateScript0.02.rpy:500
translate turkish sidneysleepswithryan_1c403472:

    # ST "{i}I am just covered in my own brother's cum!{/i}"
    ST "{i}Öz kardeşimin spermiyle kaplandım!{/i}"

# game/UpdateScript0.02.rpy:501
translate turkish sidneysleepswithryan_191f43be:

    # ST "{i}That is the naughtiest thing I've ever thought of!{/i}"
    ST "{i}Bu şimdiye kadar düşündüğüm en yaramaz şey!{/i}"

# game/UpdateScript0.02.rpy:502
translate turkish sidneysleepswithryan_fbc8ba15:

    # ST "{i}Why do taboo things turn me on so much?{/i}"
    ST "{i}Neden tabu gibi şeyler beni bu kadar tahrik ediyor?{/i}"

# game/UpdateScript0.02.rpy:503
translate turkish sidneysleepswithryan_5bd31dc0_2:

    # "{i}{b}\"Sidney's Libido +1\"{/b}{/i}"
    "{i}{b}\"Sidney'in azgınlığı +1\"{/b}{/i}"

# game/UpdateScript0.02.rpy:505
translate turkish sidneysleepswithryan_5673d77a:

    # RT "{i}OH MY GOD that felt so good! I think I nutted a lot.{/i}"
    RT "{i}AMAN TANRIM bu çok iyi hissettirdi! Sanırım bu çok oldu.{/i}"

# game/UpdateScript0.02.rpy:506
translate turkish sidneysleepswithryan_639e2465:

    # RT "{i}I think all of the jacking off I've been doing has been making me able to cum more.{/i}"
    RT "{i}Sanırım çektiğim tüm otuzbirler daha fazla üretmemi sağladı.{/i}"

# game/UpdateScript0.02.rpy:507
translate turkish sidneysleepswithryan_7fcecca4:

    # ST "{i}I need to go clean up. I think I'll spend the rest of the night on the couch.{/i}"
    ST "{i}Gidip temizlenmem lazım. Sanırım gecenin geri kalanını kanepede geçireceğim.{/i}"

# game/UpdateScript0.02.rpy:510
translate turkish sidneysleepswithryan_bcf3bef0:

    # RT "{i}She left. Did she need to go clean up?{/i}"
    RT "{i}Gitti. Gidip temizlenmesi mi gerekiyordu?{/i}"

# game/UpdateScript0.02.rpy:511
translate turkish sidneysleepswithryan_45eed5a9:

    # RT "{i}I wonder if some of my cum ended up on her.{/i}"
    RT "{i}Acaba spermlerimin bir kısmı onun üzerinde mi kaldı?{/i}"

# game/UpdateScript0.02.rpy:512
translate turkish sidneysleepswithryan_30928bfe:

    # RT "{i}I hope cumming in front of her didn't freak her out too bad.{/i}"
    RT "{i}Umarım onun önünde boşalmak onu çok korkutmamıştır.{/i}"

# game/UpdateScript0.02.rpy:513
translate turkish sidneysleepswithryan_1e5551be:

    # RT "{i}I guess I'll find out if she show's up tomorrow night.{/i}"
    RT "{i}Sanırım yarın gece gelip gelmeyeceğini göreceğim.{/i}"

# game/UpdateScript0.02.rpy:523
translate turkish sidneysleepswithryan_fa8c89ee_1:

    # RT "{i}Sweet! She came back!{/i}"
    RT "{i}Güzel! Geri döndü!{/i}"

# game/UpdateScript0.02.rpy:531
translate turkish sidneysleepswithryan_9cc1d308_2:

    # RT "{i}Ok, she should be pretty sound asleep by now.{/i}"
    RT "{i}Tamam, şu anda mışıl mışıl uyuyor olmalı.{/i}"

# game/UpdateScript0.02.rpy:532
translate turkish sidneysleepswithryan_2df756e9_1:

    # RT "{i}Time to have some more fun.{/i}"
    RT "{i}Biraz daha eğlenme zamanı.{/i}"

# game/UpdateScript0.02.rpy:542
translate turkish sidneysleepswithryan_286ce1b6_1:

    # RT "{i}Ok, I'm all ready. Let's see if I can get her into position again without waking her up.{/i}"
    RT "{i}Tamam, ben hazırım. Bakalım onu uyandırmadan tekrar pozisyonunu alabilecek miyim?{/i}"

# game/UpdateScript0.02.rpy:545
translate turkish sidneysleepswithryan_d94dd63d_1:

    # RT "{i}Ok, and now to just move her hand into place.{/i}"
    RT "{i}Tamam, şimdi elini ayarlayayım.{/i}"

# game/UpdateScript0.02.rpy:548
translate turkish sidneysleepswithryan_e39ee42d_1:

    # RT "{i}Ohh.... ho.... hngggg.... wow!{/i}"
    RT "{i}Ohh.... ho.... hngggg.... vayy!{/i}"

# game/UpdateScript0.02.rpy:549
translate turkish sidneysleepswithryan_154150a7_1:

    # RT "{i}She just started gripping like before! Like she was expecting it.{/i}"
    RT "{i}Eskisi gibi sıkmaya başladı! Sanki bunu bekliyormuş gibi.{/i}"

# game/UpdateScript0.02.rpy:550
translate turkish sidneysleepswithryan_a1797ef5_1:

    # RT "{i}Oh my God!! I've got my own sister gripping my naked cock again!{/i}"
    RT "{i}Aman Tanrım! Kendi kız kardeşim yine çıplak sikimi kavrıyor!{/i}"

# game/UpdateScript0.02.rpy:551
translate turkish sidneysleepswithryan_a6116004_1:

    # RT "{i}My own sister has my cock in her soft lovely hands! I love having her sleep in my room!{/i}"
    RT "{i}Öz kız kardeşim sikimi yumuşak ve güzel ellerine aldı! Odamda uyumasına bayılıyorum!{/i}"

# game/UpdateScript0.02.rpy:552
translate turkish sidneysleepswithryan_b910df4d_1:

    # RT "{i}I've got to really try hard not to just lose my load right now!{/i}"
    RT "{i}Şu anda kendimi kaybetmemek için gerçekten çok çabalamalıyım!{/i}"

# game/UpdateScript0.02.rpy:553
translate turkish sidneysleepswithryan_b18ab89b_1:

    # RT "{i}Ok, [ryan] concentrate! I don't want to ruin it already!{/i}"
    RT "{i}Tamam, [ryan] konsantre ol! Şimdiden mahvetmek istemiyorum!{/i}"

# game/UpdateScript0.02.rpy:556
translate turkish sidneysleepswithryan_95b021cc_1:

    # RT "{i}Now, I just have to give her a little pinch again, and act like I'm still asleep.{/i}"
    RT "{i}Şimdi ona tekrar küçük bir çimdik atmam ve hala uyuyormuşum gibi davranmam gerekiyor.{/i}"

# game/UpdateScript0.02.rpy:559
translate turkish sidneysleepswithryan_25274c25_1:

    # ST "{i}Huh.... did.... what?.... {/i}"
    ST "{i}Huh.... ne.... yapıyorum?.... {/i}"

# game/UpdateScript0.02.rpy:560
translate turkish sidneysleepswithryan_adf2f567:

    # ST "{i}What's.... in my hands?.... {/i}"
    ST "{i}Elimde.... ne var?.... {/i}"

# game/UpdateScript0.02.rpy:563
translate turkish sidneysleepswithryan_ea7d539b:

    # ST "{i}Oh, shit! Not again!.... {/i}"
    ST "{i}Oh, siktir! Yine mi!.... {/i}"

# game/UpdateScript0.02.rpy:566
translate turkish sidneysleepswithryan_0229163b:

    # ST "{i}Wait.... Is he still asleep?{/i}"
    ST "{i}Bekle.... uyuyor mu?{/i}"

# game/UpdateScript0.02.rpy:567
translate turkish sidneysleepswithryan_c51a6315_1:

    # S "{i}(whispering){/i} pssst.... [ryan].... are you asleep?"
    S "{i}(fısıldayarak){/i} şşşt.... [ryan].... uyuyor musun?"

# game/UpdateScript0.02.rpy:568
translate turkish sidneysleepswithryan_429c068c_1:

    # ST "{i}Good, he's sound asleep.{/i}"
    ST "{i}Güzel, mışıl mışıl uyuyor.{/i}"

# game/UpdateScript0.02.rpy:571
translate turkish sidneysleepswithryan_34fd9ceb:

    # ST "{i}I've never held a cock this big in my hand before.{/i}"
    ST "{i}Daha önce hiç bu kadar büyük bir siki elimde tutmamıştım.{/i}"

# game/UpdateScript0.02.rpy:572
translate turkish sidneysleepswithryan_919bdf34:

    # ST "{i}I can feel his blood pumping through his throbbing veins!{/i}"
    ST "{i}Kanının zonklayan damarlarından pompalandığını hissedebiliyorum!{/i}"

# game/UpdateScript0.02.rpy:573
translate turkish sidneysleepswithryan_718cb6b7:

    # ST "{i}I wonder if I.... {/i}"
    ST "{i}Acaba....{/i}"

# game/UpdateScript0.02.rpy:580
translate turkish sidneysleepswithryan_c471307d:

    # R "Hnnnngggghhhh..."
    ""

# game/UpdateScript0.02.rpy:586
translate turkish sidneysleepswithryan_1aa6c33c:

    # ST "{i}Oh, God! Was he waking up?{/i}"
    ST "{i}Oh, Tanrım! Uyanıyor muydu?{/i}"

# game/UpdateScript0.02.rpy:587
translate turkish sidneysleepswithryan_372e4394:

    # ST "{i}I think I almost gave him an orgasm!{/i}"
    ST "{i}Sanırım onu neredeyse orgazm ediyordum!{/i}"

# game/UpdateScript0.02.rpy:588
translate turkish sidneysleepswithryan_2dfbc2cc:

    # ST "{i}Thank God my brother is a deep sleeper.{/i}"
    ST "{i}Tanrıya şükür ki kardeşim kış uykusunda gibi uyur.{/i}"

# game/UpdateScript0.02.rpy:589
translate turkish sidneysleepswithryan_11448a07:

    # ST "{i}What's gotten into me?{/i}"
    ST "{i}Bana ne oldu böyle?{/i}"

# game/UpdateScript0.02.rpy:590
translate turkish sidneysleepswithryan_06787dc9:

    # ST "{i}What was I thinking?{/i}"
    ST "{i}Ne düşünüyordum ki?{/i}"

# game/UpdateScript0.02.rpy:591
translate turkish sidneysleepswithryan_b3be1c8d:

    # ST "{i}I really do have pent up sexual frustration.{/i}"
    ST "{i}Gerçekten bastırılmış cinsel hayal kırıklığım var.{/i}"

# game/UpdateScript0.02.rpy:592
translate turkish sidneysleepswithryan_40a23891:

    # ST "{i}But to try to release it on my own brother?{/i}"
    ST "{i}Ama bunu kendi kardeşimin üzerine yıkmaya çalışmak?{/i}"

# game/UpdateScript0.02.rpy:593
translate turkish sidneysleepswithryan_bb250291:

    # ST "{i}What is wrong with me?{/i}"
    ST "{i}Neyim var benim?{/i}"

# game/UpdateScript0.02.rpy:594
translate turkish sidneysleepswithryan_91d27ffc:

    # ST "{i}Why did it turn me on to have his cock throbbing in my hand?{/i}"
    ST "{i}Neden onun sikinin elimde zonklaması beni tahrik ediyordu?{/i}"

# game/UpdateScript0.02.rpy:595
translate turkish sidneysleepswithryan_5bd31dc0_3:

    # "{i}{b}\"Sidney's Libido +1\"{/b}{/i}"
    "{i}{b}\"Sidney'in azgınlığı +1\"{/b}{/i}"

# game/UpdateScript0.02.rpy:597
translate turkish sidneysleepswithryan_3e9497cb:

    # ST "{i}Shit, Sidney! Think of something else, of something that's not sexy. Not like your brother's penis!{/i}"
    ST "{i}Sikeyim Sidney! Başka bir şey düşün, seksi olmayan bir şey. Kardeşinin sikini değil!{/i}"

# game/UpdateScript0.02.rpy:598
translate turkish sidneysleepswithryan_688da619:

    # ST "{i}Shit! I just admitted to myself that I think my brother's penis is sexy!{/i}"
    ST "{i}Siktir! Az önce kardeşimin sikini seksi bulduğumu kendime itiraf ettim!{/i}"

# game/UpdateScript0.02.rpy:599
translate turkish sidneysleepswithryan_4d8c6efb:

    # ST "{i}AAAARRRGGGHHH.... get a grip, Sidney!{/i}"
    ST "{i}AĞHĞAĞAĞH.... kendine gel Sidney!{/i}"

# game/UpdateScript0.02.rpy:600
translate turkish sidneysleepswithryan_b6c7f50d:

    # ST "{i}Just go back to sleep!{/i}"
    ST "{i}Sadece uyumaya devam et!{/i}"

# game/UpdateScript0.02.rpy:601
translate turkish sidneysleepswithryan_b6c7f50d_1:

    # ST "{i}Just go back to sleep!{/i}"
    ST "{i}Sadece uyumaya devam et!{/i}"

# game/UpdateScript0.02.rpy:604
translate turkish sidneysleepswithryan_38643a23:

    # ST "{i}.... just.... go.... to.... sleep.... my brother's penis.... {/i}"
    ST "{i}.... sadece.... uyu.... uykuya.... dal.... kardeşimin siki.... {/i}"

# game/UpdateScript0.02.rpy:607
translate turkish sidneysleepswithryan_7f9f0508:

    # ST "{i}No! Don't think about your brother's penis! Just go to sleep!{/i}"
    ST "{i}Hayır! Kardeşinin sikini düşünme! Sadece uyu!{/i}"

# game/UpdateScript0.02.rpy:608
translate turkish sidneysleepswithryan_63847329:

    # ST "{i}Just go to sleep.... just go to sleep.... {/i}"
    ST "{i}Sadece uyu.... sadece uyu.... {/i}"

# game/UpdateScript0.02.rpy:614
translate turkish sidneysleepswithryan_12862598:

    # RT "{i}Dammit!{/i}"
    RT "{i}Kahretsin!{/i}"

# game/UpdateScript0.02.rpy:615
translate turkish sidneysleepswithryan_0b03968f:

    # RT "{i}I ruined it by making that involuntary groan!{/i}"
    RT "{i}O istemsiz iniltiyi çıkararak mahvettim!{/i}"

# game/UpdateScript0.02.rpy:616
translate turkish sidneysleepswithryan_76333c9e:

    # RT "{i}How far would she have gone if I'd just kept my mouth shut?{/i}"
    RT "{i}Çenemi kapalı tutsaydım ne kadar ileri gidebilirdi?{/i}"

# game/UpdateScript0.02.rpy:617
translate turkish sidneysleepswithryan_783ef71e:

    # RT "{i}I guess I'll find out next time, if she keeps coming back to sleep in here.{/i}"
    RT "{i}Sanırım bir dahaki sefere öğreneceğim, eğer burada uyumak için geri gelmeye devam ederse.{/i}"

# game/UpdateScript0.02.rpy:618
translate turkish sidneysleepswithryan_bf917965:

    # RT "{i}She hasn't left yet so that's a good sign.{/i}"
    RT "{i}Henüz gitmedi bu iyiye işaret.{/i}"

# game/UpdateScript0.02.rpy:619
translate turkish sidneysleepswithryan_8fdf5dde:

    # RT "{i}I guess I'll just have to wait until tomorrow night to know for sure.{/i}"
    RT "{i}Sanırım emin olmak için yarın geceye kadar beklemem gerekecek.{/i}"

# game/UpdateScript0.02.rpy:639
translate turkish sidneysleepswithryan_9cc1d308_3:

    # RT "{i}Ok, she should be pretty sound asleep by now.{/i}"
    RT "{i}Tamam, şu anda mışıl mışıl uyuyor olmalı.{/i}"

# game/UpdateScript0.02.rpy:640
translate turkish sidneysleepswithryan_22ab2b80:

    # RT "{i}Time to have a little fun.{/i}"
    RT "{i}Biraz eğlenme zamanı.{/i}"
...
translate turkish sidneysleepswithryan_e39ee42d_2:

    # RT "{i}Ohh.... ho.... hngggg.... wow!{/i}"
    RT "{i}Ohh.... ho.... hngggg.... vayy!{/i}"

# game/UpdateScript0.02.rpy:657
translate turkish sidneysleepswithryan_4716b7b2:

    # RT "{i}She just started gripping like she was expecting it.{/i}"
    RT "{i}Sanki bunu bekliyormuş gibi kavramaya başladı.{/i}"

# game/UpdateScript0.02.rpy:658
translate turkish sidneysleepswithryan_681c9e45:

    # RT "{i}Oh my God!! I've got Sidney gripping my naked cock!{/i}"
    RT "{i}Aman Tanrım! Sidney çıplak sikimi kavrıyor!{/i}"

# game/UpdateScript0.02.rpy:659
translate turkish sidneysleepswithryan_801ff432:

    # RT "{i}Sidney has my cock in her soft lovely hands! This worked out better than I could have hoped for!{/i}"
    RT "{i}Sidney sikimi yumuşak ve güzel ellerine aldı! Bu umduğumdan daha iyi oldu!{/i}"

# game/UpdateScript0.02.rpy:660
translate turkish sidneysleepswithryan_b910df4d_2:

    # RT "{i}I've got to really try hard not to just lose my load right now!{/i}"
    RT "{i}Şu anda kendimi kaybetmemek için gerçekten çok çabalamalıyım!{/i}"

# game/UpdateScript0.02.rpy:661
translate turkish sidneysleepswithryan_b18ab89b_2:

    # RT "{i}Ok, [ryan] concentrate! I don't want to ruin it already!{/i}"
    RT "{i}Tamam, [ryan] konsantre ol! Şimdiden mahvetmek istemiyorum!{/i}"

# game/UpdateScript0.02.rpy:664
translate turkish sidneysleepswithryan_3843fabb:

    # RT "{i}Now, I just have to give her a little pinch, and act like I'm still asleep.{/i}"
    ""

# game/UpdateScript0.02.rpy:667
translate turkish sidneysleepswithryan_25274c25_2:

    # ST "{i}Huh.... did.... what?.... {/i}"
    ST "{i}Huh.... ne.... yapıyorum?.... {/i}"

# game/UpdateScript0.02.rpy:668
translate turkish sidneysleepswithryan_adf2f567_1:

    # ST "{i}What's.... in my hands?.... {/i}"
    ST "{i}Elimde.... ne var?.... {/i}"

# game/UpdateScript0.02.rpy:671
translate turkish sidneysleepswithryan_ab3efd5f:

    # ST "{i}Oh, shit!.... {/i}"
    ST "{i}Oh, siktir!.... {/i}"

# game/UpdateScript0.02.rpy:677
translate turkish sidneysleepswithryan_b694862b:

    # ST "{i}Oh, God! I've done it again!{/i}"
    ST "{i}Oh, Tanrım! Yine yaptım!{/i}"

# game/UpdateScript0.02.rpy:678
translate turkish sidneysleepswithryan_cca3e339:

    # ST "{i}Why can't I just keep my hands to myself while I'm sleeping?{/i}"
    ST "{i}Neden uyurken ellerime hakim olamıyorum?{/i}"

# game/UpdateScript0.02.rpy:679
translate turkish sidneysleepswithryan_2dfbc2cc_1:

    # ST "{i}Thank God my brother is a deep sleeper.{/i}"
    ST "{i}Tanrıya şükür ki kardeşim kış uykusunda gibi uyur.{/i}"

# game/UpdateScript0.02.rpy:680
translate turkish sidneysleepswithryan_81bbcc6e:

    # ST "{i}Do I need to ask [ryan] to tie my hands before I go to sleep?{/i}"
    ST "{i}Uyumadan önce ondan ellerimi bağlamasını isteyeyim mi?{/i}"

# game/UpdateScript0.02.rpy:681
translate turkish sidneysleepswithryan_cccc5db4:

    # ST "{i}Then he'd probably take advantage of me.{/i}"
    ST "{i}O zaman muhtemelen benden faydalanırdı.{/i}"

# game/UpdateScript0.02.rpy:682
translate turkish sidneysleepswithryan_9a8fdb7c:

    # ST "{i}What am I saying? I'm the one who molests everyone in their sleep.{/i}"
    ST "{i}Ne diyorum ben? Herkesi uykusunda taciz eden benim.{/i}"

# game/UpdateScript0.02.rpy:683
translate turkish sidneysleepswithryan_7299b78b:

    # ST "{i}Do I just have a ton of pent up sexual frustration like Mom said?{/i}"
    ST "{i}Annemin dediği gibi bir ton bastırılmış cinsel hayal kırıklığım mı var?{/i}"

# game/UpdateScript0.02.rpy:684
translate turkish sidneysleepswithryan_d4928b85:

    # ST "{i}Does my body subconsciously need the sexual contact?{/i}"
    ST "{i}Bedenim bilinçaltında cinsel temasa mı ihtiyaç duyuyor?{/i}"

# game/UpdateScript0.02.rpy:685
translate turkish sidneysleepswithryan_0e286957:

    # ST "{i}I can't believe I grabbed my brother's dick!{/i}"
    ST "{i}Kardeşimin sikini tuttuğuma inanamıyorum!{/i}"

# game/UpdateScript0.02.rpy:686
translate turkish sidneysleepswithryan_09288847:

    # ST "{i}That was such a big handful!{/i}"
    ST "{i}Bu çok büyük bir avuçlamaydı!{/i}"

# game/UpdateScript0.02.rpy:687
translate turkish sidneysleepswithryan_e3eb862d:

    # ST "{i}He's way bigger than my old boyfriend.{/i}"
    ST "{i}Eski erkek arkadaşımınkinden çok daha büyük.{/i}"

# game/UpdateScript0.02.rpy:688
translate turkish sidneysleepswithryan_5bd31dc0_4:

    # "{i}{b}\"Sidney's Libido +1\"{/b}{/i}"
    "{i}{b}\"Sidney'in azgınlığı +1\"{/b}{/i}"

# game/UpdateScript0.02.rpy:690
translate turkish sidneysleepswithryan_0a8df8f2:

    # ST "{i}Shit, Sidney! Stop thinking about your brother's penis!{/i}"
    ST "{i}Sikeyim Sidney! Kardeşinin sikini düşünmeyi bırak!{/i}"

# game/UpdateScript0.02.rpy:691
translate turkish sidneysleepswithryan_bb250291_1:

    # ST "{i}What is wrong with me?{/i}"
    ST "{i}Neyim var benim?{/i}"

# game/UpdateScript0.02.rpy:692
translate turkish sidneysleepswithryan_b6c7f50d_2:

    # ST "{i}Just go back to sleep!{/i}"
    ST "{i}Sadece uyumaya devam et!{/i}"

# game/UpdateScript0.02.rpy:693
translate turkish sidneysleepswithryan_b6c7f50d_3:

    # ST "{i}Just go back to sleep!{/i}"
    ST "{i}Sadece uyumaya devam et!{/i}"

# game/UpdateScript0.02.rpy:696
translate turkish sidneysleepswithryan_38643a23_1:

    # ST "{i}.... just.... go.... to.... sleep.... my brother's penis.... {/i}"
    ST "{i}.... sadece.... uyu.... uykuya.... dal.... kardeşimin siki.... {/i}"

# game/UpdateScript0.02.rpy:699
translate turkish sidneysleepswithryan_7f9f0508_1:

    # ST "{i}No! Don't think about your brother's penis! Just go to sleep!{/i}"
    ST "{i}Hayır! Kardeşinin sikini düşünme! Sadece uyu!{/i}"

# game/UpdateScript0.02.rpy:700
translate turkish sidneysleepswithryan_63847329_1:

    # ST "{i}Just go to sleep.... just go to sleep.... {/i}"
    ST "{i}Sadece uyu.... sadece uyu.... {/i}"

# game/UpdateScript0.02.rpy:706
translate turkish sidneysleepswithryan_757e9023:

    # RT "{i}Oh, that was awesome!{/i}"
    RT "{i}Oh, bu harikaydı!{/i}"

# game/UpdateScript0.02.rpy:707
translate turkish sidneysleepswithryan_e7d4d015:

    # RT "{i}I hope that didn't scare her too much.{/i}"
    RT "{i}Umarım bu onu çok fazla korkutmamıştır.{/i}"

# game/UpdateScript0.02.rpy:708
translate turkish sidneysleepswithryan_3d511e16:

    # RT "{i}I really hope she comes back again tomorrow night so I can continue our progress.{/i}"
    RT "{i}Umarım yarın gece tekrar gelir de ilerlememize devam edebiliriz.{/i}"

# game/UpdateScript0.02.rpy:709
translate turkish sidneysleepswithryan_e99614ff:

    # RT "{i}She hasn't left yet, so that's a good sign.{/i}"
    RT "{i}Henüz gitmedi, bu iyiye işaret.{/i}"

# game/UpdateScript0.02.rpy:710
translate turkish sidneysleepswithryan_8fdf5dde_1:

    # RT "{i}I guess I'll just have to wait until tomorrow night to know for sure.{/i}"
    RT "{i}Sanırım emin olmak için yarın geceye kadar beklemem gerekecek.{/i}"

# game/UpdateScript0.02.rpy:724
translate turkish sidneysleepswithryan_929ee1a3:

    # RT "{i}Ok.... I hear her coming.... she's opening the door.... just pretend you're asleep.{/i}"
    RT "{i}Tamam.... geldiğini duyuyorum.... kapıyı açıyor.... sadece uyuyormuş gibi yap.{/i}"

# game/UpdateScript0.02.rpy:725
translate turkish sidneysleepswithryan_643ec372:

    # S "Pssstttt.... hey, [ryan].... are you awake?"
    S "Pssstttt.... hey [ryan].... uyanık mısın?"

# game/UpdateScript0.02.rpy:730
translate turkish sidneysleepswithryan_85444fff:

    # R "Hey, Sidney. What are you doing in my room in the middle of the night?"
    R "Hey, Sidney. Gecenin bir yarısı odamda ne yapıyorsun?"

# game/UpdateScript0.02.rpy:731
translate turkish sidneysleepswithryan_3de9b6a5:

    # S "You said I could come wake you if I heard any noises in the night."
    S "Gece herhangi bir ses duyarsam gelip seni uyandırabileceğimi söylemiştin."

# game/UpdateScript0.02.rpy:732
translate turkish sidneysleepswithryan_8bb14c49:

    # R "Yeah, I remember."
    R "Evet, hatırlıyorum."

# game/UpdateScript0.02.rpy:733
translate turkish sidneysleepswithryan_008982ff:

    # R "But I checked things out and didn't see anything."
    R "Ama her şeyi kontrol ettim ve hiçbir şey görmedim."

# game/UpdateScript0.02.rpy:734
translate turkish sidneysleepswithryan_20ccbff5:

    # S "Still, I'm pretty shaken up by the thought that someone could be watching me sleep."
    S "Yine de birinin beni uyurken izliyor olabileceği düşüncesi beni oldukça korkuttu."

# game/UpdateScript0.02.rpy:735
translate turkish sidneysleepswithryan_b49f3af0:

    # S "Do you mind if I sleep in here so I'm not alone?"
    S "Yalnız kalmamak için burada uyumamın sakıncası var mı?"

# game/UpdateScript0.02.rpy:736
translate turkish sidneysleepswithryan_5dfd6ffb:

    # R "Well, why don't you sleep with Lauren or Mom?"
    R "Neden Lauren ya da annemle birlikte uyumuyorsun?"

# game/UpdateScript0.02.rpy:737
translate turkish sidneysleepswithryan_fd3d2a9a:

    # RT "{i}Hehehehe.... {/i}"
    RT "{i}Hehehehe :)))) {/i}"

# game/UpdateScript0.02.rpy:738
translate turkish sidneysleepswithryan_89f8223e:

    # S ".... Umm.... I uh.... just feel safer with you."
    S ".... Umm.... Ben.... sadece senin yanında güvende hissediyorum."

# game/UpdateScript0.02.rpy:739
translate turkish sidneysleepswithryan_57d56fd5:

    # R "You said you think Mom is probably stronger than me."
    R "Annemin benden daha güçlü olduğunu düşündüğünü söylemiştin."

# game/UpdateScript0.02.rpy:740
translate turkish sidneysleepswithryan_693b9a45:

    # S "Yeah, well.... I was just being a bratty sister."
    S "Evet, iyi.... Sadece şımarık bir kardeş gibi davranıyordum."

# game/UpdateScript0.02.rpy:741
translate turkish sidneysleepswithryan_c2d0b757:

    # R "Well, as long as you're willing to admit that, than I guess I'll let you sleep in here with me."
    R "Madem bunu kabul ediyorsun, o zaman burada benimle uyumana izin veririm."

# game/UpdateScript0.02.rpy:742
translate turkish sidneysleepswithryan_99dc2208:

    # R "But don't you usually sleep in your panties?"
    R "Ama sen genelde külotunla uyumaz mısın?"

# game/UpdateScript0.02.rpy:743
translate turkish sidneysleepswithryan_765d1948:

    # S "Yeah, well I'd be an idiot to sleep with a suspected pervert in nothing but my panties wouldn't I?"
    S "Evet, şüpheli bir sapıkla külotumla uyumak aptallık olurdu, değil mi?"

# game/UpdateScript0.02.rpy:744
translate turkish sidneysleepswithryan_52a3f1b5:

    # R "Oh, hardy har har!"
    R "Oh, ne ka komik, ne ka komik, ne ka komik!"

# game/UpdateScript0.02.rpy:745
translate turkish sidneysleepswithryan_b683f14f:

    # R "I'm not a pervert."
    R "Ben sapık değilim."

# game/UpdateScript0.02.rpy:746
translate turkish sidneysleepswithryan_cbfe80c4:

    # RT "{i}I'm the worst kind of pervert.{/i}"
    RT "{i}Ben sapıkların en kötüsüyüm.{/i}"

# game/UpdateScript0.02.rpy:747
translate turkish sidneysleepswithryan_17a8764c:

    # S "(Just stares at you)"
    S "(Sadece sana bakar)"

# game/UpdateScript0.02.rpy:748
translate turkish sidneysleepswithryan_d5bd3beb:

    # R "Ok, maybe just a little teenage curiosity."
    R "Tamam, belki sadece biraz ergenlik merakı."

# game/UpdateScript0.02.rpy:749
translate turkish sidneysleepswithryan_f6f03be6:

    # R "But don't worry, I'm a very deep sleeper."
    R "Ama endişelenme, ayı gibi uyurum."

# game/UpdateScript0.02.rpy:750
translate turkish sidneysleepswithryan_84b67126:

    # R "I take melatonin at night to help me sleep."
    R "Geceleri uyumama yardımcı olması için melatonin alıyorum."

# game/UpdateScript0.02.rpy:751
translate turkish sidneysleepswithryan_f6288fcd:

    # R "You should try it."
    R "Sen de denemelisin."

# game/UpdateScript0.02.rpy:752
translate turkish sidneysleepswithryan_4684d31e:

    # S "I don't think I need it, I've been sleeping pretty deeply myself lately."
    S "İhtiyacım olduğunu sanmıyorum, son zamanlarda ben de oldukça derin uyuyorum."

# game/UpdateScript0.02.rpy:753
translate turkish sidneysleepswithryan_19cf4ee3:

    # ST "{i}With the exception of a few interruptions.{/i}"
    ST "{i}Birkaç olay dışında.{/i}"

# game/UpdateScript0.02.rpy:754
translate turkish sidneysleepswithryan_991c1d34:

    # S "So, will you scoot over and let me sleep with you? I'm pretty tired."
    S "Kenara çekilip seninle uyumama izin verir misin? Çok yorgunum."

# game/UpdateScript0.02.rpy:755
translate turkish sidneysleepswithryan_af2d31f1:

    # R "Ok.... I guess.... but you owe me."
    R "Tamam.... sanırım.... ama bana borçlusun."

# game/UpdateScript0.02.rpy:756
translate turkish sidneysleepswithryan_7bfa39f3:

    # S "Owe you what?"
    S "Sana ne borçluyum?"

# game/UpdateScript0.02.rpy:757
translate turkish sidneysleepswithryan_96492c77:

    # R "I don't know, I'll think of something."
    R "Bilmiyorum, bir şeyler düşüneceğim."

# game/UpdateScript0.02.rpy:758
translate turkish sidneysleepswithryan_ebdd0137:

    # S "Whatever!"
    S "Her neyse!"

# game/UpdateScript0.02.rpy:759
translate turkish sidneysleepswithryan_ba9243ea:

    # S "Oh, and honey?"
    S "Oh, ve tatlım?"

# game/UpdateScript0.02.rpy:760
translate turkish sidneysleepswithryan_95428694:

    # R "Yeah?"
    R "Efendim?"

# game/UpdateScript0.02.rpy:761
translate turkish sidneysleepswithryan_21c413ba:

    # S "Don't tell Mom or Lauren that I'm sleeping with you."
    S "Anneme ya da Lauren'a seninle uyuduğumu söyleme."

# game/UpdateScript0.02.rpy:762
translate turkish sidneysleepswithryan_ca7e84a9:

    # R "Why not?"
    R "Neden olmasın?"

# game/UpdateScript0.02.rpy:763
translate turkish sidneysleepswithryan_746649e3:
    ...
    S "Bunun tuhaf olduğunu düşünürler, aslında kimsenin burada uyuduğumdan şüphelenmeyeceği kadar erken kalkacağım."

# game/UpdateScript0.02.rpy:764
translate turkish sidneysleepswithryan_9453ad20:

    # S "It will give me a great excuse to do a morning jog in the park."
    S "Bu bana parkta sabah koşusu yapmak için harika bir bahane olacak."

# game/UpdateScript0.02.rpy:765
translate turkish sidneysleepswithryan_6804784c:

    # S "Promise not to tell."
    S "Söylemeyeceğine söz ver."

# game/UpdateScript0.02.rpy:766
translate turkish sidneysleepswithryan_8eeb8580:

    # R "Ok, I can do that."
    R "Tamam, bunu yapabilirim."

# game/UpdateScript0.02.rpy:769
translate turkish sidneysleepswithryan_15102bf4:

    # RT "{i}Ohhohoho yes.... that was a lot of work, but now the real fun can begin.{/i}"
    RT "{i}Ohhohoho evet.... bunun için çok uğraştım, ama şimdi gerçek eğlence başlayabilir.{/i}"

# game/UpdateScript0.02.rpy:770
translate turkish sidneysleepswithryan_4489b4a4:

    # RT "{i}She's had a rough few nights, so I think I'll give her a break right now, but tomorrow.... we'll just see.{/i}"
    RT "{i}Zor birkaç gece geçirdi, bu yüzden sanırım şu anda ona biraz ara vereceğim, ama yarın.... göreceğiz.{/i}"

# game/UpdateScript0.02.rpy:780
translate turkish getsidneyoffthecouch_e08c6a81:

    # RT "{i}I feel kind of bad for everything I've put Sidney through to get her out of Lauren's room.{/i}"
    RT "{i}Sidney'i Lauren'in odasından çıkarmak için yaptığım her şey için kendimi kötü hissediyorum.{/i}"

# game/UpdateScript0.02.rpy:781
translate turkish getsidneyoffthecouch_32ad7ce4:

    # RT "{i}Now she's stuck sleeping on this uncomfortable couch. Maybe there's a way to make it better for both of us.{/i}"
    RT "{i}Şimdi bu berbat kanepede uyumak zorunda. Belki bunu ikimiz için de daha iyi hale getirmenin bir yolu vardır.{/i}"

# game/UpdateScript0.02.rpy:786
translate turkish getsidneyoffthecouch_7dc02987:

    # RT "{i}Ok, it's time to put my acting skills to the test.{/i}"
    RT "{i}Tamamdır, oyunculuk yeteneklerimi test etme zamanı geldi.{/i}"

# game/UpdateScript0.02.rpy:787
translate turkish getsidneyoffthecouch_49584b2f:

    # RT "{i}It looks like she's pretty out of it, I'd better make some noise to wake her up.{/i}"
    RT "{i}Kendinde değil gibi görünüyor, onu uyandırmak için biraz ses çıkarsam iyi olacak.{/i}"

# game/UpdateScript0.02.rpy:792
translate turkish getsidneyoffthecouch_8603b2a3:

    # S "[ryan]? Why are you making so much noise..."
    S "[ryan]? Neden bu kadar gürültü yapıyorsun..."

# game/UpdateScript0.02.rpy:793
translate turkish getsidneyoffthecouch_e22c6c77:

    # S "And why do you have a bat in your hands?"
    S "Ve neden elinde bir sopa var?"

# game/UpdateScript0.02.rpy:794
translate turkish getsidneyoffthecouch_3230ad47:

    # S "Are you here to kill me?"
    S "Beni öldürmeye mi geldin?"

# game/UpdateScript0.02.rpy:795
translate turkish getsidneyoffthecouch_032216cf:

    # R "Oh, haha.... sorry to wake you, I didn't mean to drop my bat."
    R "Oh, haha.... uyandırdığım için özür dilerim, sopamı düşürmek istememiştim."

# game/UpdateScript0.02.rpy:796
translate turkish getsidneyoffthecouch_6e9da006:

    # R "I was just checking the house to make sure everything is safe."
    R "Her şeyin güvende olduğundan emin olmak için evi kontrol ediyordum."

# game/UpdateScript0.02.rpy:797
translate turkish getsidneyoffthecouch_b8754f0e:

    # R "I heard some noises around the house like someone was sneaking around."
    R "Evin etrafında birileri gizlice dolaşıyormuş gibi bazı sesler duydum."

# game/UpdateScript0.02.rpy:798
translate turkish getsidneyoffthecouch_b7784451:

    # S "It was probably just Mom or Lauren using the bathroom."
    S "Muhtemelen annem ya da Lauren tuvaleti kullanıyordu."

# game/UpdateScript0.02.rpy:799
translate turkish getsidneyoffthecouch_7dcbd9c7:

    # R "It wasn't, I already checked on them."
    R "Onlar değildi, onları çoktan kontrol ettim."

# game/UpdateScript0.02.rpy:800
translate turkish getsidneyoffthecouch_f36dae0c:

    # R "It sounded more like a window opening and closing, and booted footsteps sneaking around in this room."
    R "Ses daha çok bir pencerenin açılıp kapanmasına ve odanın içinde sinsice dolaşan ayak seslerine benziyordu."

# game/UpdateScript0.02.rpy:801
translate turkish getsidneyoffthecouch_b8a262d4:

    # R "Did you see or hear anything?"
    R "Bir şey gördün mü ya da duydun mu?"

# game/UpdateScript0.02.rpy:802
translate turkish getsidneyoffthecouch_fe3ad1d5:

    # S "No, are you sure you heard these noises?"
    S "Hayır, bu sesleri duyduğuna emin misin?"

# game/UpdateScript0.02.rpy:803
translate turkish getsidneyoffthecouch_f5928a3b:
    ...
    R "Tam olarak değil, ama mafya ve FBI ile ilgili olan biten her şey göz önüne alındığında, onlardan herhangi birinin burada gizlice dolaşmasının mümkün olduğunu düşündüm."

# game/UpdateScript0.02.rpy:804
translate turkish getsidneyoffthecouch_0f1badd1:
    ...
    R "Biz uyurken iç çamaşırlarımızla etrafta gizlice dolaşıp bizi gözetlediklerini düşünmek bile beni bir sopa kapıp etrafı kontrol etmeye itti."

# game/UpdateScript0.02.rpy:805
translate turkish getsidneyoffthecouch_7b04cafc:

    # S "Well, go back to sleep, I'm sure you were just imagining things."
    S "Uyumaya devam et, eminim sadece hayal görüyordun."

# game/UpdateScript0.02.rpy:806
translate turkish getsidneyoffthecouch_f26ad90f:

    # R "Ok, but if you hear anything, come and tell me, ok?"
    R "Tamam ama bir şey duyarsan gel ve bana söyle, tamam mı?"

# game/UpdateScript0.02.rpy:807
translate turkish getsidneyoffthecouch_0839905c:

    # S "Yeah right, I think I'd go tell Mom she's probably stronger than you."
    S "Evet doğru, sanırım gidip anneme söylerdim, o muhtemelen senden daha güçlüdür."

# game/UpdateScript0.02.rpy:808
translate turkish getsidneyoffthecouch_e6619df8:

    # R "No, she's not!"
    R "Hayır, değil!"

# game/UpdateScript0.02.rpy:809
translate turkish getsidneyoffthecouch_92db5806:

    # S "Ok whatever, just go back to sleep."
    S "Tamam, her neyse. Uyumaya devam et."

# game/UpdateScript0.02.rpy:810
translate turkish getsidneyoffthecouch_5d602c8a:

    # R "Ok, goodnight."
    R "Tamam, iyi geceler."

# game/UpdateScript0.02.rpy:813
translate turkish getsidneyoffthecouch_29927f2a:

    # ST "{i}Shit, I hope [ryan] was just imagining things.{/i}"
    ST "{i}Siktir, umarım [ryan] sadece hayal görüyordur.{/i}"

# game/UpdateScript0.02.rpy:814
translate turkish getsidneyoffthecouch_cfd34de7:

    # ST "{i}What if some pervert from the FBI or Mafia was snooping around in here?{/i}"
    ST "{i}Ya FBI'dan ya da mafyadan bir sapık burayı gözetliyorsa?{/i}"

# game/UpdateScript0.02.rpy:815
translate turkish getsidneyoffthecouch_458c1411:

    # ST "{i}I would be their first victim. I have no protection of a room or a locked door.{/i}"
    ST "{i}İlk kurbanları ben olurdum. Ne bir oda ne de kilitli bir kapı korumam var.{/i}"

# game/UpdateScript0.02.rpy:816
translate turkish getsidneyoffthecouch_18e0f423:

    # ST "{i}Shit, now I'm just freaking myself out.{/i}"
    ST "{i}Siktir, şimdi de kendimi korkutuyorum.{/i}"

# game/UpdateScript0.02.rpy:817
translate turkish getsidneyoffthecouch_af81cdcd:

    # ST "{i}I've got to control my imagination.{/i}"
    ST "{i}Hayal gücümü kontrol etmeliyim.{/i}"

# game/UpdateScript0.02.rpy:820
translate turkish getsidneyoffthecouch_2a02388c:

    # ST "{i}Oh, shit! What was that?{/i}"
    ST "{i}Oh, siktir! Bu da neydi?{/i}"

# game/UpdateScript0.02.rpy:823
translate turkish getsidneyoffthecouch_d860cef2:

    # ST "{i}I'm getting out of here. There should be room in Mom's bed.{/i}"
    ST "{i}Buradan gidiyorum. Annemin yatağında yer olmalı.{/i}"

# game/UpdateScript0.02.rpy:824
translate turkish getsidneyoffthecouch_5014ea5f:

    # RT "{i}Shit, she's going to Mom's bed. I really was hoping that she would come to me for protection.{/i}"
    RT "{i}Kahretsin, annemin yatağına gidiyor. Gerçekten korunmak için bana gelmesini umuyordum.{/i}"

# game/UpdateScript0.02.rpy:825
translate turkish getsidneyoffthecouch_f8702290:

    # RT "{i}Well, I've got a few more tricks up my sleeve.{/i}"
    RT "{i}Elimde birkaç numara daha var.{/i}"

# game/UpdateScript0.02.rpy:836
translate turkish givesidneymoneyforcosplay_53a5049c:

    # S "Hey [ryan], what can I do for you?"
    S "Hey [ryan], senin için ne yapabilirim?"

# game/UpdateScript0.02.rpy:837
translate turkish givesidneymoneyforcosplay_e2069dcd:

    # R "I've got the money for Lauren's cosplay outfit."
    R "Lauren'in cosplay kıyafeti için param var."

# game/UpdateScript0.02.rpy:840
translate turkish givesidneymoneyforcosplay_1a471edc:

    # S "Are you sure? Aren't you supposed to be saving up to pay the DeCapos at the end of the week?"
    S "Emin misin? Hafta sonunda DeCapos'a ödeme yapmak için para biriktirmen gerekmiyor mu?"

# game/UpdateScript0.02.rpy:843
translate turkish givesidneymoneyforcosplay_98c19aa7:
...
translate turkish givesidneymoneyforcosplay_25d608c0:
...
translate turkish givesidneymoneyforcosplay_13b30cdc:

    # R "Oh please, our mom isn't in any danger."
    ""

# game/UpdateScript0.02.rpy:853
translate turkish givesidneymoneyforcosplay_3e143f5a_1:

    # "{i}\"Money - $400\"{/i}"
    "{i}\"Paran -$400\"{/i}"

# game/UpdateScript0.02.rpy:860
translate turkish givesidneymoneyforcosplay_10adc244:

    # R "So, how long will it take to finish?"
    R "Ee, bitirmesi ne kadar sürer?"

# game/UpdateScript0.02.rpy:861
translate turkish givesidneymoneyforcosplay_9c41c972:
...
translate turkish kitchencosplayfitting_554188de:
...
translate turkish spycambath_90724d57:
    ...
    RT "{i}Casusluk kamerasindaki talimatlar, telefonumu canlı video akışına bağlayabileceğimi söylüyor.{/i}"

# game/UpdateScript0.02.rpy:990
translate turkish spycambath_f5a3833f:

    # RT "{i}It doesn't actually record video, I can only see what's going on live.{/i}"
    RT "{i}Aslında video kaydetmiyor, sadece neler olup bittiğini canlı olarak görebiliyorum.{/i}"

# game/UpdateScript0.02.rpy:991
translate turkish spycambath_da46de46:

    # RT "{i}But it does have the option for me to snap pictures when I'm watching a live stream.{/i}"
    RT "{i}Ancak canlı yayın izlerken fotoğraf çekebilmem için bir seçeneği var.{/i}"

# game/UpdateScript0.02.rpy:992
translate turkish spycambath_e6731e48:

    # RT "{i}Ok, let's get this baby set up.{/i}"
    RT "{i}Tamam, hadi şu bebeği hazırlayalım.{/i}"

# game/UpdateScript0.02.rpy:995
translate turkish spycambath_bf7b2b87:

    # RT "{i}Ok, I just need to get this footstool moved over here.... {/i}"
    RT "{i}Tamam, sadece şu tabureyi buraya taşımam gerekiyor.... {/i}"

# game/UpdateScript0.02.rpy:996
translate turkish spycambath_b3e99540:

    # RT "{i}And use this screwdriver to open this vent.... {/i}"
    RT "{i}Ve bu tornavidayı kullanarak havalandırma deliğini açmalıyım.... {/i}"

# game/UpdateScript0.02.rpy:997
translate turkish spycambath_5f00d363:

    # RT "{i}Dammit!.... That hurt!.... {/i}"
    RT "{i}Hasiktir!.... Bu acıttı!.... {/i}"

# game/UpdateScript0.02.rpy:998
translate turkish spycambath_7171c896:

    # RT "{i}You stupid goddamn piece of shit! Open up.{/i}"
    RT "{i}Seni aptal orospu çocuğu! Açıl.{/i}"

# game/UpdateScript0.02.rpy:999
translate turkish spycambath_30e04fdb:

    # RT "{i}You son of a bitch mother fucker!{/i}"
    RT "{i}Anasını siktiğimin orospusu!{/i}"

# game/UpdateScript0.02.rpy:1000
translate turkish spycambath_cff63916:

    # RT "{i}Finally!.... Ok, just place it so it can see between the grates.... {/i}"
    RT "{i}Sonunda!.... Tamam, sadece ızgaraların arasını görebilecek şekilde yerleştireyim.... {/i}"

# game/UpdateScript0.02.rpy:1001
translate turkish spycambath_5a07fa8b:

    # RT "{i}And turn it on!{/i}"
    RT "{i}Ve aç!{/i}"

# game/UpdateScript0.02.rpy:1004
translate turkish spycambath_bf4f9cc1:

    # RT "{i}Ok, perfect.... It should be streaming to my phone now.{/i}"
    RT "{i}Tamam, mükemmel.... Şimdi telefonumda görünüyor olmalı.{/i}"

# game/UpdateScript0.02.rpy:1007
translate turkish spycambath_b8588873:

    # RT "{i}All right, just a slight adjustment so I have a good view of the shower,{/i}"
    RT "{i}Pekala, duşu iyi görebilmem için ufak bir ayarlama yapacağım,{/i}"

# game/UpdateScript0.02.rpy:1008
translate turkish spycambath_e03a2027:

    # RT "{i}.... and now I should be able to see live streams of whatever it is the girls do in here.{/i}"
    RT "{i}.... ve şimdi kızlar burada ne yapıyorsa canlı yayından görebilmeliyim.{/i}"

# game/UpdateScript0.02.rpy:1009
translate turkish spycambath_84b9e393:

    # RT "{i}I can't wait! It's amazingly convenient that the girls all have predictable bathroom schedules.... hmmmm.{/i}"
    RT "{i}Sabırsızlanıyorum! Kızların hepsinin öngörülebilir banyo programlarının olması inanılmaz derecede uygun.... hmmmm.{/i}"

# game/UpdateScript0.02.rpy:1019
translate turkish spycambath_7e00f0c5:
...
translate turkish spycambath_1133ecb0:
...
translate turkish spycambath_d7ba672d:
...
translate turkish laurenbathspycam_e0aac073:

    # RT "{i}Lauren's taking her early morning shower before school. Thanks to my new spy-cam, I can take a peek.{/i}"
    RT "{i}Lauren okuldan önce sabah duşunu alıyor. Yeni casusluk kameram sağ olsun, bir göz atabilirim.{/i}"

# game/UpdateScript0.02.rpy:1057
translate turkish laurenbathspycam_a7d1c510:
...
translate turkish laurenbathspycam_1c116a65:

    # RT "{i}These little cameras have pretty decent reception and video quality.{/i}"
    RT "{i}Bu küçük kameralar oldukça iyi bir çekim ve görüntü kalitesine sahip.{/i}"

# game/UpdateScript0.02.rpy:1067
translate turkish laurenbathspycam_5e95ce5e:

    # RT "{i}Nice! It's time for a show!{/i}"
    RT "{i}Güzel! Gösteri zamanı!{/i}"

# game/UpdateScript0.02.rpy:1068
translate turkish laurenbathspycam_f730ff02:

    # RT "{i}Best thousand dollars I've ever spent.{/i}"
    RT "{i}Harcadığım en iyi bin dolardı.{/i}"

# game/UpdateScript0.02.rpy:1071
translate turkish laurenbathspycam_57bf2159:

    # RT "{i}The zoom function on this camera is pretty good too.{/i}"
    RT "{i}Bu kameranın yakınlaştırma işlevi de oldukça iyi.{/i}"

# game/UpdateScript0.02.rpy:1072
translate turkish laurenbathspycam_ce4efb74:

    # RT "{i}Oh, I love those tiny titties!{/i}"
    RT "{i}O minik memelere bayılıyorum!{/i}"

# game/UpdateScript0.02.rpy:1075
translate turkish laurenbathspycam_504bf9c1:

    # RT "{i}Oh, yeah! Get that dirty body clean!{/i}"
    RT "{i}Oh, evet! O kirli vücudunu temizle!{/i}"

# game/UpdateScript0.02.rpy:1076
translate turkish laurenbathspycam_c57d47b2:

    # RT "{i}If only she'd just turn a little to the left.{/i}"
    RT "{i}Keşke biraz sola dönse.{/i}"

# game/UpdateScript0.02.rpy:1078
translate turkish laurenbathspycam_c66f9310:

    # RT "{i}Oh, well, this will still make a great picture.{/i}"
    RT "{i}Yine de harika bir resim olacak. {/i}"

# game/UpdateScript0.02.rpy:1084
translate turkish laurenbathspycam_1370df27:

    # RT "{i}Aaauhh.... I've been here too long, I'd better go before I'm caught.{/i}"
    RT "{i}Aaauhh.... Çok uzun zamandır buradayım, yakalanmadan gitsem iyi olacak.{/i}"

# game/UpdateScript0.02.rpy:1098
translate turkish laurenfingerselfbath_a7d1c510:

    # RT "{i}She's already showered, she'll be coming out that door any second. I don't want to be creeping around when she does.{/i}"
    ""

# game/UpdateScript0.02.rpy:1105
translate turkish laurenfingerselfbath_1c116a65:
...
translate turkish laurenfingerselfbath_4ab07f0b:
    ...
    RT "{i}Bu anı kaydetmeliyim. tamam, canlı yayını izlerken ekrana iki kez dokunmak fotoğraf çekecektir.{/i}"
...
translate turkish laurenfingerselfbath_09951cce_1:
...
translate turkish laurenfingerselfbath_27c7399f:
    ...
    RT "{i}Sanırım yeterince cesursan her şey bir dildodur.{/i}"

# game/UpdateScript0.02.rpy:1156
translate turkish laurenfingerselfbath_27c7399f_1:
...
translate turkish laurenfingerselfbathcontinued_48af735f:
    ...
    RT "{i}Oh!.... Sanırım yaklaştı!{/i}"

# game/UpdateScript0.02.rpy:1168
translate turkish laurenfingerselfbathcontinued_744c96ef:

    # RT "{i}Holy shit!.... She's trying to give the shower head some competition!{/i}"
    ""

# game/UpdateScript0.02.rpy:1169
translate turkish laurenfingerselfbathcontinued_aea8e9a9:
...
translate turkish sidneybathspycam_534206cc:

    # RT "{i}Sidney must be taking a shower. Mom and Lauren don't seem to be around.{/i}"
    RT "{i}Sidney duş alıyor olmalı. Annem ve Lauren ortalıkta görünmüyorlar.{/i}"

# game/UpdateScript0.02.rpy:1209
translate turkish sidneybathspycam_3b6e563f:

    # RT "{i}Sidney must be taking a shower. Mom and Lauren are already at school.{/i}"
    ""

# game/UpdateScript0.02.rpy:1210
translate turkish sidneybathspycam_ae8eb73c:

    # RT "{i}Thanks to my new spy-cam, I can take a peek and see.{/i}"
    ""

# game/UpdateScript0.02.rpy:1215
translate turkish sidneybathspycam_a7d1c510:

    # RT "{i}She's already showered, she'll be coming out that door any second. I don't want to be creeping around when she does.{/i}"
    ""

# game/UpdateScript0.02.rpy:1222
translate turkish sidneybathspycam_1c116a65:

    # RT "{i}These little cameras have pretty decent reception and video quality.{/i}"
    RT "{i}Bu küçük kameralar oldukça iyi bir çekim ve görüntü kalitesine sahip.{/i}"

# game/UpdateScript0.02.rpy:1225
translate turkish sidneybathspycam_42e65536:

    # RT "{i}Nice! I should have made popcorn!{/i}"
    RT "{i}Güzel! Patlamış mısır yapmalıydım!{/i}"

# game/UpdateScript0.02.rpy:1226
translate turkish sidneybathspycam_739d7426:

    # RT "{i}This is the best show in town.{/i}"
    RT "{i}Bu şehirdeki en iyi gösteri.{/i}"

# game/UpdateScript0.02.rpy:1229
translate turkish sidneybathspycam_57bf2159:

    # RT "{i}The zoom function on this camera is pretty good too.{/i}"
    RT "{i}Bu kameranın yakınlaştırma işlevi de oldukça iyi.{/i}"

# game/UpdateScript0.02.rpy:1230
translate turkish sidneybathspycam_56d8d777:

    # RT "{i}She has probably got the finest ass I've ever seen, and those tan lines just make me want to nut on the spot!{/i}"
    RT "{i}Muhtemelen şimdiye kadar gördüğüm en güzel göte sahip ve o bronzluk çizgileri beni oracıkta delirtiyor!{/i}"

# game/UpdateScript0.02.rpy:1233
translate turkish sidneybathspycam_0a4770f7:

    # RT "{i}Oh, yeah! Wash that dirty hair!{/i}"
    RT "{i}Oh, evet! Yıka şu kirli saçını!{/i}"

# game/UpdateScript0.02.rpy:1234
translate turkish sidneybathspycam_111b9212:

    # RT "{i}Thank you for spreading those legs.{/i}"
    RT "{i}Bacaklarını açtığın için teşekkürler.{/i}"

# game/UpdateScript0.02.rpy:1236
translate turkish sidneybathspycam_f807c6a9:

    # RT "{i}This will make a great picture.{/i}"
    RT "{i}Bu harika bir resim olacak.{/i}"

# game/UpdateScript0.02.rpy:1242
translate turkish sidneybathspycam_1370df27:

    # RT "{i}Aaauhh.... I've been here too long, I'd better go before I'm caught.{/i}"
    RT "{i}Aaauhh.... Çok uzun zamandır buradayım, yakalanmadan gitsem iyi olacak.{/i}"

# game/UpdateScript0.02.rpy:1256
translate turkish sidneyfingerselfbath_a7d1c510:
...
translate turkish sidneyfingerselfbath_27c7399f_1:
...
translate turkish sidneyfingerselfbathcontinued_4ab05f5b:

    # RT "{i}Holy shit!.... This is like shower-ception!{/i}"
    ""

# game/UpdateScript0.02.rpy:1326
translate turkish sidneyfingerselfbathcontinued_5d5037bb:
...
translate turkish mombathspycam_aa45da92:
    ...
    RT "{i}Annem okuldan sonra duş alıyor. Yeni casusluk kameram sayesinde, bir göz atabilirim.{/i}"

# game/UpdateScript0.02.rpy:1368
translate turkish mombathspycam_a7d1c510:

    # RT "{i}She's already showered, she'll be coming out that door any second. I don't want to be creeping around when she does.{/i}"
    ""

# game/UpdateScript0.02.rpy:1375
translate turkish mombathspycam_1c116a65:

    # RT "{i}These little cameras have pretty decent reception and video quality.{/i}"
    RT "{i}Bu küçük kameralar oldukça iyi bir çekim ve görüntü kalitesine sahip.{/i}"

# game/UpdateScript0.02.rpy:1378
translate turkish mombathspycam_c3387317:

    # RT "{i}Oh, Mom looks so tired, probably all the stress of everything going on!{/i}"
    RT "{i}Annem çok yorgun görünüyor, muhtemelen her şeyin stresi devam ediyor!{/i}"

# game/UpdateScript0.02.rpy:1379
translate turkish mombathspycam_e16163ce:

    # RT "{i}I wish I could go in there and give her some physical comfort.{/i}"
    RT "{i}Keşke oraya girip onu biraz rahatlatabilseydim.{/i}"

# game/UpdateScript0.02.rpy:1382
translate turkish mombathspycam_962685f8:

    # RT "{i}I wonder what's going through Mom's head.{/i}"
    RT "{i}Annemin aklından neler geçiyor merak ediyorum.{/i}"

# game/UpdateScript0.02.rpy:1385
translate turkish mombathspycam_63556558:

    # RT "{i}Oh, good! The show's getting better. I could never get tired of looking at her in the shower from this angle!{/i}"
    RT "{i}Oh, güzel! Bu gösteri iyiye gidiyor. Duşta ona bu açıdan bakmaktan asla bıkmam!{/i}"

# game/UpdateScript0.02.rpy:1386
translate turkish mombathspycam_6512e583:

    # RT "{i}Although Mom does look really good on a pole.{/i}"
    RT "{i}Gerçi annem bir direğin üzerinde gerçekten iyi görünüyor.{/i}"

# game/UpdateScript0.02.rpy:1388
translate turkish mombathspycam_1d1ab5b0:

    # RT "{i}I'll just have to save this for later.{/i}"
    RT "{i}Bunu sonraya saklamam gerekecek.{/i}"

# game/UpdateScript0.02.rpy:1394
translate turkish mombathspycam_1370df27:

    # RT "{i}Aaauhh.... I've been here too long, I'd better go before I'm caught.{/i}"
    RT "{i}Aaauhh.... Çok uzun zamandır buradayım, yakalanmadan gitsem iyi olacak.{/i}"

# game/UpdateScript0.02.rpy:1408
translate turkish momfingerselfbath_a7d1c510:

    # RT "{i}She's already showered, she'll be coming out that door any second. I don't want to be creeping around when she does.{/i}"
    ""

# game/UpdateScript0.02.rpy:1413
translate turkish momfingerselfbath_b205a100:

    # RT "{i}Alright, show me what I paid $1000 for.{/i}"
    RT "{i}Pekala, bana 1000 doları neye ödediğimi göster.{/i}"

# game/UpdateScript0.02.rpy:1416
translate turkish momfingerselfbath_ad0a7f6d:

    # RT "{i}Oh man, Mom's going for it!{/i}"
    RT "{i}Oh adamım, anneme bak!{/i}"

# game/UpdateScript0.02.rpy:1417
translate turkish momfingerselfbath_ee4ba136:

    # RT "{i}Without Dad, she must be feeling pretty lonely.{/i}"
    RT "{i}Babam olmadan, kendini çok yalnız hissediyor olmalı.{/i}"

# game/UpdateScript0.02.rpy:1421
translate turkish momfingerselfbath_a36e2811:

    # RT "{i}Oh.... ho.... ho.... Mom really is a naughty girl, giving her asshole a little attention too.{/i}"
    RT "{i}Oh.... ho.... ho.... Annem gerçekten yaramaz bir kız, göt deliğine de biraz ilgi gösteriyor.{/i}"

# game/UpdateScript0.02.rpy:1422
translate turkish momfingerselfbath_d407ffbb:

    # RT "{i}What is it that's making her so horny?{/i}"
    RT "{i}Onu bu kadar azdıran şey ne?{/i}"

# game/UpdateScript0.02.rpy:1423
translate turkish momfingerselfbath_2e6a3bcd:

    # RT "{i}Is she thinking about all those men watching her strip?{/i}"
    RT "{i}Onu soyunurken izleyen tüm o erkekleri mi düşünüyor?{/i}"

# game/UpdateScript0.02.rpy:1424
translate turkish momfingerselfbath_ad8bbae1:

    # RT "{i}Is she thinking about me sneaking into the club to watch her strip?{/i}"
    RT "{i}Onu soyunurken izlemek için kulübe gizlice girdiğim anı mı düşünüyor?{/i}"

# game/UpdateScript0.02.rpy:1428
translate turkish momfingerselfbath_563d1eb2:

    # RT "{i}Did she just stick that shampoo bottle into her ass?{/i}"
    RT "{i}O şampuan şişesini götüne mi soktu?{/i}"

# game/UpdateScript0.02.rpy:1430
translate turkish momfingerselfbath_4ab07f0b:

    # RT "{i}I have to capture this moment. ok, just double tapping the screen while watching a livefeed should take a pic.{/i}"
    RT "{i}Bu anı kaydetmeliyim. tamam, canlı yayını izlerken ekrana iki kez dokunmak fotoğraf çekecektir.{/i}"

# game/UpdateScript0.02.rpy:1437
translate turkish momfingerselfbath_96fd17c8:

    # RT "{i}Awesome! I've got a picture of Mom pleasuring her asshole!{/i}"
    RT "{i}Harika! Annemin göt deliğini tatmin ederken çekilmiş bir fotoğrafı var!{/i}"

# game/UpdateScript0.02.rpy:1438
translate turkish momfingerselfbath_b1d22fbf:
    ...
    RT "{i}Çok kolay giriyor! Babam analdan hoşlanacak birine benzemiyor. Belki de kendini hep bu şekilde tatmin etmek zorunda kalmıştır.{/i}"

# game/UpdateScript0.02.rpy:1439
translate turkish momfingerselfbath_7bb3ee6c:

    # RT "{i}Well, I'll be happy to fill that void for her, so to speak.{/i}"
    RT "{i}Onun için bu boşluğu doldurmaktan onur duyacağım.{/i}"

# game/UpdateScript0.02.rpy:1441
translate turkish momfingerselfbath_cf1b7440:

    # RT "{i}Fucking lucky bottle!{/i}"
    ""

# game/UpdateScript0.02.rpy:1445
translate turkish momfingerselfbath_9a61365f:

    # RT "{i}What I wouldn't give to be in that bottle's place right now!{/i}"
    RT "{i}Şu anda o şişenin yerinde olmak için neler vermezdim!{/i}"
...
translate turkish momfingerselfbath_27c7399f:

    # RT "{i}I guess anything's a dildo if you're brave enough.{/i}"
    RT "{i}Sanırım yeterince cesursan her şey bir dildodur.{/i}"

# game/UpdateScript0.02.rpy:1465
translate turkish momfingerselfbath_27c7399f_1:

    # RT "{i}I guess anything's a dildo if you're brave enough.{/i}"
    RT "{i}Sanırım yeterince cesursan her şey bir dildodur.{/i}"

# game/UpdateScript0.02.rpy:1469
translate turkish momfingerselfbathcontinued_14dff635:

    # RT "{i}Soon Mom won't have to resort to such measures to get her itches scratched.{/i}"
    RT "{i}Yakında annem kaşıntısını kaşıtmak için bu tür şeylere başvurmak zorunda kalmayacak.{/i}"

# game/UpdateScript0.02.rpy:1470
translate turkish momfingerselfbathcontinued_e497f864:

    # RT "{i}Her son will be more than willing.{/i}"
    RT "{i}Oğlu çok istekli olacak.{/i}"

# game/UpdateScript0.02.rpy:1471
translate turkish momfingerselfbathcontinued_2fc8bf31:

    # RT "{i}I've just got to get her to overcome her already formed ideas of where that kind of love should come from.{/i}"
    RT "{i}Sadece bu tür bir sevginin nereden gelmesi gerektiğine dair oluşmuş fikirlerinin üstesinden gelmesini sağlamalıyım.{/i}"

# game/UpdateScript0.02.rpy:1472
translate turkish momfingerselfbathcontinued_bac3e511:

    # RT "{i}I've still got a lot of work ahead of me.{/i}"
    RT "{i}Önümde yapacak daha çok şey var.{/i}"

# game/UpdateScript0.02.rpy:1474
translate turkish momfingerselfbathcontinued_48af735f:

    # RT "{i}Oh!.... I think she's about there!{/i}"
    RT "{i}Oh!.... Sanırım yaklaştı!{/i}"

# game/UpdateScript0.02.rpy:1479
translate turkish momfingerselfbathcontinued_caf9963f:

    # RT "{i}Holy shit!.... If her spray range gets much bigger, she's going to ruin my camara!{/i}"
    RT "{i}Siktir!.... Daha da genişlerse, kameramı mahvedecek!{/i}"

# game/UpdateScript0.02.rpy:1480
translate turkish momfingerselfbathcontinued_69e5f1f9:

    # RT "{i}And I don't think I can send her the bill for a replacement.{/i}"
    RT "{i}Ve yenisi için faturayı ona gönderebileceğimi sanmıyorum.{/i}"

# game/UpdateScript0.02.rpy:1483
translate turkish momfingerselfbathcontinued_ae1bcaec:

    # RT "{i}Great job today, Mom! I'll try to make it to your next show.{/i}"
    RT "{i}Bugün iyi iş çıkardın anne! Bir sonraki gösterine gelmeye çalışacağım.{/i}"

# game/UpdateScript0.02.rpy:1484
translate turkish momfingerselfbathcontinued_7a379bd5:

    # "{i}{b}\"Mom's Libido -5\"{/b}{/i}"
    "{i}{b}\"Annemin azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:1524
translate turkish spycammomroom_90724d57:

    # RT "{i}So, the instructions on the spy-cam say that I can link my phone to the live video feed.{/i}"
    RT "{i}Casusluk kamerasindaki talimatlar, telefonumu canlı video akışına bağlayabileceğimi söylüyor.{/i}"

# game/UpdateScript0.02.rpy:1525
translate turkish spycammomroom_f5a3833f:

    # RT "{i}It doesn't actually record video, I can only see what's going on live.{/i}"
    RT "{i}Aslında video kaydetmiyor, sadece neler olup bittiğini canlı olarak görebiliyorum.{/i}"

# game/UpdateScript0.02.rpy:1526
translate turkish spycammomroom_da46de46:

    # RT "{i}But it does have the option for me to snap pictures when I'm watching a live stream.{/i}"
    RT "{i}Ancak canlı yayın izlerken fotoğraf çekebilmem için bir seçeneği var.{/i}"

# game/UpdateScript0.02.rpy:1527
translate turkish spycammomroom_e6731e48:

    # RT "{i}Ok, let's get this baby set up.{/i}"
    RT "{i}Tamam, hadi şu bebeği hazırlayalım.{/i}"

# game/UpdateScript0.02.rpy:1530
translate turkish spycammomroom_786ca567:

    # RT "{i}Ok, I just need to climb up on this cabinet.... {/i}"
    RT "{i}Tamam, bu dolabın üzerine çıkmam gerekiyor.... {/i}"

# game/UpdateScript0.02.rpy:1531
translate turkish spycammomroom_b3e99540:

    # RT "{i}And use this screwdriver to open this vent.... {/i}"
    RT "{i}Ve bu tornavidayı kullanarak havalandırma deliğini açmalıyım.... {/i}"

# game/UpdateScript0.02.rpy:1532
translate turkish spycammomroom_0e00cf13:

    # RT "{i}Ouch.... dammit!.... That hurt!.... {/i}"
    RT "{i}Ah.... kahretsin!.... Bu acıttı!.... {/i}"

# game/UpdateScript0.02.rpy:1533
translate turkish spycammomroom_2adaba05:

    # RT "{i}You cunt sucking douche mouth!{/i}"
    RT "{i}Seni amcık yalayıcı pislik!{/i}"

# game/UpdateScript0.02.rpy:1534
translate turkish spycammomroom_6e4aa58e:

    # RT "{i}Chode licking, cock gobbler!{/i}"
    RT "{i}Otuzbirci, yarrak yalayıcı!!{/i}"

# game/UpdateScript0.02.rpy:1535
translate turkish spycammomroom_cff63916:

    # RT "{i}Finally!.... Ok, just place it so it can see between the grates.... {/i}"
    RT "{i}Sonunda!.... Tamam, sadece ızgaraların arasını görebilecek şekilde yerleştireyim.... {/i}"

# game/UpdateScript0.02.rpy:1536
translate turkish spycammomroom_5a07fa8b:

    # RT "{i}And turn it on!{/i}"
    RT "{i}Ve aç!{/i}"

# game/UpdateScript0.02.rpy:1539
translate turkish spycammomroom_bf4f9cc1:

    # RT "{i}Ok, perfect.... It should be streaming to my phone now.{/i}"
    RT "{i}Tamam, mükemmel.... Şimdi telefonumda görünüyor olmalı.{/i}"

# game/UpdateScript0.02.rpy:1542
translate turkish spycammomroom_e33728b6:

    # RT "{i}All right, just a slight adjustment so I have a good view of the bed.{/i}"
    RT "{i}Pekala, yatağı iyi görebilmem için ufak bir ayar yapalım.{/i}"

# game/UpdateScript0.02.rpy:1543
translate turkish spycammomroom_392864f1:

    # RT "{i}.... and now I should be able to see live streams of whatever it is Mom does in here.{/i}"
    RT "{i}.... ve şimdi annem burada ne yapıyorsa canlı yayından görebilmeliyim.{/i}"

# game/UpdateScript0.02.rpy:1544
translate turkish spycammomroom_28ca5ebe:

    # RT "{i}I can't wait! It's amazingly convenient that Mom has a predictable daily schedule.... hmmmm.{/i}"
    RT "{i}Sabırsızlanıyorum! Annemin öngörülebilir bir günlük programı olması inanılmaz derecede uygun.... hmmmm.{/i}"

# game/UpdateScript0.02.rpy:1554
translate turkish spycammomroom_bc42173c:
...
translate turkish momhornybedroom_3f915308:
...
translate turkish momspycamroom_6d6fb1a6_1:

    # RT "{i}Oh yes, finally the good part.{/i}"
    RT "{i}Evet, nihayet en iyi kısmı.{/i}"

# game/UpdateScript0.02.rpy:1737
translate turkish momspycamroom_590f6f50_1:

    # RT "{i}Just.... wow.... what a body!{/i}"
    RT "{i}Sadece.... vay.... ne vücut ama!{/i}"

# game/UpdateScript0.02.rpy:1740
translate turkish momspycamroom_a26be530_1:

    # "{i}\"A little while later.\"{/i}"
    "{i}\"Bir süre sonra.\"{/i}"

# game/UpdateScript0.02.rpy:1750
translate turkish momspycamroom_8d42cd64_1:

    # RT "{i}Looks like she's about done, I should get out of here before she walks out that door.{/i}"
    RT "{i}İşi bitmek üzere gibi görünüyor, o kapıdan çıkmadan buradan gitmeliyim.{/i}"

# game/UpdateScript0.02.rpy:1764
translate turkish momspycamroom_ffe33709_2:

    # RT "{i}That's how she stays in such great shape.{/i}"
    RT "{i}Bu sayede bu kadar formda kalabiliyor.{/i}"

# game/UpdateScript0.02.rpy:1773
translate turkish momspycamroom_6d6fb1a6_2:

    # RT "{i}Oh yes, finally the good part.{/i}"
    RT "{i}Evet, nihayet en iyi kısmı.{/i}"

# game/UpdateScript0.02.rpy:1776
translate turkish momspycamroom_590f6f50_2:

    # RT "{i}Just.... wow.... what a body!{/i}"
    RT "{i}Sadece.... vay.... ne vücut ama!{/i}"

# game/UpdateScript0.02.rpy:1779
translate turkish momspycamroom_a26be530_2:

    # "{i}\"A little while later.\"{/i}"
    "{i}\"Bir süre sonra.\"{/i}"

# game/UpdateScript0.02.rpy:1789
translate turkish momspycamroom_8d42cd64_2:

    # RT "{i}Looks like she's about done, I should get out of here before she walks out that door.{/i}"
    RT "{i}İşi bitmek üzere gibi görünüyor, o kapıdan çıkmadan buradan gitmeliyim.{/i}"

# game/UpdateScript0.02.rpy:1805
translate turkish momspycamroomhorny_d0f070da:
    ...
    RT "{i}Görünüşe göre annem babam olmadan biraz yalnız hissediyor, onu bu tür bir ilgi için bana gelebileceğine ikna etmeliyim.{/i}"

# game/UpdateScript0.02.rpy:1809
translate turkish momspycamroomhorny_d0f070da_1:

    # RT "{i}Looks like Mom's feeling a little lonely without Dad, I've got to convince her that she can come to me for this kind of attention.{/i}"
    RT "{i}Görünüşe göre annem babam olmadan biraz yalnız hissediyor, onu bu tür bir ilgi için bana gelebileceğine ikna etmeliyim.{/i}"

# game/UpdateScript0.02.rpy:1812
translate turkish momspycamroomhorny_2254c2a6:

    # RT "{i}Good timing on my part, I think she's just getting started.{/i}"
    RT "{i}Benim açımdan iyi zamanlama, sanırım daha yeni başlıyor.{/i}"

# game/UpdateScript0.02.rpy:1818
translate turkish momspycamroomhorny_d5ba5b7b:

    # RT "{i}Is that a fucking butt plug?{/i}"
    RT "{i}Bu lanet bir anal tıkacı mı?{/i}"

# game/UpdateScript0.02.rpy:1819
translate turkish momspycamroomhorny_d4f415ec:

    # RT "{i}I guess Mom's into that kind of thing.{/i}"
    RT "{i}Sanırım annem bu tür şeylerden hoşlanıyor.{/i}"

# game/UpdateScript0.02.rpy:1820
translate turkish momspycamroomhorny_c06f2955:

    # MT "{i}Time to give the new plug a try.{/i}"
    MT "{i}Yeni anal tıkacını denemenin zamanı geldi.{/i}"

# game/UpdateScript0.02.rpy:1821
translate turkish momspycamroomhorny_0adac316:

    # MT "{i}Uuug.... why did [dad_name] force anal on me? Now it's hard for me to even cum without something in my ass.{/i}"
    MT "{i}Uuug.... neden [dad_name] beni anala zorladı? Şimdi kıçımda bir şey olmadan boşalmam bile zor.{/i}"
...
translate turkish momspycamroomhorny_875e3b12:

    # RT "{i}Holy.... she's sliding it in slowly.... I've got to get a picture.{/i}"
    RT "{i}Vay a.... yavaşça kaydırıyor.... Bir fotoğraf çekmeliyim.{/i}"

# game/UpdateScript0.02.rpy:1833
translate turkish momspycamroomhorny_ad450396:

    # RT "{i}There's some future jack-off material.{/i}"
    RT "{i}Geleceğin mastürbasyon malzemesi.{/i}"

# game/UpdateScript0.02.rpy:1834
translate turkish momspycamroomhorny_8f3a795f:

    # MT "{i}Oh God, it's been a little while.{/i}"
    MT "{i}Tanrım, uzun zaman oldu.{/i}"

# game/UpdateScript0.02.rpy:1836
translate turkish momspycamroomhorny_8cc7890f:

    # RT "{i}The look on her face.... It looks so uncomfortable.... does she really like it?{/i}"
    RT "{i}Yüzündeki ifade.... Çok rahatsız görünüyor.... gerçekten beğeniyor mu?{/i}"

# game/UpdateScript0.02.rpy:1837
translate turkish momspycamroomhorny_1a24661d:
...
translate turkish momspycamroomhorny_f79e083d:

    # MT "{i}Oh, Fuuuuuuck!!!{/i}"
    MT "{i}Oh, Sikeyiiiim!!!{/i}"

# game/UpdateScript0.02.rpy:1870
translate turkish momspycamroomhorny_b368b647:

    # MT "{i}Oh my God!.... I'm squirting!!{/i}"
    MT "{i}Aman Tanrım!.... Boşalıyorum!!{/i}"

# game/UpdateScript0.02.rpy:1874
translate turkish momspycamroomhorny_de1b100b:
...
translate turkish momspycamroomhorny_0a6bf903:
...
translate turkish momspycamroomhorny_7a379bd5:

    # "{i}{b}\"Mom's Libido -5\"{/b}{/i}"
    "{i}{b}\"Annemin azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:1893
translate turkish momspycamroomhorny_16d37eb8:

    # RT "{i}I might need to go back to my room to take care of something myself.{/i}"
    RT "{i}Bir şeyle ilgilenmek için odama dönmem gerekebilir.{/i}"

# game/UpdateScript0.02.rpy:1898
translate turkish momspycamroomhorny_da5b6539:

    # RT "{i}I should probably go get some sleep now, maybe.... {/i}"
    RT "{i}Şimdi gidip biraz uyusam iyi olacak.... {/i}"
...
translate turkish momspycamroomhorny_f79e083d_1:

    # MT "{i}Oh, Fuuuuuuck!!!{/i}"
    MT "{i}Oh, Sikeyiiiim!!!{/i}"

# game/UpdateScript0.02.rpy:1920
translate turkish momspycamroomhorny_b368b647_1:

    # MT "{i}Oh my God!.... I'm squirting!!{/i}"
    MT "{i}Aman Tanrım!.... Boşalıyorum!!{/i}"

# game/UpdateScript0.02.rpy:1924
translate turkish momspycamroomhorny_de1b100b_1:
...
translate turkish momspycamroomhorny_0a6bf903_1:
...
translate turkish momspycamroomhorny_47bb6ec2_1:

    # RT "{i}Wow! Mom's a squirter too.{/i}"
    RT "{i}Vay canına! Annem de çeşme kadınıymış.{/i}"

# game/UpdateScript0.02.rpy:1936
translate turkish momspycamroomhorny_d812643e_1:
...
translate turkish momspycamroomhorny_7a379bd5_1:

    # "{i}{b}\"Mom's Libido -5\"{/b}{/i}"
    "{i}{b}\"Annemin azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:1943
translate turkish momspycamroomhorny_16d37eb8_1:

    # RT "{i}I might need to go back to my room to take care of something myself.{/i}"
    RT "{i}Bir şeyle ilgilenmek için odama dönmem gerekebilir.{/i}"

# game/UpdateScript0.02.rpy:1948
translate turkish momspycamroomhorny_da5b6539_1:
...
translate turkish momspycamroomhorny_5e311e46:
...
translate turkish momspycamroomhorny_1e794b98_2:

    # MT "{i}But that felt sooooo good!{/i}"
    ""

# game/UpdateScript0.02.rpy:1977
translate turkish momspycamroomhorny_0a6bf903_2:
...
translate turkish momspycamroomhorny_47bb6ec2_2:

    # RT "{i}Wow! Mom's a squirter too.{/i}"
    RT "{i}Vay canına! Annem de çeşme kadınıymış.{/i}"

# game/UpdateScript0.02.rpy:1986
translate turkish momspycamroomhorny_d812643e_2:
...
translate turkish momspycamroomhorny_7a379bd5_2:

    # "{i}{b}\"Mom's Libido -5\"{/b}{/i}"
    "{i}{b}\"Annemin azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:1993
translate turkish momspycamroomhorny_16d37eb8_2:

    # RT "{i}I might need to go back to my room to take care of something myself.{/i}"
    RT "{i}Bir şeyle ilgilenmek için odama dönmem gerekebilir.{/i}"

# game/UpdateScript0.02.rpy:1998
translate turkish momspycamroomhorny_da5b6539_2:
...
translate turkish momspycamroomhorny_b368b647_3:

    # MT "{i}Oh my God!.... I'm squirting!!{/i}"
    MT "{i}Aman Tanrım!.... Boşalıyorum!!{/i}"

# game/UpdateScript0.02.rpy:2023
translate turkish momspycamroomhorny_de1b100b_3:

    # MT "{i}Oh Yes!! Fucking squirted again!{/i}"
    MT "{i}Oh evet!! Yine boşaldım!{/i}"

# game/UpdateScript0.02.rpy:2024
translate turkish momspycamroomhorny_c54c0d90:

    # MT "{i}And that time, I thought of [ryan] fucking me on purpose.{/i}"
    MT "{i}Ve bu sırada, oğlumun beni bilerek siktiğini düşündüm.{/i}"
...
translate turkish momspycamroomhorny_f7dbdc8b:
    ...
    MT "{i}Ama bu çoooook iyi hissettirdi!{/i}"

# game/UpdateScript0.02.rpy:2027
translate turkish momspycamroomhorny_0a6bf903_3:
...
translate turkish momspycamroomhorny_47bb6ec2_3:

    # RT "{i}Wow! Mom's a squirter too.{/i}"
    RT "{i}Vay canına! Annem de çeşme kadınıymış.{/i}"

# game/UpdateScript0.02.rpy:2036
translate turkish momspycamroomhorny_d812643e_3:
...
translate turkish momspycamroomhorny_7a379bd5_3:

    # "{i}{b}\"Mom's Libido -5\"{/b}{/i}"
    "{i}{b}\"Annemin azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:2043
translate turkish momspycamroomhorny_16d37eb8_3:

    # RT "{i}I might need to go back to my room to take care of something myself.{/i}"
    RT "{i}Bir şeyle ilgilenmek için odama dönmem gerekebilir.{/i}"

# game/UpdateScript0.02.rpy:2048
translate turkish momspycamroomhorny_da5b6539_3:
...
translate turkish momspycamroomhorny_820d9859:
...
translate turkish momspycamroomhorny_f79e083d_4:

    # MT "{i}Oh, Fuuuuuuck!!!{/i}"
    MT "{i}Oh, Sikeyiiiim!!!{/i}"

# game/UpdateScript0.02.rpy:2069
translate turkish momspycamroomhorny_b368b647_4:

    # MT "{i}Oh my God!.... I'm squirting!!{/i}"
    MT "{i}Aman Tanrım!.... Boşalıyorum!!{/i}"

# game/UpdateScript0.02.rpy:2072
translate turkish momspycamroomhorny_de1b100b_4:

    # MT "{i}Oh Yes!! Fucking squirted again!{/i}"
    MT "{i}Oh evet!! Yine boşaldım!{/i}"

# game/UpdateScript0.02.rpy:2073
translate turkish momspycamroomhorny_c54c0d90_1:
...
translate turkish momspycamroomhorny_0a6bf903_4:
...
translate turkish momspycamroomhorny_47bb6ec2_4:

    # RT "{i}Wow! Mom's a squirter too.{/i}"
    RT "{i}Vay canına! Annem de çeşme kadınıymış.{/i}"

# game/UpdateScript0.02.rpy:2085
translate turkish momspycamroomhorny_d812643e_4:
...
translate turkish momspycamroomhorny_7a379bd5_4:

    # "{i}{b}\"Mom's Libido -5\"{/b}{/i}"
    "{i}{b}\"Annemin azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:2092
translate turkish momspycamroomhorny_16d37eb8_4:

    # RT "{i}I might need to go back to my room to take care of something myself.{/i}"
    RT "{i}Bir şeyle ilgilenmek için odama dönmem gerekebilir.{/i}"

# game/UpdateScript0.02.rpy:2097
translate turkish momspycamroomhorny_da5b6539_4:
...
translate turkish momspycamroomhorny_8aa9b2eb:

    # MT "{i}I wonder if they make him imagine those same scenarios with me.{/i}"
    ""

# game/UpdateScript0.02.rpy:2113
translate turkish momspycamroomhorny_f79e083d_5:

    # MT "{i}Oh, Fuuuuuuck!!!{/i}"
    MT "{i}Oh, Sikeyiiiim!!!{/i}"

# game/UpdateScript0.02.rpy:2118
translate turkish momspycamroomhorny_b368b647_5:

    # MT "{i}Oh my God!.... I'm squirting!!{/i}"
    MT "{i}Aman Tanrım!.... Boşalıyorum!!{/i}"

# game/UpdateScript0.02.rpy:2121
translate turkish momspycamroomhorny_de1b100b_5:

    # MT "{i}Oh Yes!! Fucking squirted again!{/i}"
    MT "{i}Oh evet!! Yine boşaldım!{/i}"

# game/UpdateScript0.02.rpy:2122
translate turkish momspycamroomhorny_c54c0d90_2:
...
translate turkish momspycamroomhorny_0a6bf903_5:
...
translate turkish momspycamroomhorny_47bb6ec2_5:

    # RT "{i}Wow! Mom's a squirter too.{/i}"
    RT "{i}Vay canına! Annem de çeşme kadınıymış.{/i}"

# game/UpdateScript0.02.rpy:2134
translate turkish momspycamroomhorny_d812643e_5:
...
translate turkish momspycamroomhorny_7a379bd5_5:

    # "{i}{b}\"Mom's Libido -5\"{/b}{/i}"
    "{i}{b}\"Annemin azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:2141
translate turkish momspycamroomhorny_16d37eb8_5:

    # RT "{i}I might need to go back to my room to take care of something myself.{/i}"
    RT "{i}Bir şeyle ilgilenmek için odama dönmem gerekebilir.{/i}"

# game/UpdateScript0.02.rpy:2146
translate turkish momspycamroomhorny_da5b6539_5:
...
translate turkish momspycamroomhorny_d76ab941:
    ...
    MT "{i}İki deliğimin de doldurulmasına ne kadar ihtiyacım olduğuna inanamıyorum.{/i}"

# game/UpdateScript0.02.rpy:2161
translate turkish momspycamroomhorny_b0815448:

    # MT "{i}How would it be to fuck two men at the same time?{/i}"
    MT "{i}İki erkek tarafından aynı anda sikilmek nasıl olurdu?{/i}"

# game/UpdateScript0.02.rpy:2162
translate turkish momspycamroomhorny_0636c29d:

    # MT "{i}[dad_name] would never let that happen, but now that [dad_name] is gone.... {/i}"
    MT "{i}[dad_name] bunun olmasına asla izin vermezdi, ama şimdi [dad_name] gitti.... {/i}"

# game/UpdateScript0.02.rpy:2163
translate turkish momspycamroomhorny_1984f74e:

    # MT "{i}I can't let myself think that way.... {/i}"
    MT "{i}Bu şekilde düşünmeme izin veremem.... {/i}"

# game/UpdateScript0.02.rpy:2164
translate turkish momspycamroomhorny_48dd3be8:

    # MT "{i}But still.... what two guys would I even want to fuck me besides my husband?{/i}"
    MT "{i}Ama yine de.... kocamdan başka hangi iki erkeğin beni sikmesini isteyebilirim ki?{/i}"
...
translate turkish momspycamroomhorny_93de429a:
    ...
    MT "{i} [dad_name]'nin kıskançlığı sağ olsun, hayatımda pek erkek yok.{/i}"

# game/UpdateScript0.02.rpy:2175
translate turkish momspycamroomhorny_1ac4e8ca:

    # MT "{i}There's a few students I could imagine being with, and then there's Joey DeCapo and his goons.{/i}"
    MT "{i}Birlikte olmayı hayal edebileceğim birkaç öğrenci var, bir de Joey DeCapo ve serserileri var.{/i}"

# game/UpdateScript0.02.rpy:2176
translate turkish momspycamroomhorny_d6c1767f:

    # MT "{i}I still can't believe that asshole allows my son into his club whenever he feels like it.{/i}"
    MT "{i}O pisliğin canı istediğinde oğlumun kulübüne girmesine izin verdiğine hala inanamıyorum.{/i}"

# game/UpdateScript0.02.rpy:2177
translate turkish momspycamroomhorny_9d907808:

    # MT "{i}Now that boy has a big penis. I don't know if I'd be able to fit him in either of my holes.{/i}"
    MT "{i}Bu çocuğun kocaman bir siki var. Onu iki deliğime de sığdırabilir miyim bilmiyorum.{/i}"

# game/UpdateScript0.02.rpy:2179
translate turkish momspycamroomhorny_3feb8677:

    # MT "{i}With [dad_name] being so jealous there really aren't many men in my life.{/i}"
    MT "{i} [dad_name] bu kadar kıskançken hayatımda pek fazla erkek yok.{/i}"

# game/UpdateScript0.02.rpy:2180
translate turkish momspycamroomhorny_1c0e6f21:
...
translate turkish momspycamroomhorny_9d907808_1:

    # MT "{i}Now that boy has a big penis. I don't know if I'd be able to fit him in either of my holes.{/i}"
    MT "{i}Bu çocuğun kocaman bir siki var. Onu iki deliğime de sığdırabilir miyim bilmiyorum.{/i}"

# game/UpdateScript0.02.rpy:2184
translate turkish momspycamroomhorny_bd33c6ad:

    # MT "{i}Oh, God!.... Why am I thinking about my son right now?{/i}"
    MT "{i}Oh, Tanrım!.... Neden şu anda oğlumu düşünüyorum?{/i}"

# game/UpdateScript0.02.rpy:2187
translate turkish momspycamroomhorny_f79e083d_6:

    # MT "{i}Oh, Fuuuuuuck!!!{/i}"
    MT "{i}Oh, Sikeyiiiim!!!{/i}"

# game/UpdateScript0.02.rpy:2192
translate turkish momspycamroomhorny_b368b647_6:

    # MT "{i}Oh my God!.... I'm squirting!!{/i}"
    MT "{i}Aman Tanrım!.... Boşalıyorum!!{/i}"

# game/UpdateScript0.02.rpy:2196
translate turkish momspycamroomhorny_518f66f1:

    # MT "{i}It's been so long since I've squirted!{/i}"
    MT "{i}En son boşaldığımdan beri çok uzun zaman oldu!{/i}"

# game/UpdateScript0.02.rpy:2197
translate turkish momspycamroomhorny_ee379434:

    # MT "{i}I haven't done that since before I married [dad_name].{/i}"
    MT "{i} [dad_name] ile evlendiğimden beri bunu yapmamıştım.{/i}"

# game/UpdateScript0.02.rpy:2198
translate turkish momspycamroomhorny_e901e903:

    # MT "{i}Shit, shit, shit.... I think I might have been imagining [ryan] fucking me with his huge dick.{/i}"
    MT "{i}Sikeyim, Sikeyim.... Sanırım oğlumun beni kocoman sikiyle siktiğini hayal ediyor olabilirim.{/i}"

# game/UpdateScript0.02.rpy:2199
translate turkish momspycamroomhorny_ec7aa6c7:

    # MT "{i}Dammit! Having him spy on me at the club has really messed me up.{/i}"
    MT "{i}Siktir! Kulüpte beni gözetlemesi beni gerçekten mahvetti.{/i}"

# game/UpdateScript0.02.rpy:2200
translate turkish momspycamroomhorny_1f760aee:

    # MT "{i}I've always been turned on by taboo things.{/i}"
    MT "{i}Tabu gibi şeyler beni hep tahrik etmiştir.{/i}"

# game/UpdateScript0.02.rpy:2201
translate turkish momspycamroomhorny_7147d926:

    # MT "{i}But I know the difference between fantasy and real life. I would never really do that.{/i}"
    MT "{i}Ama fantezi ile gerçek hayat arasındaki farkı biliyorum. Bunu asla yapmam.{/i}"

# game/UpdateScript0.02.rpy:2203
translate turkish momspycamroomhorny_de1b100b_6:

    # MT "{i}Oh Yes!! Fucking squirted again!{/i}"
    MT "{i}Oh evet!! Yine boşaldım!{/i}"

# game/UpdateScript0.02.rpy:2204
translate turkish momspycamroomhorny_c54c0d90_3:
...
translate turkish momspycamroomhorny_0a6bf903_6:
...
translate turkish momspycamroomhorny_47bb6ec2_6:

    # RT "{i}Wow! Mom's a squirter too.{/i}"
    RT "{i}Vay canına! Annem de çeşme kadınıymış.{/i}"

# game/UpdateScript0.02.rpy:2216
translate turkish momspycamroomhorny_d812643e_6:
...
translate turkish momspycamroomhorny_7a379bd5_6:

    # "{i}{b}\"Mom's Libido -5\"{/b}{/i}"
    "{i}{b}\"Annemin azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:2223
translate turkish momspycamroomhorny_16d37eb8_6:

    # RT "{i}I might need to go back to my room to take care of something myself.{/i}"
    RT "{i}Bir şeyle ilgilenmek için odama dönmem gerekebilir.{/i}"

# game/UpdateScript0.02.rpy:2229
translate turkish momspycamroomhorny_da5b6539_6:
...
translate turkish momspycamroommad_d2f53328:

    # RT "{i}Well.... she could be doing this for a while. I should go get ready for the day myself.{/i}"
    ""

# game/UpdateScript0.02.rpy:2296
translate turkish mominbedwithsidney_fa08de63:

    # ST "{i}Mom did say I could sleep with her as long as I don't do anything weird to her in her sleep.{/i}"
    ST "{i}Annem, uykusunda ona garip bir şey yapmadığım sürece onunla uyuyabileceğimi söyledi.{/i}"

# game/UpdateScript0.02.rpy:2297
translate turkish mominbedwithsidney_9e2cc5c9:

    # ST "{i}Oh God, I hope I don't keep doing weird stuff in my sleep.{/i}"
    ST "{i}Tanrım, umarım uykumda garip şeyler yapmaya devam etmem.{/i}"

# game/UpdateScript0.02.rpy:2300
translate turkish mominbedwithsidney_045a3e03:

    # "{i}\"15 minutes later\"{/i}"
    "{i}\"15 dakika sonrası\"{/i}"

# game/UpdateScript0.02.rpy:2304
translate turkish mominbedwithsidney_ce4d37fd:

    # RT "{i}Well, they both seem to be sleeping pretty deeply. Hopefully the melatonin is still in their systems.{/i}"
    RT "{i}İkisi de oldukça derin uyuyor gibi görünüyor. Umarım melatonin hala vücutlarındadır.{/i}"

# game/UpdateScript0.02.rpy:2305
translate turkish mominbedwithsidney_b642ad0d:

    # RT "{i}Mom did say that she would give Sidney only one chance, so what's it going to be?{/i}"
    RT "{i}Annem Sidney'e sadece bir şans vereceğini söylemişti, peki bu ne olacak?{/i}"

# game/UpdateScript0.02.rpy:2306
translate turkish mominbedwithsidney_a7fd9dd6:

    # RT "{i}Pussy or ass?{/i}"
    RT "{i}Am mı göt mü?{/i}"

# game/UpdateScript0.02.rpy:2307
translate turkish mominbedwithsidney_d402481c:

    # RT "{i}No, Mom's pussy and ass are mine, let's go with the titties.{/i}"
    RT "{i}Hayır, annemin amı ve götü benim, hadi memelerle devam edelim.{/i}"

# game/UpdateScript0.02.rpy:2310
translate turkish mominbedwithsidney_0c14d78f:

    # RT "{i}Ok, so we'll just pull her undershirt down, place Sidney's hand into place,{/i}"
    RT "{i}Tamam, kıyafetini indirip Sidney'in elini oraya koyacağız,{/i}"

# game/UpdateScript0.02.rpy:2311
translate turkish mominbedwithsidney_1705c3f8:
    ...
    RT "{i}.... ve şimdi annemi uyandırmak için bir çimdik zamanı. Bundan sonra odama gitsem iyi olacak, eğer işler umduğum gibi giderse Sidney birkaç dakika içinde bana katılacak.{/i}"

# game/UpdateScript0.02.rpy:2312
translate turkish mominbedwithsidney_6581a4bd:

    # RT "{i}Ok.... how about one right on the nipple.{/i}"
    RT "{i}Tamam.... tam meme ucuna bir taneye ne dersin.{/i}"

# game/UpdateScript0.02.rpy:2317
translate turkish mominbedwithsidney_ed5c432e:

    # M "What in the world?.... Sidney wake up! What are you doing in my room?"
    M "Bu da ne?.... Sidney uyan! Odamda ne yapıyorsun?"

# game/UpdateScript0.02.rpy:2318
translate turkish mominbedwithsidney_337a0f87:

    # S "Huh.... what's going on?"
    S "Huh.... neler oluyor?"

# game/UpdateScript0.02.rpy:2319
translate turkish mominbedwithsidney_388cb1d2:

    # M "Sidney, I told you that you could only sleep with me if you didn't grope me like you did your sister."
    M "Sidney, sana sadece kız kardeşine yaptığın gibi bana sarkıntılık etmezsen benimle yatabileceğini söylemiştim."

# game/UpdateScript0.02.rpy:2320
translate turkish mominbedwithsidney_8ca7f3c6:

    # S "Oh, no! What did I do this time?"
    S "Olamaz! Bu sefer ne yaptım ben?"

# game/UpdateScript0.02.rpy:2321
translate turkish mominbedwithsidney_fa6e718e:

    # M "You pulled my shirt down and pinched my nipple!"
    M "Kıyafetimi indirip meme ucumu çimdikledin!"

# game/UpdateScript0.02.rpy:2322
translate turkish mominbedwithsidney_d9d2f789:

    # S "Really? I did it again? Goddammit!"
    S "Gerçekten mi? Yine mi yaptım? Allah kahretsin!"

# game/UpdateScript0.02.rpy:2323
translate turkish mominbedwithsidney_6d190f60:

    # M "Language, honey!"
    M "Konuşman, tatlım!"

# game/UpdateScript0.02.rpy:2324
translate turkish mominbedwithsidney_b4f4b4c6:

    # S "Sorry..."
    S "Özür dilerim..."

# game/UpdateScript0.02.rpy:2325
translate turkish mominbedwithsidney_15efadcf:

    # M "I need you to go back out there and sleep on the couch."
    M "Oraya geri dönüp kanepede uyumanı istiyorum."

# game/UpdateScript0.02.rpy:2326
translate turkish mominbedwithsidney_11de3744:

    # S "But Mom, I heard creepy noises out there, and so did [ryan]!"
    S "Ama anne, dışarıda ürkütücü sesler duydum, [ryan] da öyle!"

# game/UpdateScript0.02.rpy:2329
translate turkish mominbedwithsidney_e179710b:

    # M "Oh, you're just imagining things. The doors and windows are locked. You're perfectly safe."
    M "Oh, sadece hayal görüyorsun. Kapılar ve pencereler kilitli. Tamamen güvendesin."

# game/UpdateScript0.02.rpy:2330
translate turkish mominbedwithsidney_a0246f3c:

    # M "Now, get out!"
    M "Şimdi, çık dışarı!"

# game/UpdateScript0.02.rpy:2331
translate turkish mominbedwithsidney_5d4cf589:

    # S "But, Mom!"
    S "Ama anne!"

# game/UpdateScript0.02.rpy:2332
translate turkish mominbedwithsidney_16a20e59:

    # M "Go!"
    M "Git!"

# game/UpdateScript0.02.rpy:2335
translate turkish mominbedwithsidney_46ab1763:

    # MT "{i}Shit, what is wrong with that girl?{/i}"
    MT "{i}Kahretsin, bu kızın nesi var böyle?{/i}"

# game/UpdateScript0.02.rpy:2336
translate turkish mominbedwithsidney_8e2e5b20:

    # MT "{i}She cannot keep her hands to herself in her sleep.{/i}"
    MT "{i}Uykusunda ellerine hakim olamıyor.{/i}"

# game/UpdateScript0.02.rpy:2337
translate turkish mominbedwithsidney_7c18b4e7:

    # M "I mean, I guess I can't complain too much, at least her finger wasn't in my ass."
    M "Yani, sanırım çok fazla şikayet edemem, en azından parmağı götümde değildi."

# game/UpdateScript0.02.rpy:2338
translate turkish mominbedwithsidney_65b1892d:

    # MT "{i}.... although I do like things in my ass.... {/i}"
    MT "{i}.... götümdeki şeyleri sevmeme rağmen.... {/i}"

# game/UpdateScript0.02.rpy:2339
translate turkish mominbedwithsidney_3265e8ee:

    # "{i}{b}\"Mom's Libido +1\"{/b}{/i}"
    "{i}{b}\"Annemin azgınlığı +1\"{/b}{/i}"

# game/UpdateScript0.02.rpy:2353
translate turkish spycamlaurenroom_90724d57:

    # RT "{i}So, the instructions on the spy-cam say that I can link my phone to the live video feed.{/i}"
    RT "{i}Casusluk kamerasindaki talimatlar, telefonumu canlı video akışına bağlayabileceğimi söylüyor.{/i}"

# game/UpdateScript0.02.rpy:2354
translate turkish spycamlaurenroom_f5a3833f:

    # RT "{i}It doesn't actually record video, I can only see what's going on live.{/i}"
    RT "{i}Aslında video kaydetmiyor, sadece neler olup bittiğini canlı olarak görebiliyorum.{/i}"

# game/UpdateScript0.02.rpy:2355
translate turkish spycamlaurenroom_da46de46:

    # RT "{i}But it does have the option for me to snap pictures when I'm watching a live stream.{/i}"
    RT "{i}Ancak canlı yayın izlerken fotoğraf çekebilmem için bir seçeneği var.{/i}"

# game/UpdateScript0.02.rpy:2356
translate turkish spycamlaurenroom_e6731e48:

    # RT "{i}Ok, let's get this baby set up.{/i}"
    RT "{i}Tamam, hadi şu bebeği hazırlayalım.{/i}"

# game/UpdateScript0.02.rpy:2359
translate turkish spycamlaurenroom_724513e3:

    # RT "{i}Ok, I just need to get this vanity stool moved over here.... {/i}"
    RT "{i}Tamam, sadece şu makyaj taburesini buraya taşımam gerekiyor.... {/i}"

# game/UpdateScript0.02.rpy:2360
translate turkish spycamlaurenroom_b3e99540:

    # RT "{i}And use this screwdriver to open this vent.... {/i}"
    RT "{i}Ve bu tornavidayı kullanarak havalandırma deliğini açmalıyım.... {/i}"

# game/UpdateScript0.02.rpy:2361
translate turkish spycamlaurenroom_5f00d363:

    # RT "{i}Dammit!.... That hurt!.... {/i}"
    RT "{i}Hasiktir!.... Bu acıttı!.... {/i}"

# game/UpdateScript0.02.rpy:2362
translate turkish spycamlaurenroom_b8cce6af:

    # RT "{i}You cock nosed boner face! Open up.{/i}"
    RT "{i}Seni sik burunlu sik suratlı! Açıl.{/i}"

# game/UpdateScript0.02.rpy:2363
translate turkish spycamlaurenroom_7b5dafe0:

    # RT "{i}You filthy sons of horkers! Son of a bitch mother fucker!{/i}"
    RT "{i}Sizi pis fahişe çocukları! Anasını siktiğimin orospu çocuğu!{/i}"

# game/UpdateScript0.02.rpy:2364
translate turkish spycamlaurenroom_cff63916:

    # RT "{i}Finally!.... Ok, just place it so it can see between the grates.... {/i}"
    RT "{i}Sonunda!.... Tamam, sadece ızgaraların arasını görebilecek şekilde yerleştireyim.... {/i}"

# game/UpdateScript0.02.rpy:2365
translate turkish spycamlaurenroom_5a07fa8b:

    # RT "{i}And turn it on!{/i}"
    RT "{i}Ve aç!{/i}"

# game/UpdateScript0.02.rpy:2368
translate turkish spycamlaurenroom_bf4f9cc1:

    # RT "{i}Ok, perfect.... It should be streaming to my phone now.{/i}"
    RT "{i}Tamam, mükemmel.... Şimdi telefonumda görünüyor olmalı.{/i}"

# game/UpdateScript0.02.rpy:2371
translate turkish spycamlaurenroom_b81b7a82:

    # RT "{i}All right, just a slight adjustment so I have a good view of the bed and in front of the mirror,{/i}"
    RT "{i}Pekala, yatağı ve aynanın önünü iyi görebilmem için ufak bir ayarlama yapalım,{/i}"

# game/UpdateScript0.02.rpy:2372
translate turkish spycamlaurenroom_e03a2027:

    # RT "{i}.... and now I should be able to see live streams of whatever it is the girls do in here.{/i}"
    RT "{i}.... ve şimdi kızlar burada ne yapıyorsa canlı yayından görebilmeliyim.{/i}"

# game/UpdateScript0.02.rpy:2373
translate turkish spycamlaurenroom_07448316:

    # RT "{i}I can't wait! It's amazingly convenient that the girls all have predictable daily schedules.... hmmmm.{/i}"
    RT "{i}Sabırsızlanıyorum! Kızların hepsinin günlük programlarının tahmin edilebilir olması inanılmaz derecede uygun.... hmmmm.{/i}"

# game/UpdateScript0.02.rpy:2383
translate turkish spycamlaurenroom_ef9b508d:
...
translate turkish spycamlaurenroom_73466360:
...
translate turkish laurenspycamroom_88e582bc:

    # RT "{i}Lauren must be getting dressed, the door's locked. Not like that's going to stop me anymore.{/i}"
    RT "{i}Lauren giyiniyor olmalı, kapı kilitli. Artık bu beni durdurmayacak.{/i}"

# game/UpdateScript0.02.rpy:2414
translate turkish laurenspycamroom_083dcb57:

    # RT "{i}Yep, she's getting dressed alright, with no idea I'm watching her.{/i}"
    RT "{i}Evet, onu izlediğimin farkında olmadan giyiniyor.{/i}"

# game/UpdateScript0.02.rpy:2417
translate turkish laurenspycamroom_e375e0dd:

    # RT "{i}Come on, do something. Is the camera frozen? She's just staring at her tits in the mirror.{/i}"
    RT "{i}Hadi, bir şeyler yap. Kamera mı dondu? Sadece aynada göğüslerine bakıyor.{/i}"

# game/UpdateScript0.02.rpy:2418
translate turkish laurenspycamroom_a77f3400:

    # RT "{i}Well, to be fair, I think I would do the same if I had those cute little mosquito bites.{/i}"
    RT "{i}Dürüst olmak gerekirse, o sevimli küçük sivrisinek ısırıkları bende de olsaydı sanırım ben de aynısını yapardım.{/i}"

# game/UpdateScript0.02.rpy:2419
translate turkish laurenspycamroom_a28583e1:

    # RT "{i}Well, I think I'll check back later sometime to see if she's doing anything more interesting.{/i}"
    RT "{i}Sanırım daha ilginç bir şeyler yapıp yapmadığını görmek için bir ara tekrar kontrol edeceğim.{/i}"
...
translate turkish laurenspycamroomhorny_7fbb2d97:

    # LT "{i}Oh God.... I can remember what [ryan]'s cock tasted like.{/i}"
    ""

# game/UpdateScript0.02.rpy:2491
translate turkish laurenspycamroomhorny_4db7db55:
...
translate turkish laurenspycamroomhorny_c9cac4bc:
    ...
    LT "{i}Aman Tanrım!.... Boşalıyorum!!{/i}"

# game/UpdateScript0.02.rpy:2514
translate turkish laurenspycamroomhorny_6fdf681d:

    # LT "{i}I can't control it!, I'm squirting!{/i}"
    LT "{i}Kontrol edemiyorum! Boşalıyorum!{/i}"

# game/UpdateScript0.02.rpy:2518
translate turkish laurenspycamroomhorny_1758aaf0:

    # LT "{i}Oh my God, I squirted again!{/i}"
    LT "{i}Aman Tanrım, yine boşaldım!{/i}"
...
translate turkish laurenspycamroomhorny_0a2a29e5:
    ...
    LT "{i}Ama bu çoooook iyi hissettirdi!{/i}"

# game/UpdateScript0.02.rpy:2521
translate turkish laurenspycamroomhorny_ab62532f:

    # LT "{i}What's wrong with me.{/i}"
    LT "{i}Neyim var benim?{/i}"
...
translate turkish laurenspycamroomhorny_32616470:
    ...
    RT "{i}Vay canına! Lauren'de çeşme kızıymış.{/i}"

# game/UpdateScript0.02.rpy:2531
translate turkish laurenspycamroomhorny_d812643e:

    # RT "{i}Maybe it's a family thing.{/i}"
    RT "{i}Belki de ailevi bir şeydir.{/i}"

# game/UpdateScript0.02.rpy:2533
translate turkish laurenspycamroomhorny_6e554fd7:

    # RT "{i}Oh my God! Lauren just squirted all over her bed!{/i}"
    ""

# game/UpdateScript0.02.rpy:2534
translate turkish laurenspycamroomhorny_d48550d7:

    # RT "{i}I thought that was just some kinky porn gimmick where the girls just piss all over.{/i}"
    ""

# game/UpdateScript0.02.rpy:2535
translate turkish laurenspycamroomhorny_e349fc41:

    # RT "{i}Wow, Lauren's a real squirter!{/i}"
    ""

# game/UpdateScript0.02.rpy:2536
translate turkish laurenspycamroomhorny_07634fed:

    # RT "{i}Just.... wow!{/i}"
    RT "{i}Sadece.... vay!{/i}"

# game/UpdateScript0.02.rpy:2537
translate turkish laurenspycamroomhorny_de144e4d:

    # "{i}{b}\"Lauren's Libido -5\"{/b}{/i}"
    "{i}{b}\"Lauren'in azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:2538
translate turkish laurenspycamroomhorny_16d37eb8:
...
translate turkish laurenspycamroomhorny_6fdf681d_1:

    # LT "{i}I can't control it!, I'm squirting!{/i}"
    LT "{i}Kontrol edemiyorum! Boşalıyorum!{/i}"

# game/UpdateScript0.02.rpy:2587
translate turkish laurenspycamroomhorny_1758aaf0_1:
...
translate turkish laurenspycamroomhorny_ab62532f_1:
...
translate turkish laurenspycamroomhorny_d812643e_1:

    # RT "{i}Maybe it's a family thing.{/i}"
    RT "{i}Belki de ailevi bir şeydir.{/i}"

# game/UpdateScript0.02.rpy:2602
translate turkish laurenspycamroomhorny_6e554fd7_1:

    # RT "{i}Oh my God! Lauren just squirted all over her bed!{/i}"
    ""

# game/UpdateScript0.02.rpy:2603
translate turkish laurenspycamroomhorny_d48550d7_1:

    # RT "{i}I thought that was just some kinky porn gimmick where the girls just piss all over.{/i}"
    ""

# game/UpdateScript0.02.rpy:2604
translate turkish laurenspycamroomhorny_e349fc41_1:

    # RT "{i}Wow, Lauren's a real squirter!{/i}"
    ""

# game/UpdateScript0.02.rpy:2605
translate turkish laurenspycamroomhorny_07634fed_1:

    # RT "{i}Just.... wow!{/i}"
    RT "{i}Sadece.... vay!{/i}"

# game/UpdateScript0.02.rpy:2606
translate turkish laurenspycamroomhorny_de144e4d_1:

    # "{i}{b}\"Lauren's Libido -5\"{/b}{/i}"
    "{i}{b}\"Lauren'in azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:2607
translate turkish laurenspycamroomhorny_16d37eb8_1:
...
translate turkish laurenspycamroomhorny_782b6a62:
...
translate turkish laurenspycamroomhorny_6fdf681d_2:

    # LT "{i}I can't control it!, I'm squirting!{/i}"
    LT "{i}Kontrol edemiyorum! Boşalıyorum!{/i}"

# game/UpdateScript0.02.rpy:2655
translate turkish laurenspycamroomhorny_1758aaf0_2:

    # LT "{i}Oh my God, I squirted again!{/i}"
    LT "{i}Aman Tanrım, yine boşaldım!{/i}"

# game/UpdateScript0.02.rpy:2656
translate turkish laurenspycamroomhorny_7a95be7f:

    # LT "{i}Shit! And I did it thinking about a girl!{/i}"
    ""

# game/UpdateScript0.02.rpy:2657
translate turkish laurenspycamroomhorny_0a2a29e5_2:

    # LT "{i}But that just felt sooooo good!{/i}"
    LT "{i}Ama bu çoooook iyi hissettirdi!{/i}"

# game/UpdateScript0.02.rpy:2658
translate turkish laurenspycamroomhorny_ab62532f_2:
...
translate turkish laurenspycamroomhorny_d812643e_2:

    # RT "{i}Maybe it's a family thing.{/i}"
    RT "{i}Belki de ailevi bir şeydir.{/i}"

# game/UpdateScript0.02.rpy:2669
translate turkish laurenspycamroomhorny_6e554fd7_2:

    # RT "{i}Oh my God! Lauren just squirted all over her bed!{/i}"
    ""

# game/UpdateScript0.02.rpy:2670
translate turkish laurenspycamroomhorny_d48550d7_2:

    # RT "{i}I thought that was just some kinky porn gimmick where the girls just piss all over.{/i}"
    ""

# game/UpdateScript0.02.rpy:2671
translate turkish laurenspycamroomhorny_e349fc41_2:

    # RT "{i}Wow, Lauren's a real squirter!{/i}"
    ""

# game/UpdateScript0.02.rpy:2672
translate turkish laurenspycamroomhorny_07634fed_2:

    # RT "{i}Just.... wow!{/i}"
    RT "{i}Sadece.... vay!{/i}"

# game/UpdateScript0.02.rpy:2673
translate turkish laurenspycamroomhorny_de144e4d_2:

    # "{i}{b}\"Lauren's Libido -5\"{/b}{/i}"
    "{i}{b}\"Lauren'in azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:2674
translate turkish laurenspycamroomhorny_16d37eb8_2:
...
translate turkish laurenspycamroomhorny_cf27839c:
...
translate turkish laurenspycamroomhorny_6fdf681d_3:

    # LT "{i}I can't control it!, I'm squirting!{/i}"
    LT "{i}Kontrol edemiyorum! Boşalıyorum!{/i}"

# game/UpdateScript0.02.rpy:2722
translate turkish laurenspycamroomhorny_1758aaf0_3:
...
translate turkish laurenspycamroomhorny_ab62532f_3:
...
translate turkish laurenspycamroomhorny_d812643e_3:

    # RT "{i}Maybe it's a family thing.{/i}"
    RT "{i}Belki de ailevi bir şeydir.{/i}"

# game/UpdateScript0.02.rpy:2737
translate turkish laurenspycamroomhorny_6e554fd7_3:

    # RT "{i}Oh my God! Lauren just squirted all over her bed!{/i}"
    ""

# game/UpdateScript0.02.rpy:2738
translate turkish laurenspycamroomhorny_d48550d7_3:

    # RT "{i}I thought that was just some kinky porn gimmick where the girls just piss all over.{/i}"
    ""

# game/UpdateScript0.02.rpy:2739
translate turkish laurenspycamroomhorny_e349fc41_3:

    # RT "{i}Wow, Lauren's a real squirter!{/i}"
    ""

# game/UpdateScript0.02.rpy:2740
translate turkish laurenspycamroomhorny_07634fed_3:

    # RT "{i}Just.... wow!{/i}"
    RT "{i}Sadece.... vay!{/i}"

# game/UpdateScript0.02.rpy:2741
translate turkish laurenspycamroomhorny_de144e4d_3:

    # "{i}{b}\"Lauren's Libido -5\"{/b}{/i}"
    "{i}{b}\"Lauren'in azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:2742
translate turkish laurenspycamroomhorny_16d37eb8_3:
...
translate turkish laurenspycamroomhorny_0d6ef31b:
...
translate turkish laurenspycamroomhorny_6fdf681d_4:

    # LT "{i}I can't control it!, I'm squirting!{/i}"
    LT "{i}Kontrol edemiyorum! Boşalıyorum!{/i}"

# game/UpdateScript0.02.rpy:2790
translate turkish laurenspycamroomhorny_1758aaf0_4:
...
translate turkish laurenspycamroomhorny_ab62532f_4:
...
translate turkish laurenspycamroomhorny_d812643e_4:

    # RT "{i}Maybe it's a family thing.{/i}"
    RT "{i}Belki de ailevi bir şeydir.{/i}"

# game/UpdateScript0.02.rpy:2805
translate turkish laurenspycamroomhorny_6e554fd7_4:

    # RT "{i}Oh my God! Lauren just squirted all over her bed!{/i}"
    ""

# game/UpdateScript0.02.rpy:2806
translate turkish laurenspycamroomhorny_d48550d7_4:

    # RT "{i}I thought that was just some kinky porn gimmick where the girls just piss all over.{/i}"
    ""

# game/UpdateScript0.02.rpy:2807
translate turkish laurenspycamroomhorny_e349fc41_4:

    # RT "{i}Wow, Lauren's a real squirter!{/i}"
    ""

# game/UpdateScript0.02.rpy:2808
translate turkish laurenspycamroomhorny_07634fed_4:

    # RT "{i}Just.... wow!{/i}"
    RT "{i}Sadece.... vay!{/i}"

# game/UpdateScript0.02.rpy:2809
translate turkish laurenspycamroomhorny_de144e4d_4:

    # "{i}{b}\"Lauren's Libido -5\"{/b}{/i}"
    "{i}{b}\"Lauren'in azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:2810
translate turkish laurenspycamroomhorny_16d37eb8_4:
...
translate turkish laurenspycamroomhorny_6fdf681d_5:
...
translate turkish laurenspycamroomhorny_5a94f342:

    # LT "{i}I've got to stop switching my thoughts to [ryan] when I masturbate!{/i}"
    ""

# game/UpdateScript0.02.rpy:2933
translate turkish laurenspycamroomhorny_0a2a29e5_5:

    # LT "{i}But that just felt sooooo good!{/i}"
    LT "{i}Ama bu çoooook iyi hissettirdi!{/i}"

# game/UpdateScript0.02.rpy:2934
translate turkish laurenspycamroomhorny_ab62532f_5:
...
translate turkish laurenspycamroomhorny_d812643e_5:

    # RT "{i}Maybe it's a family thing.{/i}"
    RT "{i}Belki de ailevi bir şeydir.{/i}"

# game/UpdateScript0.02.rpy:2946
translate turkish laurenspycamroomhorny_6e554fd7_5:

    # RT "{i}Oh my God! Lauren just squirted all over her bed!{/i}"
    ""

# game/UpdateScript0.02.rpy:2947
translate turkish laurenspycamroomhorny_d48550d7_5:

    # RT "{i}I thought that was just some kinky porn gimmick where the girls just piss all over.{/i}"
    ""

# game/UpdateScript0.02.rpy:2948
translate turkish laurenspycamroomhorny_e349fc41_5:

    # RT "{i}Wow, Lauren's a real squirter!{/i}"
    ""

# game/UpdateScript0.02.rpy:2949
translate turkish laurenspycamroomhorny_07634fed_5:

    # RT "{i}Just.... wow!{/i}"
    RT "{i}Sadece.... vay!{/i}"

# game/UpdateScript0.02.rpy:2950
translate turkish laurenspycamroomhorny_de144e4d_5:

    # "{i}{b}\"Lauren's Libido -5\"{/b}{/i}"
    "{i}{b}\"Lauren'in azgınlığı -5\"{/b}{/i}"

# game/UpdateScript0.02.rpy:2951
translate turkish laurenspycamroomhorny_16d37eb8_5:
...
translate turkish sidneyspycamroom_2af4dd45:
    ...
    RT "{i}Görünüşe göre bazı moda tasarımları üzerinde çalışıyor. Acaba Lauren için bir şey mi?{/i}"

# game/UpdateScript0.02.rpy:3013
translate turkish sidneyspycamroom_5705c8d9:

    # RT "{i}Well, all my suspicions are confirmed, girls go around topless whenever they're alone.{/i}"
    RT "{i}Tüm şüphelerim doğrulandı, kızlar yalnız kaldıklarında üstsüz dolaşıyorlar.{/i}"

# game/UpdateScript0.02.rpy:3014
translate turkish sidneyspycamroom_4e005892:

    # RT "{i}Nothing more to see, if she's working, she could stay in that position for hours.{/i}"
    RT "{i}Görecek başka bir şey yok, eğer çalışıyorsa, saatlerce o pozisyonda kalabilir.{/i}"
...
translate turkish sidneyspycamroomhorny_51e59ddc:

    # ST "{i}I can't believe no ones caught us yet.{/i}"
    ""

# game/UpdateScript0.02.rpy:3056
translate turkish sidneyspycamroomhorny_4b559163:
...
translate turkish sidneyspycamroomhorny_dd857f6d:
    ...
    ST "{i}Aman Tanrım, yine boşaldım!{/i}"

# game/UpdateScript0.02.rpy:3077
translate turkish sidneyspycamroomhorny_0fb8af50:

    # ST "{i}And that felt sooooo good!{/i}"
    ""

# game/UpdateScript0.02.rpy:3078
translate turkish sidneyspycamroomhorny_9dd5f8cf:
...
translate turkish sidneyspycamroomhorny_79bf771e:
    ...
    RT "{i}Vay canına! Sidney'de çeşme kadınıymış.{/i}"

# game/UpdateScript0.02.rpy:3087
translate turkish sidneyspycamroomhorny_d812643e:

    # RT "{i}Maybe it's a family thing.{/i}"
    RT "{i}Belki de ailevi bir şeydir.{/i}"

# game/UpdateScript0.02.rpy:3089
translate turkish sidneyspycamroomhorny_f34004ea:

    # RT "{i}Oh my God! Sidney just squirted all over her bed!{/i}"
    ""

# game/UpdateScript0.02.rpy:3090
translate turkish sidneyspycamroomhorny_d48550d7:

    # RT "{i}I thought that was just some kinky porn gimmick where the girls just piss all over.{/i}"
    ""

# game/UpdateScript0.02.rpy:3091
translate turkish sidneyspycamroomhorny_c7ed333d:

    # RT "{i}Wow, Sidney's a real squirter!{/i}"
    ""

# game/UpdateScript0.02.rpy:3092
translate turkish sidneyspycamroomhorny_07634fed:
...
translate turkish sidneyspycamroomhorny_0fb8af50_1:

    # ST "{i}And that felt sooooo good!{/i}"
    ""

# game/UpdateScript0.02.rpy:3127
translate turkish sidneyspycamroomhorny_9dd5f8cf_1:
...
translate turkish sidneyspycamroomhorny_d812643e_1:

    # RT "{i}Maybe it's a family thing.{/i}"
    RT "{i}Belki de ailevi bir şeydir.{/i}"

# game/UpdateScript0.02.rpy:3138
translate turkish sidneyspycamroomhorny_f34004ea_1:

    # RT "{i}Oh my God! Sidney just squirted all over her bed!{/i}"
    ""

# game/UpdateScript0.02.rpy:3139
translate turkish sidneyspycamroomhorny_d48550d7_1:

    # RT "{i}I thought that was just some kinky porn gimmick where the girls just piss all over.{/i}"
    ""

# game/UpdateScript0.02.rpy:3140
translate turkish sidneyspycamroomhorny_c7ed333d_1:

    # RT "{i}Wow, Sidney's a real squirter!{/i}"
    ""

# game/UpdateScript0.02.rpy:3141
translate turkish sidneyspycamroomhorny_07634fed_1:
...
translate turkish sidneyspycamroomhorny_0fb8af50_2:

    # ST "{i}And that felt sooooo good!{/i}"
    ""

# game/UpdateScript0.02.rpy:3176
translate turkish sidneyspycamroomhorny_9dd5f8cf_2:
...
translate turkish sidneyspycamroomhorny_d812643e_2:

    # RT "{i}Maybe it's a family thing.{/i}"
    RT "{i}Belki de ailevi bir şeydir.{/i}"

# game/UpdateScript0.02.rpy:3187
translate turkish sidneyspycamroomhorny_f34004ea_2:

    # RT "{i}Oh my God! Sidney just squirted all over her bed!{/i}"
    ""

# game/UpdateScript0.02.rpy:3188
translate turkish sidneyspycamroomhorny_d48550d7_2:

    # RT "{i}I thought that was just some kinky porn gimmick where the girls just piss all over.{/i}"
    ""

# game/UpdateScript0.02.rpy:3189
translate turkish sidneyspycamroomhorny_c7ed333d_2:

    # RT "{i}Wow, Sidney's a real squirter!{/i}"
    ""

# game/UpdateScript0.02.rpy:3190
translate turkish sidneyspycamroomhorny_07634fed_2:
...
translate turkish sidneyspycamroomhorny_f4caa46c:
...
translate turkish sidneyspycamroomhorny_bc1142cc:
...
translate turkish sidneyspycamroomhorny_0fb8af50_3:

    # ST "{i}And that felt sooooo good!{/i}"
    ""

# game/UpdateScript0.02.rpy:3225
translate turkish sidneyspycamroomhorny_9dd5f8cf_3:
...
translate turkish sidneyspycamroomhorny_d812643e_3:

    # RT "{i}Maybe it's a family thing.{/i}"
    RT "{i}Belki de ailevi bir şeydir.{/i}"

# game/UpdateScript0.02.rpy:3236
translate turkish sidneyspycamroomhorny_f34004ea_3:

    # RT "{i}Oh my God! Sidney just squirted all over her bed!{/i}"
    ""

# game/UpdateScript0.02.rpy:3237
translate turkish sidneyspycamroomhorny_d48550d7_3:

    # RT "{i}I thought that was just some kinky porn gimmick where the girls just piss all over.{/i}"
    ""

# game/UpdateScript0.02.rpy:3238
translate turkish sidneyspycamroomhorny_c7ed333d_3:

    # RT "{i}Wow, Sidney's a real squirter!{/i}"
    ""

# game/UpdateScript0.02.rpy:3239
translate turkish sidneyspycamroomhorny_07634fed_3:
...
translate turkish sidneyspycamroomhorny_c375e11b:

    # ST "{i}His dick was just so big.... so hard.... {/i}"
    ""

# game/UpdateScript0.02.rpy:3253
translate turkish sidneyspycamroomhorny_4778ed7e:
...
translate turkish sidneyspycamroomhorny_c5fa8458:
...
translate turkish sidneyspycamroomhorny_0fb8af50_4:

    # ST "{i}And that felt sooooo good!{/i}"
    ""

# game/UpdateScript0.02.rpy:3277
translate turkish sidneyspycamroomhorny_9dd5f8cf_4:
...
translate turkish sidneyspycamroomhorny_d812643e_4:

    # RT "{i}Maybe it's a family thing.{/i}"
    RT "{i}Belki de ailevi bir şeydir.{/i}"

# game/UpdateScript0.02.rpy:3289
translate turkish sidneyspycamroomhorny_f34004ea_4:

    # RT "{i}Oh my God! Sidney just squirted all over her bed!{/i}"
    ""

# game/UpdateScript0.02.rpy:3290
translate turkish sidneyspycamroomhorny_d48550d7_4:

    # RT "{i}I thought that was just some kinky porn gimmick where the girls just piss all over.{/i}"
    ""

# game/UpdateScript0.02.rpy:3291
translate turkish sidneyspycamroomhorny_c7ed333d_4:

    # RT "{i}Wow, Sidney's a real squirter!{/i}"
    ""

# game/UpdateScript0.02.rpy:3292
translate turkish sidneyspycamroomhorny_07634fed_4:
...
translate turkish sidneyspycamroomhorny_69cb49b5:

    # ST "{i}It's just harmless fantasy. It's just harmless fantasy. It's just harmless fantasy.{/i}"
    ""

# game/UpdateScript0.02.rpy:3380
translate turkish sidneyspycamroomhorny_0fb8af50_5:

    # ST "{i}And that felt sooooo good!{/i}"
    ""

# game/UpdateScript0.02.rpy:3381
translate turkish sidneyspycamroomhorny_9dd5f8cf_5:
...
translate turkish sidneyspycamroomhorny_d812643e_5:

    # RT "{i}Maybe it's a family thing.{/i}"
    RT "{i}Belki de ailevi bir şeydir.{/i}"

# game/UpdateScript0.02.rpy:3393
translate turkish sidneyspycamroomhorny_f34004ea_5:

    # RT "{i}Oh my God! Sidney just squirted all over her bed!{/i}"
    ""

# game/UpdateScript0.02.rpy:3394
translate turkish sidneyspycamroomhorny_d48550d7_5:

    # RT "{i}I thought that was just some kinky porn gimmick where the girls just piss all over.{/i}"
    ""

# game/UpdateScript0.02.rpy:3395
translate turkish sidneyspycamroomhorny_c7ed333d_5:

    # RT "{i}Wow, Sidney's a real squirter!{/i}"
    ""

# game/UpdateScript0.02.rpy:3396
translate turkish sidneyspycamroomhorny_07634fed_5:
...
translate turkish invitemomtooffice_7a6bcafc:
    ...
    R "Matt ve Megan nasılsınız? Bayan [mom_name]? Oedipus ödevimle ilgili birkaç şeyi benimle birlikte gözden geçirmek için bir dakikan var mı?"

# game/UpdateScript0.02.rpy:3435
translate turkish invitemomtooffice_e8074312:

    # M "Ok [ryan], go to my office and I'll be right there."
    M "Tamam [ryan], ofisime git, hemen geliyorum."

# game/UpdateScript0.02.rpy:3436
translate turkish invitemomtooffice_b4a078ed:

    # R "Mom!"
    R "Anne!"

# game/UpdateScript0.02.rpy:3437
translate turkish invitemomtooffice_623e7626:

    # M "I mean [ryan], go to my office and I'll be right there."
    M "Yani [ryan], ofisime gidin, hemen geliyorum."

# game/UpdateScript0.02.rpy:3444
translate turkish invitemomtooffice_8b7a4f81:
...
translate turkish invitemomtooffice_2a03a09f:

    # M "Ok, Ok, [ryan], go to my office and I'll be right there."
    M "Tamam, tamam, [ryan], ofisime gidin, hemen geliyorum."

# game/UpdateScript0.02.rpy:3446
translate turkish invitemomtooffice_b4a078ed_1:

    # R "Mom!"
    R "Anne!"

# game/UpdateScript0.02.rpy:3447
translate turkish invitemomtooffice_623e7626_1:

    # M "I mean [ryan], go to my office and I'll be right there."
    M "Yani [ryan], ofisime gidin, hemen geliyorum."

# game/UpdateScript0.02.rpy:3454
translate turkish invitemomtooffice_4306af1d:

    # M "Oh, hi honey."
    M "Oh, selam tatlım."

# game/UpdateScript0.02.rpy:3455
translate turkish invitemomtooffice_8ec6149a:

    # R "Mom, remember? I don't want you to call me honey at school."
    R "Anne, hatırladın mı? Okulda bana tatlım demeni istemiyorum."

# game/UpdateScript0.02.rpy:3456
translate turkish invitemomtooffice_4f38eed8:

    # M "Oh right, I'm sorry I forgot, [ryan]."
    M "Doğru ya, unuttuğum için özür dilerim, [ryan]."

# game/UpdateScript0.02.rpy:3457
translate turkish invitemomtooffice_66b15a2d:

    # M "But if I can't call you honey, you have to call me Miss [mom_name]."
    M "Ama sana tatlım diyemezsem, bana Bayan [mom_name] demek zorundasın."

# game/UpdateScript0.02.rpy:3458
translate turkish invitemomtooffice_5a5a3f30:

    # R "Ok Miss [mom_name]."
    R "Tamam Bayan [mom_name]."

# game/UpdateScript0.02.rpy:3459
translate turkish invitemomtooffice_ae756d3c:

    # M "We were all actually just talking about you."
    M "İyi insan lafın üstüne gelirmiş, bizde senden bahsediyorduk."

# game/UpdateScript0.02.rpy:3460
translate turkish invitemomtooffice_2113744a:

    # R "Really? What about?"
    R "Gerçekten mi? Ne hakkında?"

# game/UpdateScript0.02.rpy:3461
translate turkish invitemomtooffice_c8609fbd:

    # MG "Oh, haha.... really Miss [mom_name] just overheard our conversation about the hottest couple for the yearbook."
    MG "Oh, haha.... gerçekten Bayan [mom_name] yıllıktaki en seksi çift hakkındaki konuşmamıza kulak misafiri oldu."

# game/UpdateScript0.02.rpy:3462
translate turkish invitemomtooffice_76575d43:

    # MG "This year it's not from existing couples, but who would make the cutest couples."
    MG "Bu yıl mevcut çiftlerden değil, en şirin çiftlerin kimler olacağı soruluyor."

# game/UpdateScript0.02.rpy:3463
translate turkish invitemomtooffice_0c51bd1a:

    # MG "And your name is on the top of the chart."
    MG "Ve adın tablonun en üstünde."

# game/UpdateScript0.02.rpy:3464
translate turkish invitemomtooffice_8cc11a35:

    # M "But I'm dying to know what girl you should be coupled with."
    M "Ama hangi kızla birlikte olman gerektiğini bilmek için can atıyorum."

# game/UpdateScript0.02.rpy:3465
translate turkish invitemomtooffice_0b5ad0de:

    # M "They were just about to tell me."
    M "Tam da bana söylemek üzereydiler."

# game/UpdateScript0.02.rpy:3466
translate turkish invitemomtooffice_e7437c78:

    # MB "Actually, Miss [mom_name], you were the one the students wanted to see [ryan] coupled up with."
    MB "Aslında Bayan [mom_name], öğrencilerin [ryan] ile birlikte görmek istedikleri kişi sizdiniz."

# game/UpdateScript0.02.rpy:3469
translate turkish invitemomtooffice_d8bf5ca9:

    # M "What?"
    M "Ne?"

# game/UpdateScript0.02.rpy:3470
translate turkish invitemomtooffice_773f5a4f:

    # M "Matt, that isn't funny!"
    M "Matt, bu hiç komik değil!"

# game/UpdateScript0.02.rpy:3471
translate turkish invitemomtooffice_1edbdf8e:

    # MB "I'm serious!"
    MB "Ciddiyim!"

# game/UpdateScript0.02.rpy:3472
translate turkish invitemomtooffice_d33743a1:

    # MB "Tabboo stuff is kind of in right now."
    MB "Tabu olayı şu sıralar çok moda."

# game/UpdateScript0.02.rpy:3473
translate turkish invitemomtooffice_50f989cf:

    # MB "And think about it. You're the hottest woman in this school!"
    MB "Ve bunu bir düşünün. Bu okuldaki en seksi kadın sizsiniz!"

# game/UpdateScript0.02.rpy:3474
translate turkish invitemomtooffice_338f5f67:

    # MG "Yeah, and [ryan]'s quite the looker as well."
    MG "Evet ve aynı zamanda [ryan] oldukça yakışıklı."

# game/UpdateScript0.02.rpy:3475
translate turkish invitemomtooffice_4335f2b8:

    # MG "You passed down your sexiest genes Miss [mom_name]!"
    MG "En seksi genlerinizi aktarmışsınız Bayan [mom_name]!"

# game/UpdateScript0.02.rpy:3478
translate turkish invitemomtooffice_2941e037:

    # M "Oh, you two!"
    M "Oh, siz ikiniz!"

# game/UpdateScript0.02.rpy:3479
translate turkish invitemomtooffice_ea10e41b:

    # M "What am I going to do with you?"
    M "Sizinle ne yapacağım ben?"

# game/UpdateScript0.02.rpy:3480
translate turkish invitemomtooffice_fbce5781:

    # R "Hey Miss [mom_name], do you have a minute. I really need to meet with you about the Oedipus assignment you gave us."
    R "Hey Bayan [mom_name], bir dakikanız var mı? Bize verdiğiniz Oedipus ödevi hakkında sizinle görüşmem gerekiyor."

# game/UpdateScript0.02.rpy:3481
translate turkish invitemomtooffice_7c4c0e04:

    # M "Ok honey, go to my office and I'll be right there."
    M "Tamam tatlım, ofisime git, hemen geliyorum."

# game/UpdateScript0.02.rpy:3482
translate turkish invitemomtooffice_b4a078ed_2:

    # R "Mom!"
    R "Anne!"

# game/UpdateScript0.02.rpy:3483
translate turkish invitemomtooffice_623e7626_2:

    # M "I mean [ryan], go to my office and I'll be right there."
    M "Yani [ryan], ofisime gidin, hemen geliyorum."

# game/UpdateScript0.02.rpy:3490
translate turkish invitemomtooffice_4306af1d_1:

    # M "Oh, hi honey."
    M "Oh, selam tatlım."

# game/UpdateScript0.02.rpy:3491
translate turkish invitemomtooffice_8ec6149a_1:

    # R "Mom, remember? I don't want you to call me honey at school."
    R "Anne, hatırladın mı? Okulda bana tatlım demeni istemiyorum."

# game/UpdateScript0.02.rpy:3492
translate turkish invitemomtooffice_4f38eed8_1:

    # M "Oh right, I'm sorry I forgot, [ryan]."
    M "Doğru ya, unuttuğum için özür dilerim, [ryan]."

# game/UpdateScript0.02.rpy:3493
translate turkish invitemomtooffice_66b15a2d_1:

    # M "But if I can't call you honey, you have to call me Miss [mom_name]."
    M "Ama sana tatlım diyemezsem, bana Bayan [mom_name] demek zorundasın."

# game/UpdateScript0.02.rpy:3494
translate turkish invitemomtooffice_5a5a3f30_1:

    # R "Ok Miss [mom_name]."
    R "Tamam Bayan [mom_name]."

# game/UpdateScript0.02.rpy:3495
translate turkish invitemomtooffice_aac26a50:

    # M "Did you need something?"
    ""

# game/UpdateScript0.02.rpy:3496
translate turkish invitemomtooffice_afcedf68:

    # R "Yeah actually, I really need to meet with you about the Oedipus assignment you gave us."
    ""

# game/UpdateScript0.02.rpy:3497
translate turkish invitemomtooffice_7c4c0e04_1:

    # M "Ok honey, go to my office and I'll be right there."
    M "Tamam tatlım, ofisime git, hemen geliyorum."

# game/UpdateScript0.02.rpy:3498
translate turkish invitemomtooffice_b4a078ed_3:

    # R "Mom!"
    R "Anne!"

# game/UpdateScript0.02.rpy:3499
translate turkish invitemomtooffice_623e7626_3:

    # M "I mean [ryan], go to my office and I'll be right there."
    M "Yani [ryan], ofisime gidin, hemen geliyorum."

# game/UpdateScript0.02.rpy:3510
translate turkish momsoffice_7c9f259b:

    # M "Ok honey, so what was it that you wanted to ask me?"
    M "Tamam tatlım, bana sormak istediğin şey neydi?"

# game/UpdateScript0.02.rpy:3511
translate turkish momsoffice_79dad77f:
    ...
    R "Sadece sana gönderdiğim oyunlardan daha fazla oynama şansın olup olmadığını merak ediyordum, ödevim için işe yarayıp yaramayacaklarını görmek için."

# game/UpdateScript0.02.rpy:3512
translate turkish momsoffice_426bf7f9:

    # M "No I haven't quite had time yet."
    M "Hayır, henüz zamanım olmadı."

# game/UpdateScript0.02.rpy:3513
translate turkish momsoffice_6b774b6b:
    ...
    R "Peki, neden işe yaramadıklarına dair bir neden bulup bulamayacağınızı görmek için şimdi benimle biraz daha oynamak ister misin?"

# game/UpdateScript0.02.rpy:3514
translate turkish momsoffice_db3aade8:

    # M "Sure, just scooch over a chair and I'll come sit by you so we can play together."
    M "Tabii, bir sandalye çek de yanına oturayım, birlikte oynayalım."

# game/UpdateScript0.02.rpy:3517
translate turkish momsoffice_ae959015:

    # R "Ok, let me just look through my F95Zone downloads."
    R "Tamam, F95Zone indirmelerime bir göz atayım."

# game/UpdateScript0.02.rpy:3518
translate turkish momsoffice_d01cade2:

    # R "Oh yes, here they are."
    ""

# game/UpdateScript0.02.rpy:3529
translate turkish momsoffice_6c23fa5f:

    # M "We keep seeing the same scenes over and over."
    M "Aynı sahneleri tekrar tekrar görmeye devam ediyoruz."

# game/UpdateScript0.02.rpy:3530
translate turkish momsoffice_8bfe6000:

    # R "Yeah, that's called grinding, the best games require it to build your stats."
    R "Evet, buna 'grinding' deniyor, en iyi oyunlar istatistiklerinizi oluşturmak için buna ihtiyaç duyar."

# game/UpdateScript0.02.rpy:3531
translate turkish momsoffice_b5ee7a6f:

    # R "It makes each scene you unlock feel even more rewarding."
    R "Kilidini açtığınız her sahneyi daha da ödüllendirici hale getiriyor."

# game/UpdateScript0.02.rpy:3532
translate turkish momsoffice_ec8a7089:

    # M "That makes a lot of sense."
    M "Bu çok mantıklı."

# game/UpdateScript0.02.rpy:3535
translate turkish momsoffice_2bb50312:

    # R "So, did you see anything that would disqualify these games from my assignment?"
    R "Peki, bu oyunları benim görevimden diskalifiye edecek bir şey gördün mü?"

# game/UpdateScript0.02.rpy:3536
translate turkish momsoffice_94a771d0:

    # M "Uhhh.... no!.... Nothing obvious."
    M "Uhhh.... hayır!.... Belli bir şey yok."

# game/UpdateScript0.02.rpy:3537
translate turkish momsoffice_7465acc3:

    # M "I think you're on the right track. But maybe when you have some time again, come by and we can keep playing to make sure."
    M "Bence doğru yoldasın. Ama belki tekrar vaktin olduğunda uğrarsın ve emin olmak için oynamaya devam edebiliriz."

# game/UpdateScript0.02.rpy:3538
translate turkish momsoffice_6ea6c2df:

    # M "Plus I'm dying to see what happens in the new updates."
    M "Ayrıca yeni güncellemelerde neler olacağını görmek için sabırsızlanıyorum."

# game/UpdateScript0.02.rpy:3539
translate turkish momsoffice_3265e8ee:

    # "{i}{b}\"Mom's Libido +1\"{/b}{/i}"
    "{i}{b}\"Annemin azgınlığı +1\"{/b}{/i}"

# game/UpdateScript0.02.rpy:3541
translate turkish momsoffice_65dbf55c:

    # M "Ok, I really need to get back to my class, I'll see you at home tonight."
    M "Tamam, gerçekten dersime dönmem gerekiyor, akşam evde görüşürüz."

# game/UpdateScript0.02.rpy:3542
translate turkish momsoffice_0a9bc157:

    # R "Ok Mom, see you later."
    R "Tamam anne, sonra görüşürüz."

# game/UpdateScript0.02.rpy:3543
translate turkish momsoffice_3a6a7d7d:

    # RT "{i}Who would have thought spending quality time with Mom would mean playing these types of games with her?{/i}"
    RT "{i}Annemle kaliteli zaman geçirmenin onunla bu tür oyunlar oynamak anlamına geleceğini kim düşünebilirdi ki?{/i}"

# game/UpdateScript0.02.rpy:3544
translate turkish momsoffice_27d42047:

    # RT "{i}She seems to have no problem with them, in fact she seems to really enjoy them.{/i}"
    RT "{i}Onlarla bir sorunu yok gibi görünüyor, aslında onlardan gerçekten hoşlanıyor gibi görünüyor.{/i}"

# game/UpdateScript0.02.rpy:3555
translate turkish momsoffice_7c9f259b_1:

    # M "Ok honey, so what was it that you wanted to ask me?"
    M "Tamam tatlım, bana sormak istediğin şey neydi?"

# game/UpdateScript0.02.rpy:3556
translate turkish momsoffice_28e0c223:

    # R "I'm still struggling with this Oedipus assignment."
    R "Hala bu Oedipus ödeviyle uğraşıyorum."

# game/UpdateScript0.02.rpy:3557
translate turkish momsoffice_ec70f4b2:

    # R "I wanted to show you something else that I found, and see if it works for my Oedipus assignment."
    R "Sana bulduğum başka bir şeyi göstermek ve Oedipus ödevim için işe yarayıp yaramadığını görmek istedim."

# game/UpdateScript0.02.rpy:3560
translate turkish momsoffice_23370fc7:

    # R "It's another video game I found online, can you come look at it with me and see what you think."
    R "İnternette bulduğum başka bir video oyunu, gelip benimle izleyebilir ve ne düşündüğünü görebilirsin."

# game/UpdateScript0.02.rpy:3561
translate turkish momsoffice_4b55c26e:

    # M "Ok just scooch over a chair and I'll come sit by you so you can show me."
    M "Tamam, bir sandalye çek de gelip yanına oturayım, böylece bana gösterebilirsin."

# game/UpdateScript0.02.rpy:3564
translate turkish momsoffice_ae959015_1:

    # R "Ok, let me just look through my F95Zone downloads."
    R "Tamam, F95Zone indirmelerime bir göz atayım."

# game/UpdateScript0.02.rpy:3565
translate turkish momsoffice_3c12b70c:

    # R "Oh yes, here it is."
    R "Evet, işte burada."

# game/UpdateScript0.02.rpy:3569
translate turkish momsoffice_fd89a40d:

    # M "Milfy City, huh?"
    M "Milfy City, ha?"

# game/UpdateScript0.02.rpy:3570
translate turkish momsoffice_dbed3871:

    # M "What on earth is a Milf?"
    M "Milf ne demek ki?"

# game/UpdateScript0.02.rpy:3571
translate turkish momsoffice_e00a42df:

    # R "Just a hot mom."
    R "Sadece ateşli bir anne."

# game/UpdateScript0.02.rpy:3572
translate turkish momsoffice_5cbd3ce0:

    # M "Ok, well let's take a look."
    M "Tamam, bir göz atalım."

# game/UpdateScript0.02.rpy:3577
translate turkish momsoffice_7063e3cf:

    # M "Wow! Somehow the mom kissing her son makes this so much more intimate than even the sex."
    M "Vay canına! Bir şekilde annenin oğlunu öpmesi bunu seksten bile çok daha samimi kılıyor."

# game/UpdateScript0.02.rpy:3578
translate turkish momsoffice_b004b47d:

    # R "Yeah, it makes you kind of understand why some people get into these types of games."
    R "Evet, bazı insanların neden bu tür oyunlara girdiğini anlamanızı sağlıyor."

# game/UpdateScript0.02.rpy:3579
translate turkish momsoffice_3b2f6452:

    # M "Hmmmm.... yes, well keep going."
    M "Hmmmm.... evet, devam et."

# game/UpdateScript0.02.rpy:3584
translate turkish momsoffice_015f3b71:

    # M "This kid's dick is as big as yours."
    M "Bu çocuğun aleti seninki kadar büyük."

# game/UpdateScript0.02.rpy:3585
translate turkish momsoffice_1eba9e7f:

    # M "Wait! I shouldn't have said that.... I'm sorry if I made you uncomfortable."
    M "Bekle! Bunu söylememeliydim.... Seni rahatsız ettiysem özür dilerim."

# game/UpdateScript0.02.rpy:3586
translate turkish momsoffice_d595540c:

    # R "It's ok, it's flattering that my dick impressed you that much."
    R "Sorun değil, aletimin seni bu kadar etkilemesi gurur verici."

# game/UpdateScript0.02.rpy:3587
translate turkish momsoffice_ffca2bff:

    # M "Don't push it!"
    M "Zorlama!"

# game/UpdateScript0.02.rpy:3590
translate turkish momsoffice_56a97f43:

    # R "So, do you think this one is good example for my paper as well?"
    R "Peki, sence bu benim dönem ödevim için de iyi bir örnek mi?"

# game/UpdateScript0.02.rpy:3591
translate turkish momsoffice_9fceb1b9:

    # R "Mom, are you alright?"
    R "Anne, iyi misin?"

# game/UpdateScript0.02.rpy:3592
translate turkish momsoffice_a6b6cd95:

    # M "Uhhh.... yes!.... Of course.... just a little flustered from that game."
    M "Uhhh.... evet!.... Tabii ki.... sadece o oyundan dolayı biraz şaşırdım."

# game/UpdateScript0.02.rpy:3593
translate turkish momsoffice_9a71c8ae:
    ...
    M "Ama evet haklısın. Sanırım doğru yoldasın. Bana o oyunun linkini de gönder, böylece bunun ödevin kapsamına tamamen girdiğinden emin olabileyim."

# game/UpdateScript0.02.rpy:3594
translate turkish momsoffice_3265e8ee_1:

    # "{i}{b}\"Mom's Libido +1\"{/b}{/i}"
    "{i}{b}\"Annemin azgınlığı +1\"{/b}{/i}"

# game/UpdateScript0.02.rpy:3596
translate turkish momsoffice_65dbf55c_1:

    # M "Ok, I really need to get back to my class, I'll see you at home tonight."
    M "Tamam, gerçekten dersime dönmem gerekiyor, akşam evde görüşürüz."

# game/UpdateScript0.02.rpy:3597
translate turkish momsoffice_b25d89fe:

    # R "Ok, Mom, see you later."
    R "Tamam, anne, sonra görüşürüz."

# game/UpdateScript0.02.rpy:3598
translate turkish momsoffice_5afbdbb7:
    ...
    RT "{i}Gerçekten şaşkın görünüyordu, eğer onu bu tür oyunlara alıştırabilirsem, zamanı geldiğinde ona yapmaya çalıştığım şey onun için o kadar da şok edici olmayabilir.{/i}"

# game/UpdateScript0.02.rpy:3599
translate turkish momsoffice_0f0847ed:

    # RT "{i}I'll have to show her some more of those games to see how she reacts.{/i}"
    RT "{i}Nasıl tepki vereceğini görmek için ona bu oyunlardan biraz daha göstermem gerekecek.{/i}"

# game/UpdateScript0.02.rpy:3610
translate turkish momsoffice_7c9f259b_2:

    # M "Ok honey, so what was it that you wanted to ask me?"
    M "Tamam tatlım, bana sormak istediğin şey neydi?"

# game/UpdateScript0.02.rpy:3611
translate turkish momsoffice_fe43db32:

    # R "I'm just kind of struggling with this Oedipus assignment."
    R "Bu Oedipus ödevinde biraz zorlanıyorum."

# game/UpdateScript0.02.rpy:3612
translate turkish momsoffice_a1ade8ef:

    # R "I'm supposed to find how this ancient play still is relevant in modern day life."
    R "Bu eski oyunun günümüz yaşamında hala nasıl geçerli olduğunu bulmam gerekiyor."

# game/UpdateScript0.02.rpy:3613
translate turkish momsoffice_8db5d59a:

    # R "But when I search for Oedipus stuff on the internet. I find stuff that is kind of porn-ish."
    R "Ama internette Oedipus ile ilgili bir şeyler aradığımda, porno gibi şeyler buluyorum."

# game/UpdateScript0.02.rpy:3614
translate turkish momsoffice_76190a68:

    # M "Yeah, I've been worried about this assignment turning up that kind of stuff."
    M "Evet, bu ödevin bu tür şeylere yol açmasından endişeleniyordum."

# game/UpdateScript0.02.rpy:3615
translate turkish momsoffice_e9fcf189:

    # M "In fact I hate this new curriculum."
    M "Aslında bu yeni müfredattan nefret ediyorum."

# game/UpdateScript0.02.rpy:3616
translate turkish momsoffice_dcd0ad96:

    # M "But I'm forced to teach it, because if I don't I'll be fired."
    M "Ama öğretmek zorundayım, çünkü öğretmezsem kovulacağım."

# game/UpdateScript0.02.rpy:3617
translate turkish momsoffice_ce3869e8:
    ...
    R "Başta düşündüğüm kadar kötü değil. Ama ne öğreteceğinizi sizler seçemiyorsanız, müfredatı kim belirliyor?"

# game/UpdateScript0.02.rpy:3618
translate turkish momsoffice_4c526736:

    # M "Some pervert on the school board named Will Tylor. He's some kind of deviant from what I can tell."
    M "Okul yönetim kurulunda Will Tylor adında bir sapık var. Anladığım kadarıyla bir çeşit sapık."

# game/UpdateScript0.02.rpy:3619
translate turkish momsoffice_40913296:

    # M "I just hope he gets fired before his curriculum corrupts everyone on the school board, and in the schools."
    M "Umarım müfredatı okul yönetim kurulundaki ve okullardaki herkesi yozlaştırmadan önce kovulur."

# game/UpdateScript0.02.rpy:3620
translate turkish momsoffice_2631ca7b:

    # R "Hmmmm.... sounds like an asshole."
    R "Hmmmm.... tam bir göt herif gibi."

# game/UpdateScript0.02.rpy:3621
translate turkish momsoffice_f0871a81:

    # M "He really is."
    M "Gerçekten öyle."

# game/UpdateScript0.02.rpy:3622
translate turkish momsoffice_5576b4d1:

    # R "Well then, I wanted to show you something that I found on the internet, and see if it works for my Oedipus assignment."
    R "O zaman sana internette bulduğum bir şeyi göstermek ve Oedipus ödevim için işe yarayıp yaramadığını görmek istedim."

# game/UpdateScript0.02.rpy:3625
translate turkish momsoffice_5d3cf1b9:

    # R "It's just this video game I found online, can you come look at it with me and see what you think."
    R "İnternette bulduğum bir video oyunu, gelip benimle izleyebilir ve ne düşündüğünü görebilirsin."

# game/UpdateScript0.02.rpy:3626
translate turkish momsoffice_a66aed00:

    # M "Sure, just scooch over a chair and I'll come sit by you so you can show me."
    M "Tabii, bir sandalye çek de gelip yanına oturayım, böylece bana gösterebilirsin."

# game/UpdateScript0.02.rpy:3629
translate turkish momsoffice_ae959015_2:

    # R "Ok, let me just look through my F95Zone downloads."
    R "Tamam, F95Zone indirmelerime bir göz atayım."

# game/UpdateScript0.02.rpy:3630
translate turkish momsoffice_3c12b70c_1:

    # R "Oh yes, here it is."
    R "Evet, işte burada."

# game/UpdateScript0.02.rpy:3634
translate turkish momsoffice_dd0f6dfa:

    # M "Big Brother, huh?"
    M "Big Brother, ha?"

# game/UpdateScript0.02.rpy:3635
translate turkish momsoffice_1291d6a3:

    # M "Is this like that voyeuristic television show on TV?"
    M "Bu televizyondaki röntgenci televizyon programı gibi bir şey mi?"

# game/UpdateScript0.02.rpy:3636
translate turkish momsoffice_4a67eccf:

    # R "No this isn't nearly that lewd."
    R "Hayır, bu o kadar da müstehcen değil."

# game/UpdateScript0.02.rpy:3637
translate turkish momsoffice_5cbd3ce0_1:

    # M "Ok, well let's take a look."
    M "Tamam, bir göz atalım."

# game/UpdateScript0.02.rpy:3642
translate turkish momsoffice_06dc1071:
    ...
    M "Uggghh.... annenin karpal tünel sendromu olduğu için oğluna mastürbasyon yapması gerektiğine inanacak kadar aptal olduğuna gerçekten inanmaya devam etmemiz mi gerekiyor?"

# game/UpdateScript0.02.rpy:3643
translate turkish momsoffice_b13394b9:
    ...
    R "Anne, bunun sadece bir oyun olduğunu hatırlamaya çalış. Biraz saçma olabilir ama bir annenin oğluyla isteyerek ilişkiye gireceği durumlar uydurmak zordur."

# game/UpdateScript0.02.rpy:3644
translate turkish momsoffice_44077d45:

    # M "Hmmmm.... well, keep going."
    M "Hmmmm.... peki, devam et."

# game/UpdateScript0.02.rpy:3649
translate turkish momsoffice_c1d7953e:

    # M "And now she's a party to the corruption of her daughter?"
    M "Ve şimdi de kızının yozlaşmasına ortak mı oluyor?"

# game/UpdateScript0.02.rpy:3650
translate turkish momsoffice_c2c10168:

    # M "I think that's all we should see for today."
    M "Sanırım bugünlük bu kadarını görmek yeterli."

# game/UpdateScript0.02.rpy:3653
translate turkish momsoffice_6e5e2012:
    ...
    R "Bu sadece bir kurgu anne, ama bu tür oyunlarla ilgilenen birçok insan var. Dönem ödevim için iyi bir konu olacağını düşünüyorum."

# game/UpdateScript0.02.rpy:3654
translate turkish momsoffice_9fceb1b9_1:

    # R "Mom, are you alright?"
    R "Anne, iyi misin?"

# game/UpdateScript0.02.rpy:3655
translate turkish momsoffice_a6b6cd95_1:

    # M "Uhhh.... yes!.... Of course.... just a little flustered from that game."
    M "Uhhh.... evet!.... Tabii ki.... sadece o oyundan dolayı biraz şaşırdım."

# game/UpdateScript0.02.rpy:3656
translate turkish momsoffice_e5eda73b:
    ...
    M "Ama evet haklısın. Sanırım doğru yoldasın. Bana o oyunun linkini gönder ki bunun ödevin kapsamına girdiğinden emin olabileyim."

# game/UpdateScript0.02.rpy:3657
translate turkish momsoffice_3265e8ee_2:

    # "{i}{b}\"Mom's Libido +1\"{/b}{/i}"
    "{i}{b}\"Annemin azgınlığı +1\"{/b}{/i}"

# game/UpdateScript0.02.rpy:3659
translate turkish momsoffice_65dbf55c_2:

    # M "Ok, I really need to get back to my class, I'll see you at home tonight."
    M "Tamam, gerçekten dersime dönmem gerekiyor, akşam evde görüşürüz."

# game/UpdateScript0.02.rpy:3660
translate turkish momsoffice_0a9bc157_1:

    # R "Ok Mom, see you later."
    R "Tamam anne, sonra görüşürüz."

# game/UpdateScript0.02.rpy:3661
translate turkish momsoffice_a0153dfe:
    ...
    RT "{i}Gerçekten şaşırmış görünüyordu ve beklediğim gibi beni ofisinden kovmadı. Bu hoşuna gitmiş olabilir mi?{/i}"

# game/UpdateScript0.02.rpy:3662
translate turkish momsoffice_0f0847ed_1:
...
translate turkish emptywarehouse_5b2507b8:
...
translate turkish emptywarehouse_4863f136:

    # MD "Ok, I'll do it!"
    ""

# game/UpdateScript0.02.rpy:3858
translate turkish emptywarehouse_554188de:
...
translate turkish emptywarehouse_8f889d5b:
    ...
    "{i}\"30 dakika sonrası\"{/i}"

# game/UpdateScript0.02.rpy:3895
translate turkish ntrclub_09a446a5:
...
translate turkish ntrclub_5d74ad77:
...
translate turkish ntrclub_c9d6c953:
...
translate turkish ntrclub_61731497:
...
translate turkish strings:
    ...
    new "Yeni bir casusluk kamerası kur."
