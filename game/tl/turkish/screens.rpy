...
translate turkish strings:
    ...
    new "Diyalog geçmişinde bir şey yok."
    ...
    new "Seçenekleri seçmeden diyaloğu ilerletir."
    ...
    new "Daha sonraki diyaloğa geçer."
    ...
    old "Mouse Wheel Up\nClick Rollback Side"
    new "Yukarı Mouse Tekerleği"

    # game/screens.rpy:1173
    old "Mouse Wheel Down"
    new "Aşağı Mouse Tekerleği"
