...
translate turkish strings:
    ...
    new "\n{b}{i}Oyun Kodlama, Android Uzmanı:{/i}{/b} \n"
    ...
    new "\n{b}{i}Yazım ve Dilbilgisi Editörü:{/i}{/b} \n"
    ...
    new "\n{b}{i}Menfaatleri Olan Ailem:{/i}{/b} \n"
