...
translate crowdin strings:
    ...
    new "{i}Please contact me if you believe your name isn't here and it should be, or would like to have it listed differently.{/i}"
    ...
    new "by Yan Terrien from The Free Music Archive"
