...
translate italian strings:
    ...
    new "\n{b}{i}Scrittore di sceneggiature di gioco, creatore di immagini, disegnatore di Face Card:{/i}{/b} \n"
    ...
    new "\n{i}Ho evitato di usare i nomi completi dei sostenitori, ove possibile, e ho usato le maniglie di Discord invece ovunque avessi accesso a quelli.{/i}\n"
    ...
    new "{i}Contattami se credi che il tuo nome non sia qui e dovrebbe essere, o vorresti averlo elencato in modo diverso.{/i}"

    # game/Credits_screen.rpy:176
    old "\n{b}{i}$35 tier (My Family with Benefits {i}SubscribeStar{/i}) (My Family {i}Patreon{/i}):{/i}{/b} \n"
    new "\n{b}{i}$35 tier (Mia famiglia con benefici {i}AbbonatoStar{/i}) (Mia famiglia {i}Patreon{/i}):{/i}{/b} \n"
    ...
    new "\n{b}{i}$20 tier (Mia famiglia {i}AbbonatoStar{/i}) (Mia BFF {i}Patreon{/i}):{/i}{/b} \n"
    ...
    new "by Yswha from The Free Music Archive"
    ...
    new "by Monplaisir from The Free Music Archive"
