...
translate italian strings:
    ...
    new "\n{i}Ho evitato di usare i nomi completi dei sostenitori, ove possibile, e ho usato le maniglie di Discord invece dove ho avuto accesso a quelli.{/i}\n"
    ...
    new "{i}Per favore contatta me se credi che il tuo nome non sia qui e dovrebbe essere, o vorresti averlo elencato in modo diverso.{/i}"
    ...
    new "\n{b}{i}$20 tier (My Family {i}SubscribeStar{/i}) (Mia BFF {i}Patreon{/i}):{/i}{/b} \n"
