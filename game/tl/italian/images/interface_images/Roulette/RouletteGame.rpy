...
translate italian gameTypeErrorCheck_be76e8b9:
    ...
    RLT_dealer "Errore: Non hai scommesso alcun importo di denaro.{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian gameTypeErrorCheck_fbac9fac:
    ...
    RLT_dealer "Errore: Con il gioco di scommesse Split puoi scegliere qualsiasi 2 (due) numeri di roulette. Per favore fornisci un elenco di due numeri diversi.{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian gameTypeErrorCheck_7f667963:
    ...
    RLT_dealer "Errore: Con il gioco di scommesse Penta puoi scegliere qualsiasi 5 (cinque) numeri di roulette. Per favore fornisci un elenco di 5 numeri diversi.{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian lblCheckRoll_bf9f0393:
    ...
    RLT_dealer "Hai perso! Il numero che è [theRoll] ed è [theRollOddOrEven_text], il colore è [theRollColor_text]!{w=3.0}{nw}" with Dissolve(2.0)
