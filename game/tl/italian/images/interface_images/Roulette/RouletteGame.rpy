...
translate italian gameTypeErrorCheck_76d464ef:
    ...
    RLT_dealer "Error: With the Straight betting game you can pick any roulette number. Please provide a list of one number.{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian gameTypeErrorCheck_fbac9fac:
    ...
    RLT_dealer "Error: With the Split betting game you can pick any 2 (two) roulette numbers. Please provide a list of two different numbers.{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian gameTypeErrorCheck_a87619d6:
    ...
    RLT_dealer "Error: With the Street betting game you can pick any 3 (tre) roulette numbers. Please provide a list of three different numbers.{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian gameTypeErrorCheck_896b51f0:
    ...
    RLT_dealer "Error: With the Corner betting game you can pick any 4 (four) roulette numbers. Please provide a list of four different numbers.{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian gameTypeErrorCheck_7f667963:
    ...
    RLT_dealer "Error: With the Penta betting game you can pick any 5 (cinque) roulette numbers. Please provide a list of 5 different numbers.{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian gameTypeErrorCheck_30b475c4:
    ...
    RLT_dealer "Error: With the Line betting game you can pick any 6 (sei) roulette numbers. Please provide a list of six different numbers.{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian gameTypeErrorCheck_e69becfe:
    ...
    RLT_dealer "Error: With the Dozen betting game you can pick any 12 (dodici) roulette numbers. Please provide a list of 12 different numbers.{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian gameTypeErrorCheck_3fde7c69:
    ...
    RLT_dealer "Error: You have picked an incorrect color. Acceptable colors are {outlinecolor=#ffffff}{color=#FF0000}Red{/color}{/outlinecolor} and {outlinecolor=#ffff}{color=#000000}Black{/color}{/outlinecolor}.{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian gameTypeErrorCheck_e10368bb:
    ...
    RLT_dealer "Error: You have pick an incorrect bet. Acceptable bets are {outlinecolor=#ffff}{color=#00008B}Odd{/color}{/outlinecolor} or {outlinecolor=#ffffff}{color=#00008B}Even{/color}{/outlinecolor}.{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian call_rotate_1bc2ab16:
    ...
    RLT_dealer "Lancia la palla!{w=2.0}{nw}" with Dissolve(2.0)
...
translate italian lblCheckRoll_38a91ca2:
    ...
    RLT_dealer "Hai vinto! Il numero che è [theRoll] ed è [theRollOddOrEven_text], il colore è [theRollColor_text]!{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian lblCheckRoll_fb67b1be:
    ...
    RLT_dealer "La vincita è di 35 a 1, così hai vinto $[payout]!{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian lblCheckRoll_bf9f0393:
    ...
    RLT_dealer "Perdi! Il numero che è [theRoll] ed è [theRollOddOrEven_text], il colore è [theRollColor_text]!{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian lblCheckRoll_a5eb7354:
    ...
    RLT_dealer "La vincita è di 17 a 1, così hai vinto $[payout]!{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian lblCheckRoll_700ff3e1:
    ...
    RLT_dealer "La vincita è di 11 a 1, così hai vinto $[payout]!{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian lblCheckRoll_0f532220:
    ...
    RLT_dealer "La vincita è di 8 a 1, così hai vinto $[payout]!{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian lblCheckRoll_b19b6772:
    ...
    RLT_dealer "La vincita è di 2 a 1, così hai vinto $[payout]!{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian lblCheckRoll_93d132d6:
    ...
    RLT_dealer "La vincita è da 1 a 1, così hai vinto $[payout]!{w=3.0}{nw}" with Dissolve(2.0)
...
translate italian strings:
    ...
    new "Vuoi lasciare il gioco della Roulette?"
